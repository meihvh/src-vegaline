...
public class AxisAngle4d implements Serializable, Cloneable {
   ...
   public final void set(Matrix4f m1) {
      ...
      m1.get(m3d);
      this.x = (double)((float)(m3d.m21 - m3d.m12));
      this.y = (double)((float)(m3d.m02 - m3d.m20));
      this.z = (double)((float)(m3d.m10 - m3d.m01));
      double mag = this.x * this.x + this.y * this.y + this.z * this.z;
      if (mag > 1.0E-12) {
         mag = Math.sqrt(mag);
         double sin = 0.5 * mag;
         double cos = 0.5 * (m3d.m00 + m3d.m11 + m3d.m22 - 1.0);
         this.angle = (double)((float)Math.atan2(sin, cos));
   ...
   public final void set(Matrix3f m1) {
      this.x = (double)(m1.m21 - m1.m12);
      this.y = (double)(m1.m02 - m1.m20);
      this.z = (double)(m1.m10 - m1.m01);
      double mag = this.x * this.x + this.y * this.y + this.z * this.z;
      if (mag > 1.0E-12) {
         mag = Math.sqrt(mag);
         double sin = 0.5 * mag;
   ...
   public final void set(Matrix3d m1) {
      this.x = (double)((float)(m1.m21 - m1.m12));
      this.y = (double)((float)(m1.m02 - m1.m20));
      this.z = (double)((float)(m1.m10 - m1.m01));
      double mag = this.x * this.x + this.y * this.y + this.z * this.z;
      if (mag > 1.0E-12) {
         mag = Math.sqrt(mag);
         double sin = 0.5 * mag;
   ...
   public final void set(Quat4f q1) {
      ...
      if (mag > 1.0E-12) {
         ...
         this.angle = 2.0 * Math.atan2(mag, (double)q1.w);
      } else {
         this.x = 0.0;
         this.y = 1.0;
         this.z = 0.0;
