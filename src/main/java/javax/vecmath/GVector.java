...
public class GVector implements Serializable, Cloneable {
   ...
   public final void normalize(GVector v1) {
      ...
      if (this.length != v1.length) {
         ...
         for (int var7 = 0; var7 < this.length; var7++) {
            this.values[var7] = v1.values[var7] * invMag;
         }
      }
   }
   ...
   public final void normalize() {
      ...
      for (int var6 = 0; var6 < this.length; var6++) {
         this.values[var6] = this.values[var6] * invMag;
      }
   }
   ...
   public final void set(GVector vector) {
      if (this.length < vector.length) {
         ...
         for (int var4 = vector.length; var4 < this.length; var4++) {
   ...
   public final void LUDBackSolve(GMatrix LU, GVector b, GVector permutation) {
      ...
      if (LU.nRow != b.getSize()) {
         ...
         for (int var11 = 0; var11 < LU.nRow; var11++) {
            result[var11 * LU.nCol] = b.values[var11];
         }

         for (int var12 = 0; var12 < LU.nCol; var12++) {
            row_perm[var12] = (int)permutation.values[var12];
         }

         GMatrix.luBacksubstitution(LU.nRow, temp, row_perm, result);

         for (int var13 = 0; var13 < LU.nRow; var13++) {
            this.values[var13] = result[var13 * LU.nCol];
         }
      }
   }
