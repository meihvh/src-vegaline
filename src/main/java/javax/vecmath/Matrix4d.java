...
public class Matrix4d implements Serializable, Cloneable {
   ...
   public final void add(Matrix4d m1) {
      ...
      this.m03 = this.m03 + m1.m03;
      this.m10 = this.m10 + m1.m10;
      this.m11 = this.m11 + m1.m11;
      this.m12 = this.m12 + m1.m12;
      this.m13 = this.m13 + m1.m13;
      this.m20 = this.m20 + m1.m20;
      this.m21 = this.m21 + m1.m21;
      this.m22 = this.m22 + m1.m22;
      this.m23 = this.m23 + m1.m23;
      this.m30 = this.m30 + m1.m30;
      this.m31 = this.m31 + m1.m31;
      this.m32 = this.m32 + m1.m32;
      this.m33 = this.m33 + m1.m33;
   }
   ...
   final void invertGeneral(Matrix4d m1) {
      ...
      double[] tmp = new double[]{
         m1.m00, m1.m01, m1.m02, m1.m03, m1.m10, m1.m11, m1.m12, m1.m13, m1.m20, m1.m21, m1.m22, m1.m23, m1.m30, m1.m31, m1.m32, m1.m33
      };
   ...
   static boolean luDecomposition(double[] matrix0, int[] row_perm) {
      ...
      for (int j = 0; j < 4; j++) {
         for (int ix = 0; ix < j; ix++) {
            int target = mtx + 4 * ix + j;
            double sum = matrix0[target];
            int k = ix;
            int p1 = mtx + 4 * ix;

            for (int p2 = mtx + j; k-- != 0; p2 += 4) {
         ...
         for (int var20 = j; var20 < 4; var20++) {
            int target = mtx + 4 * var20 + j;
            double sum = matrix0[target];
            int k = j;
            int p1 = mtx + 4 * var20;
         ...
         if (j != 3) {
            ...
            for (int var21 = 3 - j; var21-- != 0; target += 4) {
               matrix0[target] *= temp;
            }
         }
      }
   ...
   static void luBacksubstitution(double[] matrix1, int[] row_perm, double[] matrix2) {
      ...
      for (int k = 0; k < 4; k++) {
         ...
         rv -= 4;
         matrix2[cv + 0] = (matrix2[cv + 0] - matrix1[rv + 1] * matrix2[cv + 4] - matrix1[rv + 2] * matrix2[cv + 8] - matrix1[rv + 3] * matrix2[cv + 12])
            / matrix1[rv + 0];
      }
   }
