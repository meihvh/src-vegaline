            ...
            case 2:
               try {
                  ...
                  try {
                     ...
                     this.fmode = 2;
                     this.riff_header.ckID = br[0] << 24 & 0xFF000000 | br[1] << 16 & 0xFF0000 | br[2] << 8 & 0xFF00 | br[3] & 255;
                     this.riff_header.ckSize = br[4] << 24 & 0xFF000000 | br[5] << 16 & 0xFF0000 | br[6] << 8 & 0xFF00 | br[7] & 255;
