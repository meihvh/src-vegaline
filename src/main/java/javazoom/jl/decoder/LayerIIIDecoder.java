...
final class LayerIIIDecoder implements FrameDecoder {
   ...
   private final LayerIIIDecoder.III_side_info_t si;
   private final LayerIIIDecoder.temporaire2[] III_scalefac_t;
   private final LayerIIIDecoder.temporaire2[] scalefac;
   ...
   private final LayerIIIDecoder.SBI[] sfBandIndex;
         ...
         if (this.is_1d[j] == 0) {
            ...
            if (abv < t_43.length) {
               if (this.is_1d[j] > 0) {
                  ...
                  xr_1d[quotien][reste] = -g_gain * (float)Math.pow((double)(-abv), 1.3333333333333333);
               }
   ...
   private void hybrid(int ch, int gr) {
      ...
      for (int sb18 = 0; sb18 < 576; sb18 += 18) {
         ...
         System.arraycopy(tsOut, sb18, this.tsOutCopy, 0, 18);
         this.inv_mdct(this.tsOutCopy, this.rawout, bt);
         System.arraycopy(this.tsOutCopy, 0, tsOut, sb18, 18);
   ...
   private static float[] create_t_43() {
      ...
      for (int i = 0; i < 8192; i++) {
         t43[i] = (float)Math.pow((double)i, 1.3333333333333333);
      }
