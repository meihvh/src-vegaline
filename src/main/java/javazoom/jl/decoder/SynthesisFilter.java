...
final class SynthesisFilter {
   ...
   public float[] lastUpdatedSamples = new float[32];
   ...
   public float[] getTempOutSamples() {
      return this.lastUpdatedSamples;
   }
   ...
   public void input_samples(float[] s) {
      for (int i = 31; i >= 0; i--) {
         ...
         this.samples[i] = this.samples[i] * 0.5F;
         this.lastUpdatedSamples[i] = this.samples[i];
      }
   }
   ...
   private void compute_new_v() {
      ...
      new_v23 = -p3 - p2;
      p0 = (s0 - s31) * cos1_64;
      float var140 = (s1 - s30) * cos3_64;
      p2 = (s2 - s29) * cos5_64;
      float var150 = (s3 - s28) * cos7_64;
      p4 = (s4 - s27) * cos9_64;
      p5 = (s5 - s26) * cos11_64;
      p6 = (s6 - s25) * cos13_64;
      float var170 = (s7 - s24) * cos15_64;
      p8 = (s8 - s23) * cos17_64;
      p9 = (s9 - s22) * cos19_64;
      ...
      pp6 = p6 + p9;
      pp7 = var170 + p8;
      pp8 = (p0 - var210) * cos1_32;
      pp9 = (var140 - p14) * cos3_32;
      pp10 = (p2 - p13) * cos5_32;
      pp11 = (var150 - p12) * cos7_32;
      pp12 = (p4 - p11) * cos9_32;
      pp13 = (p5 - p10) * cos11_32;
      pp14 = (p6 - p9) * cos13_32;
      pp15 = (var170 - p8) * cos15_32;
      p0 = pp0 + pp7;
      ...
      p13 = (pp9 - pp14) * cos3_16;
      p14 = (pp10 - pp13) * cos5_16;
      float var211 = (pp11 - pp12) * cos7_16;
      pp0 = p0 + var151;
      pp1 = var141 + p2;
      pp2 = (p0 - var151) * cos1_8;
      pp3 = (var141 - p2) * cos3_8;
      pp4 = p4 + var171;
      pp5 = p5 + p6;
      pp6 = (p4 - var171) * cos1_8;
      pp7 = (p5 - p6) * cos3_8;
      pp8 = p8 + p11;
      pp9 = p9 + p10;
      pp10 = (p8 - p11) * cos1_8;
      ...
      pp12 = p12 + var211;
      pp13 = p13 + p14;
      pp14 = (p12 - var211) * cos1_8;
      pp15 = (p13 - p14) * cos3_8;
      p0 = pp0 + pp1;
      float var142 = (pp0 - pp1) * cos1_4;
      p2 = pp2 + pp3;
      float var152 = (pp2 - pp3) * cos1_4;
      p4 = pp4 + pp5;
      p5 = (pp4 - pp5) * cos1_4;
      p6 = pp6 + pp7;
      float var172 = (pp6 - pp7) * cos1_4;
      p8 = pp8 + pp9;
      p9 = (pp8 - pp9) * cos1_4;
      p10 = pp10 + pp11;
      p11 = (pp10 - pp11) * cos1_4;
