...
public class Advancement {
   ...
   public Advancement(
      ResourceLocation p_i47472_1_,
      @Nullable Advancement p_i47472_2_,
      @Nullable DisplayInfo p_i47472_3_,
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return !(p_equals_1_ instanceof Advancement advancement) ? false : this.field_192079_d.equals(advancement.field_192079_d);
      }
   }
   ...
   public static class Builder {
      ...
      Builder(
         @Nullable ResourceLocation p_i47414_1_,
         @Nullable DisplayInfo p_i47414_2_,
         AdvancementRewards p_i47414_3_,
         Map<String, Criterion> p_i47414_4_,
         String[][] p_i47414_5_
      ) {
      ...
      public static Advancement.Builder func_192059_a(JsonObject p_192059_0_, JsonDeserializationContext p_192059_1_) {
         ...
         AdvancementRewards advancementrewards = JsonUtils.deserializeClass(
            p_192059_0_, "rewards", AdvancementRewards.field_192114_a, p_192059_1_, AdvancementRewards.class
         );
