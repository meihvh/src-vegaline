...
public class AdvancementTreeNode {
   ...
   public AdvancementTreeNode(
      Advancement p_i47466_1_, @Nullable AdvancementTreeNode p_i47466_2_, @Nullable AdvancementTreeNode p_i47466_3_, int p_i47466_4_, int p_i47466_5_
   ) {
   ...
   private AdvancementTreeNode func_192324_a(AdvancementTreeNode p_192324_1_) {
      if (this.field_192330_c == null) {
         ...
         float f3;
         for (f3 = advancementtreenode3.field_192337_j;
            advancementtreenode2.func_192317_d() != null && advancementtreenode.func_192321_c() != null;
