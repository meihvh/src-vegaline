...
public class PlayerAdvancements {
   ...
   private void func_192740_f() {
      if (this.field_192757_e.isFile()) {
         try {
            ...
            field_192753_a.error("Couldn't parse player advancements in " + this.field_192757_e, (Throwable)var7);
         } catch (IOException var8) {
            field_192753_a.error("Couldn't access player advancements in " + this.field_192757_e, (Throwable)var8);
         }
      }
   ...
   public void func_192749_b() {
      ...
      try {
         ...
         field_192753_a.error("Couldn't save player advancements to " + this.field_192757_e, (Throwable)var5);
      }
   }
               ...
               this.field_192756_d
                  ...
                  .sendChatMsg(
                     new TextComponentTranslation(
                        ...
                        this.field_192762_j.getDisplayName(),
