...
public class DamageSourcePredicate {
   ...
   public DamageSourcePredicate(
      @Nullable Boolean p_i47543_1_,
      @Nullable Boolean p_i47543_2_,
      @Nullable Boolean p_i47543_3_,
      @Nullable Boolean p_i47543_4_,
      @Nullable Boolean p_i47543_5_,
      @Nullable Boolean p_i47543_6_,
      @Nullable Boolean p_i47543_7_,
      EntityPredicate p_i47543_8_,
   ...
   public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_) {
      if (this == field_192449_a) {
         ...
         return !this.field_193419_i.func_192482_a(p_193418_1_, p_193418_2_.getSourceOfDamage())
            ? false
            : this.field_193420_j.func_192482_a(p_193418_1_, p_193418_2_.getEntity());
      }
   }
