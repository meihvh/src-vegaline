   ...
   public static MobEffectsPredicate func_193471_a(@Nullable JsonElement p_193471_0_) {
      if (p_193471_0_ != null && !p_193471_0_.isJsonNull()) {
         ...
         for (Entry<String, JsonElement> entry : jsonobject.entrySet()) {
            ...
            MobEffectsPredicate.InstancePredicate mobeffectspredicate$instancepredicate = MobEffectsPredicate.InstancePredicate.func_193464_a(
               JsonUtils.getJsonObject(entry.getValue(), entry.getKey())
            );
   ...
   public static class InstancePredicate {
      ...
      public boolean func_193463_a(@Nullable PotionEffect p_193463_1_) {
         if (p_193463_1_ == null) {
            ...
            return this.field_193467_c != null && this.field_193467_c != p_193463_1_.getIsAmbient()
               ? false
               : this.field_193468_d == null || this.field_193468_d == p_193463_1_.doesShowParticles();
         }
      }
