...
public abstract class BlockButton extends BlockDirectional {
   ...
   protected static boolean canPlaceBlock(World worldIn, BlockPos pos, EnumFacing direction) {
      ...
      return direction == EnumFacing.UP ? block == Blocks.HOPPER || !func_193384_b(block) && flag : !func_193382_c(block) && flag;
   }
   ...
   private void checkPressed(IBlockState p_185616_1_, World p_185616_2_, BlockPos p_185616_3_) {
      List<? extends Entity> list = p_185616_2_.getEntitiesWithinAABB(
         EntityArrow.class, p_185616_1_.getBoundingBox(p_185616_2_, p_185616_3_).offset(p_185616_3_)
      );
