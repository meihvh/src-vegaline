...
public class BlockCommandBlock extends BlockContainer {
   ...
   public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos p_189540_5_) {
      if (!worldIn.isRemote && worldIn.getTileEntity(pos) instanceof TileEntityCommandBlock tileentitycommandblock) {
   ...
   public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
      if (worldIn.getTileEntity(pos) instanceof TileEntityCommandBlock tileentitycommandblock) {
         CommandBlockBaseLogic commandblockbaselogic = tileentitycommandblock.getCommandBlockLogic();
   ...
   private static void func_193386_c(World p_193386_0_, BlockPos p_193386_1_, EnumFacing p_193386_2_) {
      ...
      while (i-- > 0) {
         ...
         if (block != Blocks.CHAIN_COMMAND_BLOCK
            || !(p_193386_0_.getTileEntity(blockpos$mutableblockpos) instanceof TileEntityCommandBlock tileentitycommandblock)
