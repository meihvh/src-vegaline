...
public class BlockNote extends BlockContainer {
   ...
   public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos p_189540_5_) {
      ...
      if (worldIn.getTileEntity(pos) instanceof TileEntityNote tileentitynote && tileentitynote.previousRedstoneState != flag) {
         if (flag) {
   ...
   public boolean onBlockActivated(
      ...
      if (worldIn.isRemote) {
         ...
         if (worldIn.getTileEntity(pos) instanceof TileEntityNote tileentitynote) {
   ...
   public boolean eventReceived(IBlockState state, World worldIn, BlockPos pos, int id, int param) {
      ...
      worldIn.spawnParticle(
         EnumParticleTypes.NOTE, (double)pos.getX() + 0.5, (double)pos.getY() + 1.2, (double)pos.getZ() + 0.5, (double)param / 24.0, 0.0, 0.0
      );
      return true;
   }
