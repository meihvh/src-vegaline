...
public class BlockObserver extends BlockDirectional {
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      if (state.getValue(field_190963_a)) {
   ...
   private void func_190960_d(IBlockState p_190960_1_, World p_190960_2_, BlockPos p_190960_3_) {
      if (!p_190960_1_.getValue(field_190963_a) && !p_190960_2_.isUpdateScheduled(p_190960_3_, this)) {
   ...
   public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
      return blockState.getValue(field_190963_a) && blockState.getValue(FACING) == side ? 15 : 0;
   }
   ...
   public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
      if (state.getValue(field_190963_a) && worldIn.isUpdateScheduled(pos, this)) {
