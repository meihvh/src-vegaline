...
public class BlockPistonBase extends BlockDirectional {
   ...
   public boolean causesSuffocation(IBlockState p_176214_1_) {
      return !p_176214_1_.getValue(EXTENDED);
   }
      ...
      if (id == 0) {
         ...
         if (this.isSticky) {
            ...
            if (block == Blocks.PISTON_EXTENSION
               && worldIn.getTileEntity(blockpos) instanceof TileEntityPiston tileentitypiston
               && tileentitypiston.getFacing() == enumfacing
   ...
   public BlockFaceShape func_193383_a(IBlockAccess p_193383_1_, IBlockState p_193383_2_, BlockPos p_193383_3_, EnumFacing p_193383_4_) {
      ...
      return p_193383_2_.getValue(FACING) != p_193383_4_.getOpposite() && p_193383_2_.getValue(EXTENDED) ? BlockFaceShape.UNDEFINED : BlockFaceShape.SOLID;
   }
}
