      ...
      if (iblockstate.getMaterial() == Material.AIR) {
         ...
         if (i + this.toMove.size() > 12) {
            ...
            while (block == Blocks.SLIME_BLOCK) {
               ...
               if (iblockstate.getMaterial() == Material.AIR
                  || !BlockPistonBase.canPush(iblockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite())
            ...
            while (true) {
               ...
               if (!BlockPistonBase.canPush(iblockstate, this.world, blockpos1, this.moveDirection, true, this.moveDirection)
