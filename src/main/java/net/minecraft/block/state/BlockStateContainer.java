...
public class BlockStateContainer {
   ...
   static class StateImplementation extends BlockStateBase {
      ...
      protected StateImplementation(
         Block p_i8_1_, ImmutableMap<IProperty<?>, Comparable<?>> p_i8_2_, ImmutableTable<IProperty<?>, Comparable<?>, IBlockState> p_i8_3_
      ) {
         this.block = p_i8_1_;
      ...
      public void addCollisionBoxToList(
         World worldIn, BlockPos pos, AxisAlignedBB p_185908_3_, List<AxisAlignedBB> p_185908_4_, @Nullable Entity p_185908_5_, boolean p_185908_6_
      ) {
      ...
      public AxisAlignedBB getBoundingBox(IBlockAccess blockAccess, BlockPos pos) {
         ...
         if (block$enumoffsettype != Block.EnumOffsetType.NONE && !(this.block instanceof BlockFlower)) {
            ...
            return BlockModelUtils.getOffsetBoundingBox(axisalignedbb, block$enumoffsettype, pos);
         } else {
      ...
      public boolean doesSideBlockRendering(
         IBlockAccess p_doesSideBlockRendering_1_, BlockPos p_doesSideBlockRendering_2_, EnumFacing p_doesSideBlockRendering_3_
      ) {
         return Reflector.callBoolean(
            this.block,
            Reflector.ForgeBlock_doesSideBlockRendering,
            this,
            p_doesSideBlockRendering_1_,
            p_doesSideBlockRendering_2_,
            p_doesSideBlockRendering_3_
         );
      }
