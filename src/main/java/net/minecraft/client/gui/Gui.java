...
public class Gui {
   ...
   protected void drawHorizontalLine(int startX, int endX, int y, int color) {
      ...
      drawRect(startX, (double)y, (double)(endX + 1), (double)(y + 1), color);
   }
   ...
   protected void drawVerticalLine(int x, int startY, int endY, int color) {
      ...
      drawRect(x, (double)(startY + 1), (double)(x + 1), (double)endY, color);
   }
   ...
   public static void drawRect(int left, double g, double d, double e, int color) {
      ...
      bufferbuilder.pos((double)left, e, 0.0).endVertex();
      bufferbuilder.pos(d, e, 0.0).endVertex();
      bufferbuilder.pos(d, g, 0.0).endVertex();
      bufferbuilder.pos((double)left, g, 0.0).endVertex();
      tessellator.draw();
   ...
   public void drawCenteredString(CFontRenderer fontRendererIn, String text, int x, int y, int color) {
      fontRendererIn.drawStringWithShadow(text, (float)x - fontRendererIn.getStringWidth(text) / 2.0F, (float)y, color);
   }
   ...
   public static void drawCircledModalRect(ResourceLocation location, double x, double y, int textureX, int textureY, double width, double height) {
      ...
      bufferbuilder.pos(x, y + height, 0.0)
         .tex((double)((float)textureX * 0.00390625F), (double)((float)((double)textureY + height) * 0.00390625F))
         .endVertex();
      bufferbuilder.pos(x + width, y + height, 0.0)
         .tex((double)((float)((double)textureX + width) * 0.00390625F), (double)((float)((double)textureY + height) * 0.00390625F))
         .endVertex();
      bufferbuilder.pos(x + width, y, 0.0).tex((double)((float)((double)textureX + width) * 0.00390625F), (double)((float)textureY * 0.00390625F)).endVertex();
      bufferbuilder.pos(x, y, 0.0).tex((double)((float)textureX * 0.00390625F), (double)((float)textureY * 0.00390625F)).endVertex();
      tessellator.draw();
      if (alpha_test) {
         GL11.glEnable(3008);
      } else {
   ...
   public void drawTexturedModalRectAlphed(int x, int y, int textureX, int textureY, int width, int height, float alphaPC) {
      float f = 0.00390625F;
      float f1 = 0.00390625F;
      Tessellator tessellator = Tessellator.getInstance();
      BufferBuilder bufferbuilder = tessellator.getBuffer();
   ...
   public void drawSkin(int x, int y, float u, float v, int uWidth, int vHeight, int width, int height, float tileWidth, float tileHeight) {
      ...
      for (int i = 0; i <= 180; i++) {
         double xPosOffset = Math.sin((double)i * Math.PI / 90.0);
         double yPosOffset = Math.cos((double)i * Math.PI / 90.0);
         worldrenderer.pos((double)((float)x + x2) + xPosOffset * (double)x2, (double)((float)y + y2) + yPosOffset * (double)y2, 0.0)
            .tex((double)(u * f + u2) + xPosOffset * (double)u2, (double)(v * f1 + v2) + yPosOffset * (double)v2)
            .endVertex();
      }
   ...
   public void drawTexturedModalRect(float xCoord, float yCoord, int minU, int minV, int maxU, int maxV) {
      ...
      bufferbuilder.pos((double)(xCoord + 0.0F), (double)(yCoord + (float)maxV), (double)this.zLevel)
         .tex((double)((float)minU * 0.00390625F), (double)((float)(minV + maxV) * 0.00390625F))
         .endVertex();
      ...
      bufferbuilder.pos((double)(xCoord + (float)maxU), (double)(yCoord + 0.0F), (double)this.zLevel)
         .tex((double)((float)(minU + maxU) * 0.00390625F), (double)((float)minV * 0.00390625F))
         .endVertex();
      bufferbuilder.pos((double)(xCoord + 0.0F), (double)(yCoord + 0.0F), (double)this.zLevel)
         .tex((double)((float)minU * 0.00390625F), (double)((float)minV * 0.00390625F))
         .endVertex();
      tessellator.draw();
   }
   ...
   public void drawTexturedModalRect(int xCoord, int yCoord, TextureAtlasSprite textureSprite, int widthIn, int heightIn) {
      ...
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
      bufferbuilder.pos((double)xCoord, (double)(yCoord + heightIn), (double)this.zLevel)
      ...
      bufferbuilder.pos((double)(xCoord + widthIn), (double)(yCoord + heightIn), (double)this.zLevel)
         ...
         .endVertex();
      bufferbuilder.pos((double)(xCoord + widthIn), (double)yCoord, (double)this.zLevel)
         .tex((double)textureSprite.getMaxU(), (double)textureSprite.getMinV())
         .endVertex();
      bufferbuilder.pos((double)xCoord, (double)yCoord, (double)this.zLevel).tex((double)textureSprite.getMinU(), (double)textureSprite.getMinV()).endVertex();
      tessellator.draw();
   }
   ...
   public static void drawModalRectWithCustomSizedTexture(int x, int y, float u, float v, int width, int height, float textureWidth, float textureHeight) {
      ...
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
      bufferbuilder.pos((double)x, (double)(y + height), 0.0).tex((double)(u * f), (double)((v + (float)height) * f1)).endVertex();
      bufferbuilder.pos((double)(x + width), (double)(y + height), 0.0).tex((double)((u + (float)width) * f), (double)((v + (float)height) * f1)).endVertex();
      bufferbuilder.pos((double)(x + width), (double)y, 0.0).tex((double)((u + (float)width) * f), (double)(v * f1)).endVertex();
   ...
   public static void drawModalRectWithCustomSizedTexture(
      ...
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
      bufferbuilder.pos((double)x, (double)(y + height), 0.0).tex((double)(u * f), (double)((v + height) * f1)).endVertex();
      bufferbuilder.pos((double)(x + width), (double)(y + height), 0.0).tex((double)((u + width) * f), (double)((v + height) * f1)).endVertex();
      bufferbuilder.pos((double)(x + width), (double)y, 0.0).tex((double)((u + width) * f), (double)(v * f1)).endVertex();
      bufferbuilder.pos((double)x, (double)y, 0.0).tex((double)(u * f), (double)(v * f1)).endVertex();
      tessellator.draw();
   }

   public static void drawScaledCustomSizeModalRect(
      float width2, float height2, float u, float v, float uWidth, float vHeight, float width, float height, float tileWidth, float tileHeight
   ) {
      float f = 1.0F / tileWidth;
      float f1 = 1.0F / tileHeight;
      Tessellator tessellator = Tessellator.getInstance();
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
      bufferbuilder.pos((double)width2, (double)(height2 + height), 0.0).tex((double)(u * f), (double)((v + vHeight) * f1)).endVertex();
      bufferbuilder.pos((double)(width2 + width), (double)(height2 + height), 0.0).tex((double)((u + uWidth) * f), (double)((v + vHeight) * f1)).endVertex();
      bufferbuilder.pos((double)(width2 + width), (double)height2, 0.0).tex((double)((u + uWidth) * f), (double)(v * f1)).endVertex();
      bufferbuilder.pos((double)width2, (double)height2, 0.0).tex((double)(u * f), (double)(v * f1)).endVertex();
      tessellator.draw();
   }

   public static void drawScaledCustomSizeModalRect2(
      float width2, float height2, float u, float v, float uWidth, float vHeight, float width, float height, float tileWidth, float tileHeight
   ) {
      float f = 1.0F / tileWidth;
      float f1 = 1.0F / tileHeight;
   ...
   public static void drawScaledCustomSizeModalRect3(
   ...
   public static void drawScaledHead(ResourceLocation skin, int x, int y, int width, int height) {
      ...
      drawScaledCustomSizeModalRect((float)x, (float)y, 8.0F, 8.0F, 8.0F, 8.0F, (float)width, (float)height, 64.0F, 64.0F);
      drawScaledCustomSizeModalRect((float)x, (float)y, 40.0F, 8.0F, 8.0F, 8.0F, (float)width, (float)height, 64.0F, 64.0F);
   }
