...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.addLayerButton = this.addButton(
         new GuiButton(2, width / 2 - 154, height - 52, 100, 20, I18n.format("createWorld.customize.flat.addLayer") + " (NYI)")
      );
      this.editLayerButton = this.addButton(
         new GuiButton(3, width / 2 - 50, height - 52, 100, 20, I18n.format("createWorld.customize.flat.editLayer") + " (NYI)")
      );
   ...
   public void actionPerformed(GuiButton button) throws IOException {
      ...
      if (button.id == 1) {
         ...
         this.createFlatWorldListSlotGui.selectedLayer = Math.min(
            this.createFlatWorldListSlotGui.selectedLayer, this.theFlatGeneratorInfo.getFlatLayers().size() - 1
         );
      }
   ...
   class Details extends GuiSlot {
      ...
      private void drawItemBackground(int x, int z, int textureX, int textureY) {
         ...
         bufferbuilder.pos((double)x, (double)(z + 18), (double)GuiCreateFlatWorld.this.zLevel)
            .tex((double)((float)textureX * 0.0078125F), (double)((float)(textureY + 18) * 0.0078125F))
            .endVertex();
         bufferbuilder.pos((double)(x + 18), (double)(z + 18), (double)GuiCreateFlatWorld.this.zLevel)
            ...
            .endVertex();
         bufferbuilder.pos((double)(x + 18), (double)z, (double)GuiCreateFlatWorld.this.zLevel)
            .tex((double)((float)(textureX + 18) * 0.0078125F), (double)((float)textureY * 0.0078125F))
            .endVertex();
         bufferbuilder.pos((double)x, (double)z, (double)GuiCreateFlatWorld.this.zLevel)
            .tex((double)((float)textureX * 0.0078125F), (double)((float)textureY * 0.0078125F))
            .endVertex();
         tessellator.draw();
      }
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj.drawString(s, (float)(p_192637_2_ + 18 + 5), (double)(p_192637_3_ + 3), 16777215);
         String s1;
         if (p_192637_1_ == 0) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj
            .drawString(s1, (float)(p_192637_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s1)), (double)(p_192637_3_ + 3), 16777215);
      }
