...
public class GuiFlatPresets extends GuiScreen {
   ...
   class ListSlot extends GuiSlot {
      ...
      private void blitSlotIcon(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
         ...
         bufferbuilder.pos((double)p_148171_1_, (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel)
            .tex((double)((float)p_148171_3_ * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F))
            .endVertex();
         bufferbuilder.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel)
            .tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F))
            .endVertex();
         bufferbuilder.pos((double)(p_148171_1_ + 18), (double)p_148171_2_, (double)GuiFlatPresets.this.zLevel)
            .tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)p_148171_4_ * 0.0078125F))
            .endVertex();
         bufferbuilder.pos((double)p_148171_1_, (double)p_148171_2_, (double)GuiFlatPresets.this.zLevel)
            .tex((double)((float)p_148171_3_ * 0.0078125F), (double)((float)p_148171_4_ * 0.0078125F))
            .endVertex();
         tessellator.draw();
      }
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         ...
         GuiFlatPresets.this.fontRendererObj.drawString(guiflatpresets$layeritem.name, (float)(p_192637_2_ + 18 + 5), (double)(p_192637_3_ + 6), 16777215);
      }
   }
}
