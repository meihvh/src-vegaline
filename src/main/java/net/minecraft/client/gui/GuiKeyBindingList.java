   ...
   public class CategoryEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void func_192634_a(
         ...
         GuiKeyBindingList.this.mc
            ...
            .drawString(
               this.labelText,
               (float)(GuiScreen.width / 2 - this.labelWidth / 2),
               (double)(p_192634_3_ + p_192634_5_ - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1),
               16777215
            );
      }
   ...
   public class KeyEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void func_192634_a(
         ...
         GuiKeyBindingList.this.mc
            ...
            .drawString(
               this.keyDesc,
               (float)(p_192634_2_ + 90 - GuiKeyBindingList.this.maxListLabelWidth),
               (double)(p_192634_3_ + p_192634_5_ / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2),
               16777215
            );
