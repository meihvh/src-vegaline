...
public class GuiLanguage extends GuiScreen {
   ...
   class List extends GuiSlot {
      ...
      public final Map<String, Language> languageMap = Maps.newHashMap();
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         ...
         GuiLanguage.this.drawCenteredString(
            GuiLanguage.this.fontRendererObj, this.languageMap.get(this.langCodeList.get(p_192637_1_)).toString(), this.width / 2, p_192637_3_ + 1, 16777215
         );
