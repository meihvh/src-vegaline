   ...
   protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
      this.getListEntry(p_192637_1_)
         .func_192634_a(
            ...
            p_192637_5_,
            p_192637_6_,
            this.isMouseYWithinSlotBounds(p_192637_6_) && this.getSlotIndexFromScreenCoords(p_192637_5_, p_192637_6_) == p_192637_1_,
            p_192637_7_
         );
   }
   ...
   public boolean mouseClicked(int mouseX, int mouseY, int mouseEvent) {
      if (this.isMouseYWithinSlotBounds(mouseY)) {
         ...
         if (i >= 0) {
            ...
            int k = (int)((float)(this.top + 4) - this.getScrolled() + (float)(i * this.slotHeight) + (float)this.headerPadding);
            int l = mouseX - j;
            int i1 = mouseY - k;
