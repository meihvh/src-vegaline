...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void func_192634_a(
      ...
      this.client.fontRendererObj.drawString(s, (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 1), 16777215);
      this.client.fontRendererObj.drawString(s1, (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + 3), 8421504);
      this.client
         .fontRendererObj
         .drawString(
            s2,
            (float)(p_192634_2_ + 32 + 3),
            (double)(p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + this.client.fontRendererObj.FONT_HEIGHT + 3),
            8421504
         );
