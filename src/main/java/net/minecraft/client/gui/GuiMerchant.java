...
public class GuiMerchant extends GuiContainer {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(s, (float)(this.xSize / 2 - this.fontRendererObj.getStringWidth(s) / 2), 6.0, 4210752);
      this.fontRendererObj.drawString(I18n.format("container.inventory"), 8.0F, (double)(this.ySize - 96 + 2), 4210752);
   }
