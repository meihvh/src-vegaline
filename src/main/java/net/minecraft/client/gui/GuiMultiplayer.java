...
public class GuiMultiplayer extends GuiScreen {
   ...
   public static boolean flagUpdateLists;
   public static GuiMultiplayer lastGuiThis;
   ...
   public void initGui() {
      lastGuiThis = this;
      flagUpdateLists = true;
      ClientRP.getInstance().getDiscordRP().update("В меню выбора серверов", "Выбирает сервер");
      Keyboard.enableRepeatEvents(true);
      this.buttonList.clear();
      if (this.initialized) {
         this.serverListSelector.setDimensions(width, height, Panic.stop ? 32 : 52, height - 64);
      } else {
         ...
         this.serverListSelector = new ServerSelectionList(this, this.mc, width, height, Panic.stop ? 32 : 52, height - 64, 36);
         this.serverListSelector.updateOnlineServers(this.savedServerList);
      }

      flagUpdateLists = false;
      this.createButtons();
   }
   ...
   public void selectServer(int index) {
      ...
      if (guilistextended$iguilistentry != null && !(guilistextended$iguilistentry instanceof ServerListEntryLanScan)) {
         ...
         if (guilistextended$iguilistentry instanceof ServerListEntryNormal normal && !normal.isClientServer()) {
