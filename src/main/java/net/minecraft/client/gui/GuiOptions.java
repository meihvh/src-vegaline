   ...
   public void initGui() {
      ...
      if (this.mc.world != null) {
         ...
         this.difficultyButton = new GuiButton(
            108, width / 2 - 155 + i % 2 * 160, height / 6 - 12 + 24 * (i >> 1), 150, 20, this.getDifficultyText(enumdifficulty)
         );
         ...
         if (this.mc.isSingleplayer() && !this.mc.world.getWorldInfo().isHardcoreModeEnabled()) {
            ...
            this.lockButton = new GuiLockIconButton(
               109, this.difficultyButton.xPosition + this.difficultyButton.getButtonWidth(), this.difficultyButton.yPosition
            );
               ...
               .displayGuiScreen(
                  new GuiYesNo(
                     ...
                     new TextComponentTranslation(
                           "difficulty.lock.question", new TextComponentTranslation(this.mc.world.getWorldInfo().getDifficulty().getDifficultyResourceKey())
                        )
                        .getFormattedText(),
                     109
                  )
