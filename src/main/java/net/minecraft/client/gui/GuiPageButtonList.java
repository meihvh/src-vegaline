...
public class GuiPageButtonList extends GuiListExtended {
   ...
   private Gui createEntry(@Nullable GuiPageButtonList.GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
      if (p_178058_1_ instanceof GuiPageButtonList.GuiSlideEntry) {
         ...
         return p_178058_1_ instanceof GuiPageButtonList.GuiLabelEntry
            ? this.createLabel(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiLabelEntry)p_178058_1_, p_178058_3_)
            : null;
      }
   }
   ...
   private GuiListButton createButton(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_) {
      GuiListButton guilistbutton = new GuiListButton(
         this.responder, p_178065_3_.getId(), p_178065_1_, p_178065_2_, p_178065_3_.getCaption(), p_178065_3_.getInitialValue()
      );
      ...
      if (this.focusedControl instanceof GuiTextField guitextfield) {
         if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
            if (p_178062_2_ == 15) {
               ...
               GuiTextField var13 = (GuiTextField)this.focusedControl;
               var13.setFocused(true);
               int l = var13.yPosition + this.slotHeight;
               int i1 = var13.yPosition;
               if (l > this.bottom) {
                  this.addScrolled((float)(l - this.bottom));
               } else if (i1 < this.top) {
                  this.setScrolled((float)i1);
               }
            } else {
