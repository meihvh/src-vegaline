...
public class GuiRepair extends GuiContainer implements IContainerListener {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(I18n.format("container.repair"), 60.0F, 6.0, 4210752);
      if (this.anvil.maximumCost > 0) {
         int i = 8453920;
         boolean flag = true;
         String s = I18n.format("container.repair.cost", this.anvil.maximumCost);
         if (this.anvil.maximumCost >= 40 && !Minecraft.player.capabilities.isCreativeMode) {
         ...
         if (flag) {
            ...
            if (this.fontRendererObj.getUnicodeFlag()) {
               drawRect(k - 3, 65.0, (double)(this.xSize - 7), 77.0, -16777216);
               drawRect(k - 2, 66.0, (double)(this.xSize - 8), 76.0, -12895429);
            } else {
               this.fontRendererObj.drawString(s, (float)k, 68.0, j);
               this.fontRendererObj.drawString(s, (float)(k + 1), 67.0, j);
               this.fontRendererObj.drawString(s, (float)(k + 1), 68.0, j);
            }

            this.fontRendererObj.drawString(s, (float)k, 67.0, i);
         }
      }
