...
public class GuiScreenBook extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.fontRendererObj.drawString(s1, (float)(i + 36 + (116 - k) / 2), 34.0, 0);
         int l = this.fontRendererObj.getStringWidth(s);
         this.fontRendererObj.drawString(s, (float)(i + 36 + (116 - l) / 2), 50.0, 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
         int i1 = this.fontRendererObj.getStringWidth(s2);
         this.fontRendererObj.drawString(TextFormatting.DARK_GRAY + s2, (float)(i + 36 + (116 - i1) / 2), 60.0, 0);
            ...
            if (ItemWrittenBook.validBookTagContents(this.bookObj.getTagCompound())) {
               try {
                  ...
                  this.cachedComponents = itextcomponent != null
                     ? GuiUtilRenderComponents.splitText(itextcomponent, 116, this.fontRendererObj, true, true)
                     : null;
         ...
         this.fontRendererObj.drawString(s4, (float)(i - j1 + 192 - 44), 18.0, 0);
         if (this.cachedComponents == null) {
            ...
            for (int l1 = 0; l1 < k1; l1++) {
               ...
               this.fontRendererObj.drawString(itextcomponent2.getUnformattedText(), (float)(i + 36), (double)(34 + l1 * this.fontRendererObj.FONT_HEIGHT), 0);
            }
   ...
   static class NextPageButton extends GuiButton {
      ...
      public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
         if (this.visible) {
            boolean flag = p_191745_2_ >= this.xPosition
