...
public class GuiScreenDemo extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.title"), (float)i, (double)j, 2039583);
      j += 12;
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.movementMouse"), (float)i, (double)(j + 12), 5197647);
      this.fontRendererObj
         .drawString(
            I18n.format("demo.help.jump", GameSettings.getKeyDisplayString(gamesettings.keyBindJump.getKeyCode())), (float)i, (double)(j + 24), 5197647
         );
      this.fontRendererObj
         .drawString(
