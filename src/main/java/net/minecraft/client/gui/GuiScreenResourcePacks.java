...
public class GuiScreenResourcePacks extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (!Panic.stop && this.parentScreen instanceof GuiOptions op && op.lastScreen instanceof GuiMainMenu) {
      ...
      if (Client.moduleManager != null && ComfortUi.get.actived && this.mc.world != null) {
         ...
         RenderUtils.drawRect((double)(sr.getScaledWidth() / 2 - 204), 32.0, (double)(sr.getScaledWidth() / 2 + 204), (double)(sr.getScaledHeight() - 52), -1);
