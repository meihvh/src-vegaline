...
public class GuiSnooper extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.toggleButton = this.addButton(
         new GuiButton(1, width / 2 - 152, height - 30, 150, 20, this.game_settings_2.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED))
      );
   ...
   class List extends GuiSlot {
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.keys.get(p_192637_1_), 10.0F, (double)p_192637_3_, 16777215);
         GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.values.get(p_192637_1_), 230.0F, (double)p_192637_3_, 16777215);
      }
