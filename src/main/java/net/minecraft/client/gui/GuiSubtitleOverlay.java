   ...
   public void renderSubtitles(ScaledResolution resolution) {
      ...
      if (this.enabled && !this.subtitles.isEmpty()) {
         ...
         Vec3d vec3d1 = new Vec3d(0.0, 0.0, -1.0)
            .rotatePitch(-Minecraft.player.rotationPitch * (float) (Math.PI / 180.0))
            .rotateYaw(-Minecraft.player.rotationYaw * (float) (Math.PI / 180.0));
         ...
         for (GuiSubtitleOverlay.Subtitle guisubtitleoverlay$subtitle1 : this.subtitles) {
            ...
            int l1 = MathHelper.floor(
               MathHelper.clampedLerp(255.0, 75.0, (double)((float)(Minecraft.getSystemTime() - guisubtitleoverlay$subtitle1.getStartTime()) / 3000.0F))
            );
            int i2 = l1 << 16 | l1 << 8 | l1;
            GlStateManager.pushMatrix();
            GlStateManager.translate(
               (float)resolution.getScaledWidth() - (float)l * 1.0F - 2.0F, (float)(resolution.getScaledHeight() - 30) - (float)(i * (i1 + 1)) * 1.0F, 0.0F
            );
            GlStateManager.scale(1.0F, 1.0F, 1.0F);
            drawRect(-l - 1, (double)(-j1 - 1), (double)(l + 1), (double)(j1 + 1), -872415232);
            GlStateManager.enableBlend();
            if (!flag) {
               if (d0 > 0.0) {
                  this.client.fontRendererObj.drawString(">", (float)(l - this.client.fontRendererObj.getStringWidth(">")), (double)(-j1), i2 + -16777216);
               } else if (d0 < 0.0) {
                  this.client.fontRendererObj.drawString("<", (float)(-l), (double)(-j1), i2 + -16777216);
               }
            }

            this.client.fontRendererObj.drawString(s, (float)(-k1 / 2), (double)(-j1), i2 + -16777216);
