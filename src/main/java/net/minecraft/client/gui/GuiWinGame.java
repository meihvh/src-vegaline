...
public class GuiWinGame extends GuiScreen {
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      f3 *= f3;
      f3 = f3 * 96.0F / 255.0F;
      bufferbuilder.pos(0.0, (double)height, (double)this.zLevel).tex(0.0, (double)(f * 0.015625F)).color(f3, f3, f3, 1.0F).endVertex();
      bufferbuilder.pos((double)i, (double)height, (double)this.zLevel)
         .tex((double)((float)i * 0.015625F), (double)(f * 0.015625F))
         .color(f3, f3, f3, 1.0F)
         .endVertex();
      bufferbuilder.pos((double)i, 0.0, (double)this.zLevel).tex((double)((float)i * 0.015625F), (double)(f1 * 0.015625F)).color(f3, f3, f3, 1.0F).endVertex();
      bufferbuilder.pos(0.0, 0.0, (double)this.zLevel).tex(0.0, (double)(f1 * 0.015625F)).color(f3, f3, f3, 1.0F).endVertex();
      tessellator.draw();
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)height) {
            ...
            if (s.startsWith("[C]")) {
               this.fontRendererObj
                  .drawStringWithShadow(s.substring(3), (float)(j + (274 - this.fontRendererObj.getStringWidth(s.substring(3))) / 2), (float)l, 16777215);
            } else {
      ...
      int k1 = height;
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      bufferbuilder.pos(0.0, (double)k1, (double)this.zLevel).tex(0.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.pos((double)j1, (double)k1, (double)this.zLevel).tex(1.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.pos((double)j1, 0.0, (double)this.zLevel).tex(1.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.pos(0.0, 0.0, (double)this.zLevel).tex(0.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      tessellator.draw();
