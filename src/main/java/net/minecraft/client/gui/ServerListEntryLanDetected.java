...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry {
   ...
   public void func_192634_a(
      ...
      this.mc.fontRendererObj.drawString(I18n.format("lanServer.title"), (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 1), 16777215);
      this.mc.fontRendererObj.drawString(this.serverData.getServerMotd(), (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 12), 8421504);
      if (this.mc.gameSettings.hideServerAddress) {
         this.mc.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress"), (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 12 + 11), 3158064);
      } else {
         this.mc.fontRendererObj.drawString(this.serverData.getServerIpPort(), (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 12 + 11), 3158064);
      }
   }
