...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public boolean isClientServer() {
      return this.server != null && this.server.isClientDataServer() && this.server.hasClientData();
   }
   ...
   public void func_192634_a(
      ...
      boolean clientDrawing = this.isClientServer();
      ...
      if (clientDrawing) {
         Client.ServerListPresetElement clientData = this.server.getClientData();
         int color = ColorUtils.getOverallColorFrom(clientData.getServerColor(), -1, 0.4F);
         float txX = (float)(p_192634_2_ + 32 + 4);
         float txY = (float)(p_192634_3_ + 3);
         Fonts.mntsb_15.drawStringWithBloomAndShadow(this.server.serverName, txX, txY, color, 0.25F, 9);
         txX += Fonts.mntsb_15.getStringWidth(this.server.serverName) + 1.0F;
         txY++;
         String desc = "(" + clientData.getServerDescription() + ")";
         Fonts.mntsb_10.drawStringWithBloomAndShadow(desc, txX, txY, color, 0.55F, 6);
      } else {
         this.mc.fontRendererObj.drawString(this.server.serverName, (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 1), 16777215);
      }
      ...
      for (int i = 0; i < Math.min(list.size(), 2); i++) {
         this.mc
            .fontRendererObj
            .drawString(list.get(i), (float)(p_192634_2_ + 32 + 3), (double)(p_192634_3_ + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i), 8421504);
      }
      ...
      if (clientDrawing) {
         ...
         Fonts.mntsb_15
            .drawStringWithBloomAndShadow(
               s2, (float)(p_192634_2_ + p_192634_4_) - Fonts.mntsb_15.getStringWidth(s2) - 15.0F - 2.0F, (float)(p_192634_3_ + 3), color, 0.25F, 9
            );
      } else {
         this.mc.fontRendererObj.drawString(s2, (float)(p_192634_2_ + p_192634_4_ - j - 15 - 2), (double)(p_192634_3_ + 1), 8421504);
      }
      ...
      if (flag2) {
         ...
         k = 1;
         l = (int)(Minecraft.getSystemTime() / 100L + (long)p_192634_1_ * 2L & 7L);
         if (l > 4) {
            l = 8 - l;
         }
      ...
      if (clientDrawing) {
         Client.ServerListPresetElement clientData = this.server.getClientData();
         float extXY = 0.5F;
         float x1 = (float)p_192634_2_ - extXY;
         float y1 = (float)p_192634_3_ - extXY;
         float x2 = x1 + (float)p_192634_4_ - 4.5F + extXY;
         float y2 = y1 + (float)p_192634_5_ + 0.5F + extXY;
         int baseCol0 = clientData.getServerColor();
         int baseColDark0 = ColorUtils.toDark(baseCol0, 0.05F);
         int baseCol1 = clientData.getServerColor();
         int baseColDark1 = ColorUtils.toDark(baseCol1, 0.05F);
         int fade0 = ColorUtils.fadeColor(baseColDark0, baseCol0, 0.3F, 90 - (int)y1);
         int fade1 = ColorUtils.fadeColor(baseColDark1, baseCol1, 0.3F, -((int)y1));
         int fadeBG0 = ColorUtils.swapAlpha(fade0, (float)ColorUtils.getAlphaFromColor(fade0) * 0.4F);
         int fadeBG1 = ColorUtils.swapAlpha(fade1, (float)ColorUtils.getAlphaFromColor(fade1) * 0.4F);
         int fadeSH0 = ColorUtils.swapAlpha(fade0, (float)ColorUtils.getAlphaFromColor(fade0) * 0.2F);
         int fadeSH1 = ColorUtils.swapAlpha(fade1, (float)ColorUtils.getAlphaFromColor(fade1) * 0.2F);
         float shadow = 8.0F;
         RenderUtils.drawAlphedSideways((double)x1, (double)y1, (double)x2, (double)y2, fadeBG0, fadeBG1, true);
         RenderUtils.drawLightContureRectSidewaysSmooth((double)x1, (double)y1, (double)x2, (double)y2, fade0, fade1);
         RenderUtils.drawRoundedFullGradientShadowFullGradientRoundedFullGradientRectWithBloomBool(
            x1, y1, x2, y2, 0.0F, shadow, fadeSH0, fadeSH1, fadeSH1, fadeSH0, true, false, true
         );
      ...
      if (this.mc.gameSettings.touchscreen || p_192634_8_) {
         ...
         if (this.owner.canMoveUp(this, p_192634_1_) && !clientDrawing) {
            if (k1 < 16 && l1 < 16) {
         ...
         if (this.owner.canMoveDown(this, p_192634_1_) && !clientDrawing) {
            if (k1 < 16 && l1 > 16) {
   ...
   public boolean mousePressed(int slotIndex, int mouseX, int mouseY, int mouseEvent, int relativeX, int relativeY) {
      if (relativeX <= 32) {
         ...
         if (relativeX < 16 && relativeY < 16 && this.owner.canMoveUp(this, slotIndex) && !this.isClientServer()) {
            this.owner.moveServerUp(this, slotIndex, GuiScreen.isShiftKeyDown());
            return true;
         }

         if (relativeX < 16 && relativeY > 16 && this.owner.canMoveDown(this, slotIndex) && !this.isClientServer()) {
