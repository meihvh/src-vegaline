...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      if (this.doesGuiPauseGame) {
         ...
         this.drawCenteredString(
            ...
            width / 2,
            height / 2 + this.fontRendererObj.FONT_HEIGHT * 2,
            16777215
         );
      } else {
   ...
   private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
      ...
      bufferbuilder.pos((double)p_146527_1_, (double)(p_146527_2_ + 18), (double)this.zLevel)
         .tex((double)((float)p_146527_3_ * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F))
         .endVertex();
      bufferbuilder.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)this.zLevel)
         ...
         .endVertex();
      bufferbuilder.pos((double)(p_146527_1_ + 18), (double)p_146527_2_, (double)this.zLevel)
         .tex((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)p_146527_4_ * 0.0078125F))
         .endVertex();
      bufferbuilder.pos((double)p_146527_1_, (double)p_146527_2_, (double)this.zLevel)
         .tex((double)((float)p_146527_3_ * 0.0078125F), (double)((float)p_146527_4_ * 0.0078125F))
         .endVertex();
      tessellator.draw();
   }
      ...
      protected void renderStat(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
         if (p_148209_1_ != null) {
            ...
            GuiStats.this.drawString(
               GuiStats.this.fontRendererObj,
               "-",
               p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth("-"),
               p_148209_3_ + 5,
               p_148209_4_ ? 16777215 : 9474192
            );
         }
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         ...
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj,
            s,
            p_192637_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s),
            p_192637_3_ + 1,
            p_192637_1_ % 2 == 0 ? 16777215 : 9474192
         );
      }
   ...
   class StatsMobsList extends GuiSlot {
      ...
      protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
         ...
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj, s1, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, i == 0 ? 6316128 : 9474192
         );
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj, s2, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192
         );
      }
   }
}
