...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener {
   ...
   private void func_191936_c(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_) {
      ...
      if (guiadvancementtab == null) {
         drawRect(p_191936_3_ + 9, (double)(p_191936_4_ + 18), (double)(p_191936_3_ + 9 + 234), (double)(p_191936_4_ + 18 + 113), -16777216);
         String s = I18n.format("advancements.empty");
         int i = this.fontRendererObj.getStringWidth(s);
         this.fontRendererObj.drawString(s, (float)(p_191936_3_ + 9 + 117 - i / 2), (double)(p_191936_4_ + 18 + 56 - this.fontRendererObj.FONT_HEIGHT / 2), -1);
         this.fontRendererObj
            .drawString(
               ":(",
               (float)(p_191936_3_ + 9 + 117 - this.fontRendererObj.getStringWidth(":(") / 2),
               (double)(p_191936_4_ + 18 + 113 - this.fontRendererObj.FONT_HEIGHT),
               -1
            );
      } else {
   ...
   public void func_191934_b(int p_191934_1_, int p_191934_2_) {
      ...
      this.fontRendererObj.drawString(I18n.format("gui.advancements"), (float)(p_191934_1_ + 8), (double)(p_191934_2_ + 6), 4210752);
   }
