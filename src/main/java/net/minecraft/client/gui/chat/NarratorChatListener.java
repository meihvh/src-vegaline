   ...
   public void func_192576_a(ChatType p_192576_1_, ITextComponent p_192576_2_) {
      ...
      if (i != 0 && this.field_192580_a.active() && (i == 1 || i == 2 && p_192576_1_ == ChatType.CHAT || i == 3 && p_192576_1_ == ChatType.SYSTEM)) {
         if (p_192576_2_ instanceof TextComponentTranslation && "chat.type.text".equals(((TextComponentTranslation)p_192576_2_).getKey())) {
            this.field_192580_a
               .say(new TextComponentTranslation("chat.type.text.narrate", ((TextComponentTranslation)p_192576_2_).getFormatArgs()).getUnformattedText());
         } else {
      ...
      this.field_192580_a
         .say(
            new TextComponentTranslation("options.narrator").getUnformattedText()
               + " : "
               + new TextComponentTranslation(GameSettings.field_193632_b[p_193641_1_]).getUnformattedText()
         );
      GuiToast guitoast = Minecraft.getMinecraft().func_193033_an();
      if (this.field_192580_a.active()) {
         if (p_193641_1_ == 0) {
            SystemToast.func_193657_a(guitoast, SystemToast.Type.NARRATOR_TOGGLE, new TextComponentTranslation("narrator.toast.disabled"), (ITextComponent)null);
         } else {
            SystemToast.func_193657_a(
               guitoast,
               SystemToast.Type.NARRATOR_TOGGLE,
               new TextComponentTranslation("narrator.toast.enabled"),
               new TextComponentTranslation(GameSettings.field_193632_b[p_193641_1_])
            );
         }
      } else {
         SystemToast.func_193657_a(
