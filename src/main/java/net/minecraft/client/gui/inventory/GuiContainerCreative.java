...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   public void handleMouseClick(@Nullable Slot slotIn, int slotId, int mouseButton, ClickType type) {
      ...
      if (slotIn == null && selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && type != ClickType.QUICK_CRAFT) {
         ...
         if (slotIn == this.destroyItemSlot && flag) {
            ...
            if (slotIn == this.destroyItemSlot) {
            ...
            } else if (type == ClickType.THROW && !Minecraft.player.inventory.getItemStack().func_190926_b()) {
               ...
               Minecraft.player
                  .inventoryContainer
                  .slotClick(slotIn == null ? slotId : ((GuiContainerCreative.CreativeSlot)slotIn).slot.slotNumber, mouseButton, type, Minecraft.player);
            ...
            this.inventorySlots.slotClick(slotIn == null ? slotId : slotIn.slotNumber, mouseButton, type, Minecraft.player);
   ...
   private void updateCreativeSearch() {
      ...
      if (this.searchField.getText().isEmpty()) {
         ...
         guicontainercreative$containercreative.itemList
            .addAll(this.mc.func_193987_a(SearchTreeManager.field_194011_a).func_194038_a(this.searchField.getText().toLowerCase(Locale.ROOT)));
      }
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      if (creativetabs.drawInForegroundOfTab()) {
         ...
         this.fontRendererObj.drawString(I18n.format(creativetabs.getTranslatedTabLabel()), 8.0F, 6.0, 4210752);
      }
   }
   ...
   protected void renderToolTip(ItemStack stack, int x, int y) {
      if (selectedTabIndex == CreativeTabs.SEARCH.getTabIndex()) {
         List<String> list = stack.getTooltip(
            Minecraft.player, this.mc.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL
         );
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (creativetabs == CreativeTabs.INVENTORY) {
         GuiInventory.drawEntityOnScreen(
            this.guiLeft + 88, this.guiTop + 45, 20.0F, (float)(this.guiLeft + 88 - mouseX), (float)(this.guiTop + 45 - 30 - mouseY), Minecraft.player
         );
      }
   }
