...
public class GuiScreenHorseInventory extends GuiContainer {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      this.fontRendererObj.drawString(this.horseInventory.getDisplayName().getUnformattedText(), 8.0F, 6.0, 4210752);
      this.fontRendererObj.drawString(this.playerInventory.getDisplayName().getUnformattedText(), 8.0F, (double)(this.ySize - 96 + 2), 4210752);
   }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (this.horseEntity instanceof AbstractChestHorse abstractchesthorse && abstractchesthorse.func_190695_dh()) {
