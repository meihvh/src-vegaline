...
public class GhostRecipe {
   ...
   public void func_194188_a(Minecraft p_194188_1_, int p_194188_2_, int p_194188_3_, boolean p_194188_4_, float p_194188_5_) {
      ...
      for (int i = 0; i < this.field_192688_b.size(); i++) {
         ...
         if (i == 0 && p_194188_4_) {
            Gui.drawRect(j - 4, (double)(k - 4), (double)(j + 20), (double)(k + 20), 822018048);
         } else {
            Gui.drawRect(j, (double)k, (double)(j + 16), (double)(k + 16), 822018048);
         }
         ...
         Gui.drawRect(j, (double)k, (double)(j + 16), (double)(k + 16), 822083583);
