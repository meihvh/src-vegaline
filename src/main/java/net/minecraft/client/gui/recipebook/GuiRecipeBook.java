...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener {
   ...
   private void func_193003_g(boolean p_193003_1_) {
      ...
      if (list != null) {
         list.forEach(
            p_193944_1_ -> p_193944_1_.func_194210_a(this.field_193965_u, this.field_193961_o.getWidth(), this.field_193961_o.getHeight(), this.field_193964_s)
         );
   ...
   private void func_193015_d(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_) {
      ...
      if (itemstack != null && this.field_191888_F.currentScreen != null) {
         this.field_191888_F.currentScreen.drawHoveringText(GuiScreen.func_191927_a(itemstack), p_193015_3_, p_193015_4_);
      }
   }
      ...
      if (this.func_191878_b() && !Minecraft.player.isSpectator()) {
         if (this.field_193022_s
            ...
            if (irecipe != null && recipelist != null) {
               ...
               this.field_191888_F
                  .playerController
                  .func_194338_a(Minecraft.player.openContainer.windowId, irecipe, GuiScreen.isShiftKeyDown(), Minecraft.player);
   ...
   private void func_193716_a(String p_193716_1_) {
      if ("excitedze".equals(p_193716_1_)) {
         ...
         this.field_191888_F
            .fontRendererObj
            .setUnicodeFlag(this.field_191888_F.getLanguageManager().isCurrentLocaleUnicode() || this.field_191888_F.gameSettings.forceUnicodeFont);
