...
public class GuiRecipeOverlay extends Gui {
   ...
   class Button extends GuiButton {
      ...
      public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
         ...
         int k = 3;
         int l = 3;
         if (this.field_193924_p instanceof ShapedRecipes shapedrecipes) {
            ...
            for (int k1 = 0; k1 < k; k1++) {
               if (iterator.hasNext()) {
                  ...
                  if (aitemstack.length != 0) {
                     ...
                     p_191745_1_.getRenderItem()
                        .renderItemAndEffectIntoGUI(aitemstack[MathHelper.floor(GuiRecipeOverlay.this.field_193974_m / 30.0F) % aitemstack.length], i2, j2);
