...
public class RecipeBookPage {
   ...
   public void func_194191_a(int p_194191_1_, int p_194191_2_, int p_194191_3_, int p_194191_4_, float p_194191_5_) {
      if (this.field_193737_b > 1) {
         ...
         this.field_193754_s.fontRendererObj.drawString(s, (float)(p_194191_1_ - i / 2 + 73), (double)(p_194191_2_ + 141), -1);
      }
            ...
            if (guibuttonrecipe.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_)) {
               ...
               if (p_194196_3_ == 0) {
                  ...
                  this.field_194202_c
                     .func_191845_a(
                        this.field_193754_s,
                        guibuttonrecipe.func_191771_c(),
                        guibuttonrecipe.xPosition,
                        guibuttonrecipe.yPosition,
