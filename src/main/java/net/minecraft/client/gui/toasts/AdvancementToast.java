      ...
      if (displayinfo != null) {
         ...
         if (list.size() == 1) {
            p_193653_1_.func_192989_b()
               .fontRendererObj
               .drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30.0F, 7.0, i | 0xFF000000);
            ...
            if (p_193653_2_ < 1500L) {
               ...
               p_193653_1_.func_192989_b()
                  .fontRendererObj
                  .drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30.0F, 11.0, i | k);
            } else {
               ...
               for (String s : list) {
                  p_193653_1_.func_192989_b().fontRendererObj.drawString(s, 30.0F, (double)l, 16777215 | i1);
