...
public class ModelBat extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      if (((EntityBat)entityIn).getIsBatHanging()) {
         this.batHead.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
         this.batHead.rotateAngleY = (float) Math.PI - netHeadYaw * (float) (Math.PI / 180.0);
         ...
         this.batHead.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
         this.batHead.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
