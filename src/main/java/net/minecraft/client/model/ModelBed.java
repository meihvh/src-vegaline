...
public class ModelBed extends ModelBase {
   ...
   public ModelBed() {
      ...
      this.field_193774_c[0].rotateAngleX = (float) (Math.PI / 2);
      this.field_193774_c[1].rotateAngleX = (float) (Math.PI / 2);
      this.field_193774_c[2].rotateAngleX = (float) (Math.PI / 2);
      this.field_193774_c[3].rotateAngleX = (float) (Math.PI / 2);
      this.field_193774_c[0].rotateAngleZ = 0.0F;
      this.field_193774_c[1].rotateAngleZ = (float) (Math.PI / 2);
      this.field_193774_c[2].rotateAngleZ = (float) (Math.PI * 3.0 / 2.0);
