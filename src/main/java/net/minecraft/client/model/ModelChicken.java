...
public class ModelChicken extends ModelBase {
   ...
   public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      boolean steve = BadTrip.get.isSteveChiken();
      ResourceLocation old = RenderChicken.CHICKEN_TEXTURES;
      if (steve) {
         RenderChicken.CHICKEN_TEXTURES = BadTrip.STEVE;
         Minecraft.getMinecraft().getTextureManager().bindTexture(RenderChicken.CHICKEN_TEXTURES);
      }
      ...
      if (steve) {
         RenderChicken.CHICKEN_TEXTURES = old;
         Minecraft.getMinecraft().getTextureManager().bindTexture(RenderChicken.CHICKEN_TEXTURES);
      }
   }
