...
public class ModelDragon extends ModelBase {
   ...
   public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      this.jaw.rotateAngleX = (float)(Math.sin((double)(f * (float) (Math.PI * 2))) + 1.0) * 0.2F;
      ...
      for (int i = 0; i < 5; i++) {
         ...
         this.spine.rotateAngleY = this.updateRotations(adouble1[0] - adouble[0]) * (float) (Math.PI / 180.0) * 1.5F;
         this.spine.rotateAngleX = f9 + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
         this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - (double)f7) * (float) (Math.PI / 180.0) * 1.5F;
      ...
      this.head.rotateAngleY = this.updateRotations(adouble2[0] - adouble[0]) * (float) (Math.PI / 180.0);
      this.head.rotateAngleX = this.updateRotations((double)entitydragon.getHeadPartYOffset(6, adouble, adouble2)) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
      this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - (double)f7) * (float) (Math.PI / 180.0);
      ...
      float f10 = -((float)Math.sin((double)(f * (float) (Math.PI * 2)))) * 0.0F;
      ...
      for (int k = 0; k < 12; k++) {
         ...
         this.spine.rotateAngleY = (this.updateRotations(adouble2[0] - adouble[0]) * 1.5F + 180.0F) * (float) (Math.PI / 180.0);
         this.spine.rotateAngleX = f10 + (float)(adouble2[1] - adouble[1]) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
         this.spine.rotateAngleZ = this.updateRotations(adouble2[0] - (double)f7) * (float) (Math.PI / 180.0) * 1.5F;
         this.spine.rotationPointY = f2;
         this.spine.rotationPointZ = f3;
         this.spine.rotationPointX = f4;
         f2 = (float)((double)f2 + Math.sin((double)this.spine.rotateAngleX) * 10.0);
