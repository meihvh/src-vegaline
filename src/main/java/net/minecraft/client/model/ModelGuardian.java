...
public class ModelGuardian extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      this.guardianBody.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
      this.guardianBody.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      ...
      if (entity != null) {
         ...
         Vec3d vec3d3 = new Vec3d(vec3d1.xCoord - vec3d.xCoord, 0.0, vec3d1.zCoord - vec3d.zCoord).normalize().rotateYaw((float) (Math.PI / 2));
