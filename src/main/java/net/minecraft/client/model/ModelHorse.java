...
public class ModelHorse extends ModelBase {
   ...
   public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
      ...
      this.head.rotateAngleX = f6 * ((float) (Math.PI / 12) + f4) + f5 * 2.1816616F + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleX;
      this.head.rotateAngleY = f6 * f3 * (float) (Math.PI / 180.0) + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleY;
      ...
      this.body.rotateAngleX = f6 * (float) (-Math.PI / 4) + f7 * this.body.rotateAngleX;
      ...
      this.lowerMouth.rotateAngleX = (float) (Math.PI / 20) * f8;
      ...
      this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f12 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos((float) (-Math.PI / 2) + f12 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f12 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
      this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos((float) (-Math.PI / 2) + f12 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
      float f14 = ((float) (-Math.PI / 3) + f13) * f6 + f11 * f7;
      float f15 = ((float) (-Math.PI / 3) - f13) * f6 + -f11 * f7;
      this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f14) * 7.0F;
      this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + MathHelper.cos((float) (-Math.PI / 2) + f14) * 7.0F;
      this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f15) * 7.0F;
      this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos((float) (-Math.PI / 2) + f15) * 7.0F;
      ...
      f12 = (float) (-Math.PI * 5.0 / 12.0) + p_78086_3_ * 1.5F;
      if (f12 > 0.0F) {
         f12 = 0.0F;
      }
      ...
      this.tailTip.rotateAngleX = (float) (-Math.PI / 12) + f12;
   }
}
