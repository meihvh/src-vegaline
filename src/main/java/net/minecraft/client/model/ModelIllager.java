...
public class ModelIllager extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      this.field_191217_a.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
      this.field_191217_a.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      ...
      if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.ATTACKING) {
         ...
         this.field_191223_g.rotateAngleY = (float) (Math.PI / 20);
         this.field_191224_h.rotateAngleY = (float) (-Math.PI / 20);
         ...
         this.field_191223_g.rotateAngleZ = this.field_191223_g.rotateAngleZ + MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F;
         this.field_191224_h.rotateAngleZ = this.field_191224_h.rotateAngleZ - (MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F);
         this.field_191223_g.rotateAngleX = this.field_191223_g.rotateAngleX + MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
         this.field_191224_h.rotateAngleX = this.field_191224_h.rotateAngleX - MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
         ...
         this.field_191223_g.rotateAngleZ = (float) (Math.PI * 3.0 / 4.0);
         this.field_191224_h.rotateAngleZ = (float) (-Math.PI * 3.0 / 4.0);
         ...
         this.field_191223_g.rotateAngleX = (float) (-Math.PI / 2) + this.field_191217_a.rotateAngleX;
         ...
         this.field_191224_h.rotateAngleZ = (float) (Math.PI / 2);
      }
   }
