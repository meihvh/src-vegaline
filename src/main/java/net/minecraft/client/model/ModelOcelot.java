...
public class ModelOcelot extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      this.ocelotHead.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.ocelotHead.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
      if (this.state != 3) {
