...
public class ModelParrot extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      this.field_192768_e.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.field_192768_e.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
      ...
      if (this.field_192775_l != ModelParrot.State.FLYING) {
         ...
         this.field_192773_j.rotateAngleX = this.field_192773_j.rotateAngleX + MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
         this.field_192774_k.rotateAngleX = this.field_192774_k.rotateAngleX + MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
      }
   ...
   public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
      ...
      this.field_192766_c.rotateAngleX = (float) -Math.PI * 2.0F / 9.0F;
      this.field_192766_c.rotateAngleY = (float) -Math.PI;
      this.field_192767_d.rotateAngleX = (float) -Math.PI * 2.0F / 9.0F;
      ...
      if (entitylivingbaseIn instanceof EntityParrot entityparrot) {
         if (entityparrot.func_192004_dr()) {
            this.field_192773_j.rotateAngleZ = (float) (-Math.PI / 9);
            this.field_192774_k.rotateAngleZ = (float) (Math.PI / 9);
         ...
         if (entityparrot.isSitting()) {
            ...
            this.field_192773_j.rotateAngleX += (float) Math.PI * 2.0F / 9.0F;
            this.field_192774_k.rotateAngleX += (float) Math.PI * 2.0F / 9.0F;
