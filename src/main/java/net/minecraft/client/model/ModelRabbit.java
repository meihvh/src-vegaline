...
public class ModelRabbit extends ModelBase {
   ...
   public void setRotationAngles(
      ...
      this.rabbitNose.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.rabbitHead.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.rabbitRightEar.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.rabbitLeftEar.rotateAngleX = headPitch * (float) (Math.PI / 180.0);
      this.rabbitNose.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
      this.rabbitHead.rotateAngleY = netHeadYaw * (float) (Math.PI / 180.0);
