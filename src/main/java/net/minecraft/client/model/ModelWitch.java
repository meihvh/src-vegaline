...
public class ModelWitch extends ModelVillager {
   ...
   public void setRotationAngles(
      ...
      this.villagerNose.rotateAngleX = MathHelper.sin((float)entityIn.ticksExisted * f) * 4.5F * (float) (Math.PI / 180.0);
      this.villagerNose.rotateAngleY = 0.0F;
      this.villagerNose.rotateAngleZ = MathHelper.cos((float)entityIn.ticksExisted * f) * 2.5F * (float) (Math.PI / 180.0);
      if (this.holdingItem) {
