...
public class WorldClient extends World {
   ...
   public void tick() {
      ...
      if (!Minecraft.temporalImageSizeMoreThan16x && Minecraft.player != null && Minecraft.player.ticksExisted > 800) {
         try {
   ...
   public Entity getEntityByID(int id) {
      return (Entity)(Minecraft.player != null && id == Minecraft.player.getEntityId() ? Minecraft.player : super.getEntityByID(id));
   }
   ...
   public void showBarrierParticles(
      int p_184153_1_, int p_184153_2_, int p_184153_3_, int p_184153_4_, Random random, boolean p_184153_6_, BlockPos.MutableBlockPos pos
   ) {
   ...
   public void removeAllEntities() {
      ...
      boolean instRemove = !Panic.stop && AntiBot.get != null && AntiBot.get.isActived() && AntiBot.get.RemoveLagEnts.getBool();
      ...
      for (int j1 = 0; j1 < this.loadedEntityList.size(); j1++) {
         ...
         if (entity1.isDead) {
            ...
            if (entity1.addedToChunk && this.isChunkLoaded(k1, l, true) || instRemove) {
   ...
   private boolean isPlayerActing() {
      return this.mc.playerController instanceof PlayerControllerOF playercontrollerof ? playercontrollerof.isActing() : false;
   }
