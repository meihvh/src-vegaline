...
public class ParticleSpit extends ParticleExplosion {
   protected ParticleSpit(
      World p_i47221_1_, double p_i47221_2_, double p_i47221_4_, double p_i47221_6_, double p_i47221_8_, double p_i47221_10_, double p_i47221_12_
   ) {
   ...
   public void onUpdate() {
      super.onUpdate();
      this.motionY = this.motionY - (0.004 + 0.04 * (double)this.particleGravity);
   }
