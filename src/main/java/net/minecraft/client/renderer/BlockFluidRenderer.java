      ...
      try {
         ...
         if (flag1 || flag2 || aboolean[0] || aboolean[1] || aboolean[2] || aboolean[3]) {
            ...
            if (flag2) {
               ...
               int i2 = l1 >> 16 & 65535;
               int j2 = l1 & 65535;
               worldRendererIn.pos(d0, d1, d2 + 1.0).color(f * 0.5F, f1 * 0.5F, f2 * 0.5F, 1.0F).tex((double)f38, (double)f41).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0, d1, d2).color(f * 0.5F, f1 * 0.5F, f2 * 0.5F, 1.0F).tex((double)f38, (double)f40).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0 + 1.0, d1, d2).color(f * 0.5F, f1 * 0.5F, f2 * 0.5F, 1.0F).tex((double)f39, (double)f40).lightmap(i2, j2).endVertex();
               worldRendererIn.pos(d0 + 1.0, d1, d2 + 1.0)
                  .color(f * 0.5F, f1 * 0.5F, f2 * 0.5F, 1.0F)
                  .tex((double)f39, (double)f41)
                  .lightmap(i2, j2)
                  .endVertex();
               flag3 = true;
            }
            ...
            for (int i1 = 0; i1 < 4; i1++) {
               ...
               if (!flag) {
                  ...
                  if (block instanceof BlockSlab blockslab && !blockslab.isDouble() && iblockstate.getValue(BlockSlab.HALF) == BlockSlab.EnumBlockHalf.BOTTOM) {
                     f42 = 0.5F;
                     f43 = 0.5F;
                  }
               }
