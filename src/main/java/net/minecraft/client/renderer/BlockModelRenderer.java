...
public class BlockModelRenderer {
   ...
   private void renderQuadsSmooth(
      ...
      BufferBuilder p_renderQuadsSmooth_4_,
      ...
      int i = 0;
      float[] facesColorMultShadow = blockmodelrenderer$ambientocclusionface.vertexColorMultiplier;
      float[] facesColorMultGround = blockmodelrenderer$ambientocclusionface.vertexColorMultiplier;
      int[] facesBrightness = blockmodelrenderer$ambientocclusionface.vertexBrightness;
      boolean mulToDarkest = WorldRender.isDeepShadows();
      ...
      for (int j = p_renderQuadsSmooth_5_.size(); i < j; i++) {
         ...
         blockmodelrenderer$ambientocclusionface.updateVertexBrightness(
            p_renderQuadsSmooth_1_, p_renderQuadsSmooth_2_, p_renderQuadsSmooth_3_, bakedquad.getFace(), afloat, bitset
         );
         if (mulToDarkest) {
            for (int k = 0; k < facesColorMultShadow.length; k++) {
               facesColorMultShadow[k] *= 0.5F + facesColorMultShadow[k] / 2.0F;
            }

            for (int k = 0; k < facesColorMultGround.length; k++) {
               facesColorMultGround[k] *= 0.5F + facesColorMultGround[k] / 2.0F;
            }
         }
         ...
         p_renderQuadsSmooth_4_.putBrightness4(facesBrightness[0], facesBrightness[1], facesBrightness[2], facesBrightness[3]);
         if (bakedquad.shouldApplyDiffuseLighting()) {
            float f = FaceBakery.getFaceBrightness(bakedquad.getFace());
            facesColorMultShadow[0] *= f;
            facesColorMultShadow[1] *= f;
            facesColorMultShadow[2] *= f;
            facesColorMultShadow[3] *= f;
         }
         ...
         if (!bakedquad.hasTintIndex() && l == -1) {
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultShadow[0], facesColorMultShadow[0], facesColorMultShadow[0], 4);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultShadow[1], facesColorMultShadow[1], facesColorMultShadow[1], 3);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultShadow[2], facesColorMultShadow[2], facesColorMultShadow[2], 2);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultShadow[3], facesColorMultShadow[3], facesColorMultShadow[3], 1);
         } else {
            int k = l;
            if (l == -1) {
            ...
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultGround[0] * f1, facesColorMultGround[0] * f2, facesColorMultGround[0] * f3, 4);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultGround[1] * f1, facesColorMultGround[1] * f2, facesColorMultGround[1] * f3, 3);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultGround[2] * f1, facesColorMultGround[2] * f2, facesColorMultGround[2] * f3, 2);
            p_renderQuadsSmooth_4_.putColorMultiplier(facesColorMultGround[3] * f1, facesColorMultGround[3] * f2, facesColorMultGround[3] * f3, 1);
         }
   ...
   private void renderQuadsFlat(
      ...
      int p_renderQuadsFlat_4_,
      boolean p_renderQuadsFlat_5_,
      BufferBuilder p_renderQuadsFlat_6_,
      List<BakedQuad> p_renderQuadsFlat_7_,
      RenderEnv p_renderQuadsFlat_8_
   ) {
   ...
   private void renderOverlayModels(
      ...
      BufferBuilder p_renderOverlayModels_5_,
                  ...
                  for (int j = 0; j < listquadsoverlay.size(); j++) {
                     ...
                     if (p_renderOverlayModels_10_) {
                        ...
                        this.renderQuadsFlat(
                           p_renderOverlayModels_1_, iblockstate, p_renderOverlayModels_4_, k, false, bufferbuilder, list, p_renderOverlayModels_9_
                        );
                     }
                  }
               }
      ...
      if (Config.isBetterSnow()
         ...
         this.renderModel(
            ...
            p_renderOverlayModels_5_,
            p_renderOverlayModels_6_,
            p_renderOverlayModels_7_
         );
      }
   }
