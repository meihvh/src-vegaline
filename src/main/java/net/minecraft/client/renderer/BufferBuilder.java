...
public class BufferBuilder {
   ...
   public BufferBuilder tex(int[] uv) {
      return this.tex((double)uv[0], (double)uv[1]);
   }

   public BufferBuilder tex(double[] uv) {
      return this.tex(uv[0], uv[1]);
   }
   ...
   public BufferBuilder color(int color) {
      return this.color(
         ColorUtils.getRedFromColor(color), ColorUtils.getGreenFromColor(color), ColorUtils.getBlueFromColor(color), ColorUtils.getAlphaFromColor(color)
      );
   }
