...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void func_191967_a(IBakedModel p_191967_1_, int p_191967_2_, ItemStack p_191967_3_) {
      ...
      boolean renderAltMathod = !Panic.stop
         && (
            ItemRenderer.isRender3dHand && ViewModel.get.isModelWeldRenderFixActived()
               || this.renderItemGui && ComfortUi.get != null && ComfortUi.get.isHDGuiItems() && this.zLevel != -100.0F
         );
      if (renderAltMathod) {
         GL11.glDepthMask(false);
         GL11.glLineWidth(ItemRenderer.isRender3dHand ? 1.5F : 0.33333F * (float)ScaledResolution.getScaleFactor());
         GL11.glEnable(2848);
         GL11.glHint(3154, 4354);
         bufferbuilder.begin(1, DefaultVertexFormats.ITEM);
         ...
         tessellator.draw();
         bufferbuilder.begin(10, DefaultVertexFormats.ITEM);
   ...
   final boolean cancelGlint() {
      return NoRender.get.actived && NoRender.get.EnchGlintEffect.getBool();
   }
   ...
   public void renderItem(ItemStack stack, IBakedModel model) {
      if (!stack.func_190926_b()) {
         ...
         if (model.isBuiltInRenderer()) {
            ...
            if (stack.hasEffect() && (!Config.isCustomItems() || !this.cancelGlint() && !CustomItems.renderCustomEffect(this, stack, model))) {
   ...
   private void func_191966_a(IBakedModel p_191966_1_) {
      if ((!Config.isCustomItems() || CustomItems.isUseGlint()) && (!Config.isShaders() || !Shaders.isShadowPass)) {
         if (NoRender.get.actived && NoRender.get.EnchGlintEffect.getBool()) {
            return;
         }
   ...
   public IBakedModel getItemModelWithOverrides(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entitylivingbaseIn) {
      ...
      if (Reflector.ForgeItemOverrideList_handleItemState.exists()) {
         return (IBakedModel)Reflector.call(
            ibakedmodel.getOverrides(), Reflector.ForgeItemOverrideList_handleItemState, ibakedmodel, stack, worldIn, entitylivingbaseIn
         );
   ...
   protected void func_191962_a(ItemStack p_191962_1_, int p_191962_2_, int p_191962_3_, IBakedModel p_191962_4_) {
      ...
      if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
         p_191962_4_ = (IBakedModel)Reflector.call(
            Reflector.ForgeHooksClient_handleCameraTransforms, p_191962_4_, ItemCameraTransforms.TransformType.GUI, false
         );
      } else {
   ...
   public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
      if (!stack.func_190926_b()) {
         ...
         if (ReflectorForge.isItemDamaged(stack)) {
            ...
            if (stack.getItem() instanceof ItemArmor armor && armor.getArmorMaterial() == ItemArmor.ArmorMaterial.NETHERITE) {
               f1 = (float)new int[]{481, 555, 592, 407}[armor.armorType.getIndex()];
            }
   ...
   public void renderItemOverlayIntoGUI20(CFontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
      if (!stack.func_190926_b()) {
         ...
         if (stack.func_190916_E() != 1 || text != null) {
            ...
            GlStateManager.disableDepth();
            GlStateManager.disableBlend();
            fr.drawStringWithOutline(s, (float)(xPosition + 19 - 2) - fr.getStringWidth(s), (float)(yPosition + 8), 16777215);
            GlStateManager.enableLighting();
            GlStateManager.enableDepth();
            GlStateManager.enableBlend();
         }
   ...
   public void renderItemOverlayIntoGUI(CFontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
      if (!stack.func_190926_b()) {
         if ((stack.func_190916_E() != 1 || text != null) && fr != null) {
            String s = text == null ? String.valueOf(stack.func_190916_E()) : text;
            GlStateManager.disableLighting();
            GlStateManager.disableDepth();
            GlStateManager.disableBlend();
   ...
   public void renderItemOverlayIntoGUIWithTextColor(CFontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text, int color) {
      if (!stack.func_190926_b()) {
         if (stack.func_190916_E() != 1 || text != null) {
            ...
            GlStateManager.disableBlend();
            if (fr != null) {
               fr.drawStringWithShadow(s, (float)(xPosition + 19 - 2) - fr.getStringWidth(s), (float)(yPosition + 6 + 3), color);
            }
