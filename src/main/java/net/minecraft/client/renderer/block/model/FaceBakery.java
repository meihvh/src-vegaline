...
public class FaceBakery {
   ...
   public BakedQuad makeBakedQuad(
      ...
      if (p_makeBakedQuad_8_) {
         if (Reflector.ForgeHooksClient_applyUVLock.exists()) {
            blockfaceuv = (BlockFaceUV)Reflector.call(
               Reflector.ForgeHooksClient_applyUVLock, p_makeBakedQuad_3_.blockFaceUV, p_makeBakedQuad_5_, p_makeBakedQuad_6_
            );
         } else {
   ...
   private int[] makeQuadVertexData(
      BlockFaceUV p_makeQuadVertexData_1_,
      ...
      @Nullable BlockPartRotation p_makeQuadVertexData_6_,
   ...
   private void storeVertexData(
      ...
      faceData[j + 4] = Float.floatToRawIntBits(
         sprite.getInterpolatedU((double)faceUV.getVertexU(vertexIndex) * 0.999 + (double)faceUV.getVertexU((vertexIndex + 2) % 4) * 0.001)
      );
      faceData[j + 4 + 1] = Float.floatToRawIntBits(
         sprite.getInterpolatedV((double)faceUV.getVertexV(vertexIndex) * 0.999 + (double)faceUV.getVertexV((vertexIndex + 2) % 4) * 0.001)
      );
   }
