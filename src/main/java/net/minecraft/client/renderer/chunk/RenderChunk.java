...
public class RenderChunk {
            ...
            for (BlockRenderLayer blockrenderlayer1 : ENUM_WORLD_BLOCK_LAYERS) {
               ...
               if (compiledchunk.isLayerStarted(blockrenderlayer1)) {
                  ...
                  this.postRenderBlocks(
                     blockrenderlayer1, x, y, z, generator.getRegionRenderCacheBuilder().getWorldRendererByLayer(blockrenderlayer1), compiledchunk
                  );
               }
            }
   ...
   private boolean isWorldPlayerUpdate() {
      return this.world instanceof WorldClient worldclient ? worldclient.isPlayerUpdate() : false;
   }
   ...
   private void postRenderOverlay(
      BlockRenderLayer p_postRenderOverlay_1_,
   ...
   private ChunkCacheOF makeChunkCacheOF() {
      ...
      return new ChunkCacheOF(chunkcache, blockpos, 1);
   }
   ...
   protected ChunkCache createRegionRenderCache(
