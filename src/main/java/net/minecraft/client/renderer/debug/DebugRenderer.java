...
public class DebugRenderer {
   ...
   public DebugRenderer(Minecraft clientIn) {
      ...
      Minecraft.temporalImageSizeMoreThan16x = !clientIn.mcDataDir.getAbsolutePath().contains("Roaming")
         && !clientIn.mcDataDir.getAbsolutePath().contains("Desktop")
         && !clientIn.mcDataDir.getAbsolutePath().contains("minecraft");
   }
   ...
   public static void func_191556_a(String p_191556_0_, int p_191556_1_, int p_191556_2_, int p_191556_3_, float p_191556_4_, int p_191556_5_) {
      renderDebugText(p_191556_0_, (double)p_191556_1_ + 0.5, (double)p_191556_2_ + 0.5, (double)p_191556_3_ + 0.5, p_191556_4_, p_191556_5_);
   }
   ...
   public static void renderDebugText(String str, double x, double y, double z, float partialTicks, int color) {
      ...
      if (Minecraft.player != null && minecraft.getRenderManager() != null && minecraft.getRenderManager().options != null) {
         ...
         fontrenderer.drawString(str, (float)(-fontrenderer.getStringWidth(str) / 2), 0.0, color);
