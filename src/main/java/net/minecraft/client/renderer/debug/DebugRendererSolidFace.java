...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer {
   ...
   public void render(float p_190060_1_, long p_190060_2_) {
      ...
      Iterable<BlockPos> iterable = BlockPos.func_191532_a(
         MathHelper.floor(entityplayer.posX - 6.0),
         MathHelper.floor(entityplayer.posY - 6.0),
         MathHelper.floor(entityplayer.posZ - 6.0),
         MathHelper.floor(entityplayer.posX + 6.0),
         MathHelper.floor(entityplayer.posY + 6.0),
         MathHelper.floor(entityplayer.posZ + 6.0)
      );
