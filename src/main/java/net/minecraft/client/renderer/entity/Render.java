...
public abstract class Render<T extends Entity> implements IEntityRenderer {
   ...
   public boolean shouldRender(T livingEntity, ICamera camera, double camX, double camY, double camZ) {
      AxisAlignedBB axisalignedbb = livingEntity.getRenderBoundingBox().expandXyz(0.5);
   ...
   protected boolean bindEntityTexture(T entity) {
      ...
      resourcelocation = WorldRender.get.updatedResourceSkin(resourcelocation, entity);
   ...
   private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks) {
      ...
      float f4 = (float)(entity.posY - entity.getEntityBoundingBoxCLCompact().minY);
      GlStateManager.rotate(this.renderManager.playerViewY + WorldRender.get.offYawOrient, 0.0F, -1.0F, 0.0F);
   ...
   private void renderShadowSingle(
      ...
      if (state.isFullCube()) {
         Tessellator tessellator = Tessellator.getInstance();
         BufferBuilder bufferbuilder = tessellator.getBuffer();
         double d0 = ((double)p_188299_9_ - (p_188299_4_ - ((double)p_188299_8_.getY() + p_188299_13_)) / 2.0)
            * 0.5
            * (double)this.getWorldFromRenderManager().getLightBrightness(p_188299_8_);
         if (d0 >= 0.0) {
            if (d0 > 1.0) {
               d0 = 1.0;
            }
   ...
   public void doRenderShadowAndFire(Entity entityIn, double x, double y, double z, float yaw, float partialTicks) {
      if (this.renderManager.options != null) {
         ...
         if (entityIn.canRenderOnFire()
            ...
            && (!NoRender.get.actived || !NoRender.get.FireOnEntity.getBool())) {
   ...
   protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      ...
      if (this.canRenderName(entityIn)) {
         if (d0 <= (double)(maxDistance * maxDistance)) {
            ...
            boolean var10000;
            label31: {
               flag = entityIn.isSneaking();
               f = this.renderManager.playerViewY;
               f1 = this.renderManager.playerViewX;
               flag1 = this.renderManager.options.thirdPersonView == 2;
            ...
            boolean isChild = var10000;
            float f2 = entityIn.height / (isChild ? 1.8F : 1.0F) + 0.3F - (flag ? 0.25F : 0.0F);
