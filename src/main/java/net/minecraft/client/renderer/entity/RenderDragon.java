...
public class RenderDragon extends RenderLiving<EntityDragon> {
   ...
   protected void renderModel(
      EntityDragon entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor
   ) {
   ...
   public static void renderCrystalBeams(
      ...
      GlStateManager.rotate((float)(-Math.atan2((double)f2, (double)f)) * (180.0F / (float)Math.PI) - 90.0F, 0.0F, 1.0F, 0.0F);
      GlStateManager.rotate((float)(-Math.atan2((double)f3, (double)f1)) * (180.0F / (float)Math.PI) - 90.0F, 1.0F, 0.0F, 0.0F);
