...
public class RenderEnderCrystal extends Render<EntityEnderCrystal> {
   ...
   public void doRender(EntityEnderCrystal entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (this.renderOutlines) {
       ...
       float finalF = f1;
       Runnable renderModel = () -> this.modelEnderCrystalNoBase.render(entity, 0.0F, f * 3.0F, finalF * 0.2F, 0.0F, 0.0F, 0.0625F);
      ...
      for (Module mx : Client.moduleManager.modules) {
         if (mx.actived) {
            mx.postRenderLivingBase(entity, renderModel, false);
         }
      }
