...
public abstract class RenderLiving<T extends EntityLiving> extends RenderLivingBase<T> {
   ...
   public boolean shouldRender(T livingEntity, ICamera camera, double camX, double camY, double camZ) {
      if (livingEntity.renderCheckIsTrueOnRender = super.shouldRender(livingEntity, camera, camX, camY, camZ)) {
         return true;
      } else if (livingEntity.getLeashed() && livingEntity.getLeashedToEntity() != null) {
         Entity entity = livingEntity.getLeashedToEntity();
         return livingEntity.renderCheckIsTrueOnRender = camera.isBoundingBoxInFrustum(entity.getRenderBoundingBox());
      } else {
         return false;
      }
   }
