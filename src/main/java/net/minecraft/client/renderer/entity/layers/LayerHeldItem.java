...
public class LayerHeldItem implements LayerRenderer<EntityLivingBase> {
   ...
   private void renderHeldItem(EntityLivingBase p_188358_1_, ItemStack p_188358_2_, ItemCameraTransforms.TransformType p_188358_3_, EnumHandSide handSide) {
      if (!p_188358_2_.isEmpty()) {
         ...
         int modelType = 0;
         if (p_188358_1_ instanceof EntityPlayer player) {
            if (modelType == 1) {
         ...
         EnumHandSide s = p_188358_1_.getActiveHand() == EnumHand.MAIN_HAND ? EnumHandSide.RIGHT : EnumHandSide.LEFT;
         if (!Panic.stop
            && p_188358_1_.isEating()
            && (p_188358_1_.getActiveHand() == EnumHand.OFF_HAND || !flag && p_188358_1_.getActiveHand() == EnumHand.MAIN_HAND)
            && handSide == s) {
            float tts = 5.0F;
            ...
            int side = flag ? 1 : -1;
            GL11.glRotated((double)(-(30.0F + upPC * 5.0F)), 1.0, 0.0, 0.0);
            GL11.glRotated((double)(-10 * side), 0.0, 0.0, 1.0);
            GL11.glTranslated((double)(0.2F * (float)side), 0.45F, 0.4F);
            GL11.glRotated(80.0, 1.0, 0.0, 0.0);
            GL11.glRotated((double)(20 * side), 0.0, 0.0, -1.0);
         }
