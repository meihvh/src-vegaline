...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer<TileEntityEnderChest> {
   ...
   public void func_192841_a(
      TileEntityEnderChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_
   ) {
      int i = 0;
      ...
      f = 1.0F - f;
      f = 1.0F - f * f * f;
      this.modelChest.chestLid.rotateAngleX = -(f * (float) (Math.PI / 2));
