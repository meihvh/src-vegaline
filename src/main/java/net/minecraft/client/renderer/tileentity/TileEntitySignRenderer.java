...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer<TileEntitySign> {
   ...
   public void func_192841_a(
      TileEntitySign p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_
   ) {
         ...
         for (int j = 0; j < p_192841_1_.signText.length; j++) {
            if (p_192841_1_.signText[j] != null) {
               ...
               if (j == p_192841_1_.lineBeingEdited) {
                  s = "> " + s + " <";
                  fontrenderer.drawString(s, (float)(-fontrenderer.getStringWidth(s) / 2), (double)(j * 10 - p_192841_1_.signText.length * 5), i);
               } else {
                  fontrenderer.drawString(s, (float)(-fontrenderer.getStringWidth(s) / 2), (double)(j * 10 - p_192841_1_.signText.length * 5), i);
               }
            }
