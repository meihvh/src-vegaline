...
public class GameSettings {
   ...
   public final Set<EnumPlayerModelParts> setModelParts = Sets.newHashSet(EnumPlayerModelParts.values());
   ...
   public void saveOptions() {
      ...
      try {
         ...
         try {
            Integer value = UiScaleControl.oldGuiScalePreSetForce;
            if (value == null) {
   ...
   private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_) {
      ...
      s = s == null ? p_getKeyBindingOF_1_.getEnumString() : s;
