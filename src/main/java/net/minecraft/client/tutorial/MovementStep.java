...
public class MovementStep implements ITutorialStep {
   private static final ITextComponent field_193254_a = new TextComponentTranslation(
      "tutorial.move.title", Tutorial.func_193291_a("forward"), Tutorial.func_193291_a("left"), Tutorial.func_193291_a("back"), Tutorial.func_193291_a("right")
   );
