         ...
         if ("clear".equals(args[1])) {
            ...
            if (j > 0) {
               ...
               notifyCommandListener(
                  ...
                  new Object[]{new TextComponentTranslation(potioneffect.getEffectName()), Potion.getIdFromPotion(potion), k, entitylivingbase.getName(), j}
               );
            } else {
               ...
               notifyCommandListener(
                  sender, this, "commands.effect.success.removed", new Object[]{new TextComponentTranslation(potion.getName()), entitylivingbase.getName()}
               );
            }
         }
      }
