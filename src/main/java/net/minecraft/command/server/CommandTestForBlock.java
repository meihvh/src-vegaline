            ...
            if (!world.isBlockLoaded(blockpos)) {
               ...
               if (block1 != block) {
                  ...
                  try {
                     ...
                     throw new CommandException(
                        "commands.testforblock.failed.data", blockpos.getX(), blockpos.getY(), blockpos.getZ(), i, Integer.parseInt(args[4])
                     );
                  } catch (NumberFormatException var13) {
                     throw new CommandException(
                        "commands.testforblock.failed.data", blockpos.getX(), blockpos.getY(), blockpos.getZ(), iblockstate.toString(), args[4]
                     );
                  }
               } else {
                  if (flag) {
