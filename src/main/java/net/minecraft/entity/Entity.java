...
public abstract class Entity implements ICommandSender {
   ...
   public Vec3d lastPredictVec;
   public boolean predictReachedTick;
   public double posX;
   public double posY;
   public double posZ;
   ...
   public boolean renderCheckIsTrueOnRender = true;
   ...
   private ScopeEntityModelTo2D scope2d;
   ...
   public boolean antiFired = false;
   ...
   public Entity(World worldIn) {
      ...
      this.entityInit();
      this.scope2d = new ScopeEntityModelTo2D(this);
   }

   public ScopeEntityModelTo2D getScope2d() {
      if (this.scope2d == null) {
         this.scope2d = new ScopeEntityModelTo2D(this);
      }
   ...
   public double getSpeed() {
      double dx = this.posX - this.lastTickPosX;
      double dz = this.posZ - this.lastTickPosZ;
      ...
      if (this.world != null) {
         while (true) {
            if (this.posY > 0.0 && this.posY < 256.0) {
               ...
               if (!this.world.getCollisionBoxes(this, this.getEntityBoundingBoxCLCompact()).isEmpty()) {
                  this.posY++;
                  continue;
               }
            }
      ...
      if (width != this.width || height != this.height) {
         ...
         if (this.width < f) {
            ...
            this.setEntityBoundingBox(
               new AxisAlignedBB(this.posX - d0, this.posY, this.posZ - d0, this.posX + d0, this.posY + (double)this.height, this.posZ + d0)
            );
            return;
         }
         ...
         if (this.width > f && !this.firstUpdate && !this.world.isRemote) {
            this.moveEntity(MoverType.SELF, (double)(f - this.width), 0.0, (double)(f - this.width));
         }
      }
   }
   ...
   public static double getRenderX(Entity entityIn) {
      ...
      return entityIn != null && !entityIn.isDead ? xf : 0.0;
   }
   ...
   public static double getRenderY(Entity entityIn) {
      ...
      return entityIn != null && !entityIn.isDead ? yf : 0.0;
   }
   ...
   public static double getRenderZ(Entity entityIn) {
      ...
      return entityIn != null && !entityIn.isDead ? zf : 0.0;
   }
   ...
   public static Vec3d getRenderVecPosEnt(Entity entityIn) {
      ...
      return entityIn != null && !entityIn.isDead ? new Vec3d(xf, yf, zf) : null;
   }
   ...
   public void setPosY(double y) {
      ...
      float f1 = this.height;
      this.setEntityBoundingBox(
         new AxisAlignedBB(this.posX - (double)f, y, this.posZ - (double)f, this.posX + (double)f, y + (double)f1, this.posZ + (double)f)
      );
   }
   ...
   public void onUpdate() {
      ...
      this.onEntityUpdate();
      if (this instanceof EntityLivingBase base) {
         base.totemTick = false;
         if (base.ticksExisted <= 1) {
            base.totemsPopped = 0;
            base.totemTickOutHurt = 0;
         }

         if (base.totemTickOutHurt > 0) {
            base.totemTickOutHurt--;
         }
      }
   }
   ...
   public boolean isOffsetPositionInLiquid(double x, double y, double z) {
      AxisAlignedBB axisalignedbb = this.getEntityBoundingBoxCLCompact().offset(x, y, z);
   ...
   public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
      EventStep step = new EventStep(true, (double)this.stepHeight);
      ...
      AxisAlignedBB before = this.getEntityBoundingBoxCLCompact().addCoord(0.0, 0.0, 0.0);
      Minecraft mc = Minecraft.getMinecraft();
      if (p_70091_2_ != 0.0 || p_70091_4_ != 0.0 || p_70091_6_ != 0.0) {
         this.predictReachedTick = true;
      }
      ...
      AxisAlignedBB aabb = this.getEntityBoundingBoxCLCompact();
      if (this.noClip) {
         this.setEntityBoundingBox(aabb.offset(p_70091_2_, p_70091_4_, p_70091_6_));
         ...
         if (x == MoverType.PISTON) {
            ...
            if (p_70091_2_ != 0.0) {
               ...
               if (Math.abs(p_70091_2_) <= 1.0E-5F) {
                  return;
               }
               ...
               if (Math.abs(p_70091_4_) <= 1.0E-5F) {
                  return;
               }
            } else {
               if (p_70091_6_ == 0.0) {
               ...
               if (Math.abs(p_70091_6_) <= 1.0E-5F) {
                  return;
               }
            }
         }
         ...
         if ((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking() || safeEvent.isCancelled()) {
            for (double d5 = 0.05;
               p_70091_2_ != 0.0 && this.world.getCollisionBoxes(this, aabb.offset(p_70091_2_, (double)(-this.stepHeight), 0.0)).isEmpty();
               d2 = p_70091_2_
            ) {
            ...
            for (; p_70091_6_ != 0.0 && this.world.getCollisionBoxes(this, aabb.offset(0.0, (double)(-this.stepHeight), p_70091_6_)).isEmpty(); d4 = p_70091_6_) {
            ...
            for (;
               p_70091_2_ != 0.0
                  && p_70091_6_ != 0.0
                  && this.world.getCollisionBoxes(this, aabb.offset(p_70091_2_, (double)(-this.stepHeight), p_70091_6_)).isEmpty();
               d4 = p_70091_6_
            ) {
               if (p_70091_2_ < 0.05 && p_70091_2_ >= -0.05) {
                  p_70091_2_ = 0.0;
         ...
         List<AxisAlignedBB> list1 = this.world.getCollisionBoxes(this, aabb.addCoord(p_70091_2_, p_70091_4_, p_70091_6_));
         ...
         if (this instanceof EntityPlayerSP) {
            ...
            if (p_70091_4_ != 0.0) {
               ...
               for (int l = list1.size(); k < l; k++) {
                  p_70091_4_ = list1.get(k).calculateYOffset(axisalignedbb, p_70091_4_);
               }
            ...
            if (p_70091_2_ != 0.0) {
               ...
               for (int l5 = list1.size(); j5 < l5; j5++) {
                  p_70091_2_ = list1.get(j5).calculateXOffset(axisalignedbb, p_70091_2_);
               }
            ...
            if (p_70091_6_ != 0.0) {
               ...
               for (int i6 = list1.size(); k5 < i6; k5++) {
                  p_70091_6_ = list1.get(k5).calculateZOffset(axisalignedbb, p_70091_6_);
               }
            ...
            if (this.stepHeight > 0.0F && flag && (d2 != p_70091_2_ || d4 != p_70091_6_)) {
               ...
               if (this instanceof EntityPlayerSP && p_70091_4_ == 0.6F) {
                  MoveHelper.stairTick = true;
               }

               List<AxisAlignedBB> list = this.world.getCollisionBoxes(this, aabb.addCoord(d2, p_70091_4_, d4));
               AxisAlignedBB axisalignedbb2 = this.getEntityBoundingBoxCLCompact();
               ...
               AxisAlignedBB axisalignedbb4 = this.getEntityBoundingBoxCLCompact();
               ...
               for (int k4 = list.size(); j4 < k4; j4++) {
                  p_70091_4_ = list.get(j4).calculateYOffset(aabb, p_70091_4_);
               }
            ...
            p_70091_2_ = bpMX;
            p_70091_6_ = bpMZ;
            EventMove2 move = new EventMove2(
               new Vec3d(this.posX, this.posY, this.posZ),
               new Vec3d(predictX, predictY, predictZ),
               new Vec3d(bpMX, bpMY, bpMZ),
               collisionOffset,
               predictGround,
            ...
            ignoreHorizontal = (move.isIgnoreHorizontal() || GuiIngameMenu.respawnKey) && this instanceof EntityPlayerSP;
         ...
         list1 = this.world.getCollisionBoxes(this, aabb.addCoord(p_70091_2_, p_70091_4_, p_70091_6_));
         if (this instanceof EntityPlayerSP) {
            List<AxisAlignedBB> bb = this.world
               .getCollisionBoxes2(
                  this,
                  this.getEntityBoundingBoxCLCompact()
                     .addCoord(p_70091_2_, p_70091_4_, p_70091_6_)
                     .offset(collisionOffset.xCoord, collisionOffset.yCoord, collisionOffset.zCoord)
               );
            if (!bb.isEmpty() && collisionOffset.lengthVector() > 0.0) {
               for (AxisAlignedBB aabb0 : bb) {
                  AxisAlignedBB aabb2 = aabb.offset(collisionOffset.xCoord, collisionOffset.yCoord, collisionOffset.zCoord);
                  if (p_70091_2_ != 0.0) {
                     int j5 = 0;
         ...
         if (p_70091_4_ != 0.0) {
            AxisAlignedBB aab0 = this.getEntityBoundingBoxCLCompact();
            int k = 0;
            if (!ignoreVertical) {
               for (int l = list1.size(); k < l; k++) {
                  p_70091_4_ = list1.get(k).calculateYOffset(aab0, p_70091_4_);
               }
            }

            this.setEntityBoundingBox(aab0.offset(0.0, p_70091_4_, 0.0));
         }

         if (p_70091_2_ != 0.0) {
            AxisAlignedBB aabb0 = this.getEntityBoundingBoxCLCompact();
            int j5 = 0;
            if (!ignoreHorizontal) {
               for (int l5 = list1.size(); j5 < l5; j5++) {
                  p_70091_2_ = list1.get(j5).calculateXOffset(aabb0, p_70091_2_);
               }
            }

            if (p_70091_2_ != 0.0) {
               this.setEntityBoundingBox(aabb0.offset(p_70091_2_, 0.0, 0.0));
            }
         }

         if (p_70091_6_ != 0.0) {
            AxisAlignedBB aabb0x = this.getEntityBoundingBoxCLCompact();
            int k5 = 0;
            if (!ignoreHorizontal) {
               for (int i6 = list1.size(); k5 < i6; k5++) {
                  p_70091_6_ = list1.get(k5).calculateZOffset(aabb0x, p_70091_6_);
               }
            }

            if (p_70091_6_ != 0.0) {
               this.setEntityBoundingBox(aabb0x.offset(0.0, 0.0, p_70091_6_));
            }
         }

         boolean flagx = this.onGround || d3 != p_70091_4_ && d3 < 0.0;
         if (flagx && (d2 != p_70091_2_ || d4 != p_70091_6_) && !ignoreHorizontal && !ignoreVertical) {
            double d14x = p_70091_2_;
            double d6x = p_70091_4_;
            double d7x = p_70091_6_;
            AxisAlignedBB axisalignedbb1 = this.getEntityBoundingBoxCLCompact();
            this.setEntityBoundingBox(axisalignedbb);
            p_70091_4_ = (double)this.stepHeight;
            List<AxisAlignedBB> list = this.world.getCollisionBoxes(this, axisalignedbb1.addCoord(d2, p_70091_4_, d4));
            AxisAlignedBB axisalignedbb2 = this.getEntityBoundingBoxCLCompact();
            AxisAlignedBB axisalignedbb3 = axisalignedbb2.addCoord(d2, 0.0, d4);
            double d8 = p_70091_4_;
            int j1 = 0;
            ...
            axisalignedbb4 = axisalignedbb4.offset(0.0, 0.0, d22);
            double d23x = d18 * d18 + d19 * d19;
            double d9x = d21 * d21 + d22 * d22;
            if (d23x > d9x) {
               p_70091_2_ = d18;
               p_70091_6_ = d19;
               p_70091_4_ = -d8;
            ...
            int j4 = 0;
            AxisAlignedBB aabb001 = this.getEntityBoundingBoxCLCompact();

            for (int k4 = list.size(); j4 < k4; j4++) {
               p_70091_4_ = list.get(j4).calculateYOffset(aabb001, p_70091_4_);
            }

            this.setEntityBoundingBox(aabb001.offset(0.0, p_70091_4_, 0.0));
            if (d14x * d14x + d7x * d7x >= p_70091_2_ * p_70091_2_ + p_70091_6_ * p_70091_6_) {
               p_70091_2_ = d14x;
               p_70091_4_ = d6x;
               p_70091_6_ = d7x;
         ...
         if (this.canTriggerWalking() && (!this.onGround || !this.isSneaking() || !(this instanceof EntityPlayer)) && !this.isRiding()) {
            ...
            this.distanceWalkedOnStepModified = (float)(
               (double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt(d15 * d15 + d16 * d16 + d17 * d17) * 0.6
            );
            if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && iblockstate.getMaterial() != Material.AIR) {
               ...
               if (!this.isInWater()) {
                  ...
                  float f1 = MathHelper.sqrt(entity.motionX * entity.motionX * 0.2F + entity.motionY * entity.motionY + entity.motionZ * entity.motionZ * 0.2F)
                     * f;
                  if (f1 > 1.0F) {
                     f1 = 1.0F;
                  }
         ...
         try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport(var83, "Checking entity block collision");
         ...
         if (this.world.isFlammableWithin(this.getEntityBoundingBoxCLCompact().contract(0.001))) {
   ...
   public void resetPositionToBB() {
      AxisAlignedBB axisalignedbb = this.getEntityBoundingBoxCL();
   ...
   protected void updateFallState(double y, boolean onGroundIn, IBlockState state, BlockPos pos) {
      if (this instanceof EntityLivingBase base && base.hasNewVersionMoves && y > 0.0) {
   ...
   public boolean isWet() {
      if (this.inWater) {
         ...
         if (!this.world.isRainingAt(blockpos$pooledmutableblockpos)
            && !this.world.isRainingAt(blockpos$pooledmutableblockpos.setPos(this.posX, this.posY + (double)this.height, this.posZ))) {
            blockpos$pooledmutableblockpos.release();
            return false;
         } else {
            blockpos$pooledmutableblockpos.release();
   ...
   public boolean func_191953_am() {
      return this.world.handleMaterialAcceleration(this.getEntityBoundingBoxCLCompact().expand(0.0, -20.0, 0.0).contract(0.001), Material.WATER, this);
   }

   public double getWaterOffset() {
      if (this instanceof EntityLivingBase base && base.hasNewVersionMoves) {
         return base.posY > base.lastTickPosY ? -0.35 : -0.4F;
      }
   ...
   public boolean handleWaterMovement() {
      if (this.getRidingEntity() instanceof EntityBoat) {
         ...
         .handleMaterialAcceleration(this.getEntityBoundingBoxCLCompact().expand(0.0, this.getWaterOffset(), 0.0).contract(0.001), Material.WATER, this)) {
   ...
   protected void resetHeight() {
      ...
      float f1 = MathHelper.sqrt(entity.motionX * entity.motionX * 0.2F + entity.motionY * entity.motionY + entity.motionZ * entity.motionZ * 0.2F) * f;
      if (f1 > 1.0F) {
         f1 = 1.0F;
      }

      this.playSound(this.getSplashSound(), f1, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
      float f2 = (float)MathHelper.floor(this.getEntityBoundingBoxCLCompact().minY);
      ...
      for (int j = 0; (float)j < 1.0F + this.width * 20.0F; j++) {
         ...
         this.world
            .spawnParticle(
               EnumParticleTypes.WATER_SPLASH, this.posX + (double)f5, (double)(f2 + 1.0F), this.posZ + (double)f6, this.motionX, this.motionY, this.motionZ
            );
      }
   }
      ...
      if (iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE) {
         this.world
            .spawnParticle(
               ...
               this.getEntityBoundingBoxCLCompact().minY + 0.1,
   ...
   public boolean isInLava() {
      return this.world.isMaterialInBB(this.getEntityBoundingBoxCLCompact().expand(-0.1F, -0.4F, -0.1F), Material.LAVA);
   }

   public EntityLivingBase getLivingBaseOf() {
      return this != null && this instanceof EntityLivingBase ? (EntityLivingBase)this : null;
   }

   public EntityEnderPearl getEntityEnderPearlOf() {
      return this != null && this instanceof EntityEnderPearl ? (EntityEnderPearl)this : null;
   }

   public EntityItem getItemOf() {
      return this instanceof EntityItem ? (EntityItem)this : null;
   }
   ...
   public void func_191958_b(float strafe, float up, float forward, float friction) {
      ...
      EventRotationStrafe e = new EventRotationStrafe(yaw, strafe, forward, friction);
      if (this instanceof EntityPlayerSP) {
         e.call();
      }

      float strafe1 = e.getStrafe();
      float forward1 = e.getForward();
      float friction1 = e.getFriction();
      float yaw1 = e.getYaw();
      float f = strafe1 * strafe1 + up * up + forward1 * forward1;
      if (f >= 1.0E-4F) {
         f = MathHelper.sqrt(f);
         if (f < 1.0F) {
            f = 1.0F;
         ...
         up *= f;
         forward1 *= f;
         double f1 = (double)MathHelper.sin(yaw1 * (float) (Math.PI / 180.0));
         double f2 = (double)MathHelper.cos(yaw1 * (float) (Math.PI / 180.0));
         this.motionX += (double)strafe1 * f2 - (double)forward1 * f1;
         this.motionY += (double)up;
         this.motionZ += (double)forward1 * f2 + (double)strafe1 * f1;
      }
   }
   ...
   public float getDistanceToEntityAABB(Entity entityIn) {
      List<AxisAlignedBB> axises = BackTrack.get.getTracksAsEntity(entityIn, entityIn.getEntityBoundingBoxCL(), true);
      Iterator var3 = axises.iterator();
      if (var3.hasNext()) {
         AxisAlignedBB aabb = (AxisAlignedBB)var3.next();
         return (float)this.getDistance(aabb.minX + (aabb.maxX - aabb.minX) / 2.0, aabb.minY, aabb.minZ + (aabb.maxZ - aabb.minZ) / 2.0);
      } else {
         return this.getDistanceToEntity(entityIn);
      }
   }
   ...
   public float getSmoothDistanceToTileEntity(TileEntity tileentityIn) {
      ...
      float f = x - (float)tileentityIn.getX() + 0.5F;
      float f1 = y - (float)tileentityIn.getY();
      float f2 = z - (float)tileentityIn.getZ() + 0.5F;
      return MathHelper.sqrt(f * f + f1 * f1 + f2 * f2);
   }
   ...
   public float getSmoothDistanceToCoordXZ(float x, float y, float z) {
      float pTicks = Minecraft.getMinecraft().getRenderPartialTicks();
      double xposme = this.lastTickPosX + (this.posX - this.lastTickPosX) * (double)pTicks;
      double zposme = this.lastTickPosZ + (this.posZ - this.lastTickPosZ) * (double)pTicks;
      float f = (float)(xposme - (double)x);
   ...
   public float getPredDistanceToEntityWithCustomPos(Entity entityIn, double x, double y, double z) {
      ...
      for (Entity entities : GuiPlayerTabOverlay.getPlayers()) {
         if (entities == entityIn
            && entityIn instanceof EntityPlayer
            && entities.getUniqueID() != null
            && entityIn.ticksExisted > 200
            && Minecraft.getMinecraft().getConnection().getPlayerInfo(entities.getUniqueID()).getResponseTime() != 0) {
            entTicks += (float)(Minecraft.getMinecraft().getConnection().getPlayerInfo(entities.getUniqueID()).getResponseTime() / 50);
         }
      }
      ...
      double xme = xposme - (this.lastTickPosX - xposme) * (double)meTicks;
      double yme = yposme - (this.lastTickPosY - yposme) * (double)meTicks;
      double zme = zposme - (this.lastTickPosZ - zposme) * (double)meTicks;
      double xent = x - (entityIn.lastTickPosX - x) * (double)entTicks;
      double yent = y - (entityIn.lastTickPosY - y) * (double)entTicks;
      double zent = z - (entityIn.lastTickPosZ - z) * (double)entTicks;
   ...
   public double getSmartDistanceToAABB(float[] rotate, Entity entityIn) {
      ...
      return MathUtils.getDistanceToPointedEntity(new Vector2f(rotate[0], rotate[1]), (Entity)(virtualCamera ? FreeCam.fakePlayer : Minecraft.player), entityIn);
   }
   ...
   public double getDistanceToBlockPos(BlockPos pos) {
      Vec3d vec3 = new Vec3d((double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5);
      return this.getDistanceAtEye(vec3.xCoord, vec3.yCoord, vec3.zCoord);
   }
   ...
   public boolean canEntityBeSeenCoords(double x, double y, double z) {
      return Minecraft.getMinecraft()
            .world
            .rayTraceBlocks(new Vec3d(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3d(x, y, z), false, true, false)
         == null;
   }
   ...
   private boolean localSeen(EntityPlayer selfEntity, double[] xyz, float scale) {
      return scale == 0.0F
         ? selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1], xyz[2])
         : selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1], xyz[2])
            && scale != 0.0F
            && selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1] + (double)scale, xyz[2])
            && selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1] - (double)scale, xyz[2])
            && selfEntity.canEntityBeSeenCoords(xyz[0] + (double)scale, xyz[1], xyz[2])
            && selfEntity.canEntityBeSeenCoords(xyz[0] - (double)scale, xyz[1], xyz[2])
            && selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1], xyz[2] + (double)scale)
            && selfEntity.canEntityBeSeenCoords(xyz[0], xyz[1], xyz[2] - (double)scale);
   }
   ...
   public List<Vec3d> entityBoxVec3dsAlternate(Entity entityIn, boolean addOnSeenNoDontSeen) {
      if (entityIn == null) {
         ...
         double accuracyY = 9.0;
         double offsetXYZ = 0.03F;
         accuracyXZ = 1.0 / accuracyXZ;
         accuracyY = 1.0 / accuracyY;
         AxisAlignedBB aabb = entityIn.getRenderBoundingBox();
         double[] whh = new double[]{
            (double)this.width - offsetXYZ * 2.0, (double)this.height - offsetXYZ * 2.0, ((double)this.height - offsetXYZ * 2.0) / 1.05
         };
         ...
         if (aabb != null) {
            ...
            double[] var10000 = new double[]{aabb.minX + whh[0] / 2.0, aabb.minY, aabb.minZ + whh[0] / 2.0};
            ...
            for (double xs = xyz1[0]; xs <= xyz2[0]; xs += accuracyXZ * whh[0] * 2.0) {
               for (double zs = xyz1[2]; zs <= xyz2[2]; zs += accuracyXZ * whh[0] * 2.0) {
                  for (double ys = xyz2[1]; ys > xyz1[1]; ys -= accuracyY * whh[1] * 2.0) {
                     if (xs == xyz2[0] || xs == xyz1[0] || ys == xyz2[1] || ys == xyz1[1] || zs == xyz2[2] || zs == xyz1[2]) {
                        xyz3[0] = xs;
                        xyz3[1] = ys;
                        xyz3[2] = zs;
                        if (this.localSeen(me, xyz3, scale)) {
   ...
   public double getDistanceAtVec3dToVec3d(Vec3d first, Vec3d second) {
      ...
      double zDiff;
      return Math.sqrt(
         (xDiff = first.xCoord - second.xCoord) * xDiff + (yDiff = first.yCoord - second.yCoord) * yDiff + (zDiff = first.zCoord - second.zCoord) * zDiff
      );
   }

   public Vec3d getBestVec3dOnEntityBox(boolean alwaysMultipoints) {
      Iterator var2 = BackTrack.get.getTracksAsEntity(this, this.getEntityBoundingBoxCL(), true).iterator();
      if (!var2.hasNext()) {
         return this.getPositionEyes(1.0F);
      } else {
         AxisAlignedBB aabb = (AxisAlignedBB)var2.next();
         double[] whh = new double[]{(double)this.width, (double)this.height, (double)(this.height / 1.05F)};
         double[] xyz = new double[]{this.posX, this.posY, this.posZ};
         if (aabb != null) {
            whh = new double[]{aabb.maxX - aabb.minX, aabb.maxY - aabb.minY, (aabb.maxY - aabb.minY) / 1.05F};
         ...
         if (!alwaysMultipoints && !Minecraft.player.canEntityBeSeenVec3d(defaultVec)) {
            defaultVec = defaultVec.addVector(0.0, -pitchPointHeight / 2.0, 0.0);
         }

         if (!(whh[1] <= 1.0) && (alwaysMultipoints || !Minecraft.player.canEntityBeSeenVec3d(defaultVec))) {
            List<Vec3d> normalVecs = this.entityBoxVec3dsAlternate(this, true);
            Vec3d toSortVec = new Vec3d(Minecraft.player.posX, Minecraft.player.posY + pitchPointHeight, Minecraft.player.posZ);
            if (normalVecs != null && normalVecs.size() > 1) {
               normalVecs.sort(Comparator.comparing(vec3 -> this.getDistanceAtVec3dToVec3d(toSortVec, vec3)));
            }
   ...
   public double getDistanceToPointedAABB(Entity entityIn) {
      Vec3d vec = this.getBestVec3dOnEntityBox(false);
      return vec != null ? this.getDistanceToVec3d(vec) : this.getSmartDistanceToAABB(RotationUtil.getLookRotations(entityIn, false), entityIn);
   }
      ...
      for (int x = -range; x < range; x++) {
         for (int y = range; y > -range; y--) {
            for (int z = -range; z < range; z++) {
               ...
               if (Minecraft.getMinecraft().world.getBlockState(blockPos).getBlock() == blocks) {
                  int rangeFromBlockToPlayer = (int)blockPos.getDistance((int)Minecraft.player.posX, (int)Minecraft.player.posY, (int)Minecraft.player.posZ);
                  if (rangeFromBlockToPlayer < bestRange) {
   ...
   public double getDistanceY(double y) {
      ...
      return (double)MathHelper.sqrt(d0 * d0);
   }
   ...
   public Vec3d getRenderLook(float partialTicks) {
      if (partialTicks == 1.0F) {
         return this instanceof EntityPlayerSP sp
            ? getVectorForRotation(this.rotationPitch + WorldRender.get.offPitchOrient, this.rotationYaw + WorldRender.get.offYawOrient)
            : getVectorForRotation(this.rotationPitch, this.rotationYaw);
      } else {
         float f = this.prevRotationPitch + (this.rotationPitch - this.prevRotationPitch) * partialTicks;
         float f1 = this.prevRotationYaw + (this.rotationYaw - this.prevRotationYaw) * partialTicks;
         if (this instanceof EntityPlayerSP sp) {
   ...
   public RayTraceResult rayTrace(double blockReachDistance, float partialTicks) {
      ...
      if (EntityBox.hitboxModState()) {
         reach = blockReachDistance + (double)EntityBox.hitboxModReachBlocks();
      }
   ...
   public boolean isGlowing() {
      boolean cancelGlow = !Panic.stop && NoRender.get.isActived() && NoRender.get.EntityGlowing.getBool();
      boolean cancelGlow2 = !Panic.stop
         && FragEffects.get != null
         && FragEffects.get.isActived()
         && (FragEffects.get.hasLoadedShaderEffect1 || FragEffects.get.hasLoadedShaderEffect2);
      return this.glowing && !cancelGlow && !cancelGlow2
         || this.world.isRemote && this.getFlag(6) && !cancelGlow && !cancelGlow2
         || this instanceof EntityItem && EntityItem.tempGlowing && !cancelGlow2;
   }
   ...
   protected boolean pushOutOfBlocks(double x, double y, double z) {
      ...
      if (!this.world.collidesWithAnyBlock(this.getEntityBoundingBoxCLCompact())) {
         return false;
      } else {
   ...
   public Entity changeDimension(int dimensionIn) {
      if (!this.world.isRemote && !this.isDead) {
         ...
         Entity entity = EntityList.func_191304_a((Class<? extends Entity>)this.getClass(), worldserver1);
         if (entity != null) {
   ...
   public AxisAlignedBB resizeAxisByNewVersion(AxisAlignedBB prevAxis) {
      ...
      if (this instanceof EntityLivingBase base && base.hasNewVersionMoves) {
         double height = prevAxis.maxY - prevAxis.minY;
   ...
   public AxisAlignedBB getEntityBoundingBoxCL() {
      if (this != null && this == FreeCam.fakePlayer) {
         return new AxisAlignedBB(
            FreeCam.fakePlayer.posX,
            FreeCam.fakePlayer.posY + (double)(FreeCam.fakePlayer.height / 2.0F) - 0.1F,
            FreeCam.fakePlayer.posZ,
            FreeCam.fakePlayer.posX,
            FreeCam.fakePlayer.posY + (double)(FreeCam.fakePlayer.height / 2.0F) + 0.1F,
            FreeCam.fakePlayer.posZ
         );
      } else {
         return this != null && EntityBox.hitboxModState() && EntityBox.entityIsCurrentToExtend(this)
            ? EntityBox.getExtendedHitbox(
               EntityBox.hitboxModAddVec(this, EntityBox.hitboxModPredictSize(this)),
               this,
               EntityBox.hitboxModSizeBox(),
               this.resizeAxisByNewVersion(this.boundingBox)
            )
            : this.resizeAxisByNewVersion(this.boundingBox);
      }
   }

   public AxisAlignedBB getEntityBoundingBoxCLCompact() {
      return this != null && this == FreeCam.fakePlayer
         ? new AxisAlignedBB(
            FreeCam.fakePlayer.posX,
            FreeCam.fakePlayer.posY + (double)(FreeCam.fakePlayer.height / 2.0F) - 0.1F,
            FreeCam.fakePlayer.posZ,
