...
public class EntityList {
   ...
   public static ResourceLocation func_191301_a(Entity p_191301_0_) {
      return func_191306_a((Class<? extends Entity>)p_191301_0_.getClass());
   }
   ...
   public static String getEntityString(Entity entityIn) {
      int i = field_191308_b.getIDForObject((Class<? extends Entity>)entityIn.getClass());
   ...
   public static boolean isStringEntityName(Entity entityIn, ResourceLocation entityName) {
      ResourceLocation resourcelocation = func_191306_a((Class<? extends Entity>)entityIn.getClass());
      if (resourcelocation != null) {
         return resourcelocation.equals(entityName);
      } else {
         return entityIn instanceof EntityPlayer
            ? field_191310_e.equals(entityName)
            : entityIn instanceof EntityLightningBolt && field_191307_a.equals(entityName);
      }
   }
