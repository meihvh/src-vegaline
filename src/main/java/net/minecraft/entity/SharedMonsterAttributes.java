...
public class SharedMonsterAttributes {
   ...
   public static final IAttribute MAX_HEALTH = new RangedAttribute((IAttribute)null, "generic.maxHealth", 20.0, 0.0, 1024.0)
   ...
   public static final IAttribute KNOCKBACK_RESISTANCE = new RangedAttribute((IAttribute)null, "generic.knockbackResistance", 0.0, 0.0, 1.0)
      .setDescription("Knockback Resistance");
   public static final IAttribute MOVEMENT_SPEED = new RangedAttribute((IAttribute)null, "generic.movementSpeed", 0.7F, 0.0, 1024.0)
      .setDescription("Movement Speed")
      .setShouldWatch(true);
   public static final IAttribute field_193334_e = new RangedAttribute((IAttribute)null, "generic.flyingSpeed", 0.4F, 0.0, 1024.0)
