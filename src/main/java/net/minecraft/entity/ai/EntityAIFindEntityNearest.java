...
public class EntityAIFindEntityNearest extends EntityAIBase {
      ...
      this.predicate = new Predicate<EntityLivingBase>() {
         public boolean apply(@Nullable EntityLivingBase p_apply_1_) {
            ...
            if (p_apply_1_.isInvisible()) {
               ...
               return (double)p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearest.this.mob) > d0
                  ? false
   ...
   public boolean shouldExecute() {
      ...
      List<EntityLivingBase> list = this.mob
         .world
         .getEntitiesWithinAABB(this.classToCheck, this.mob.getEntityBoundingBox().expand(d0, 4.0, d0), this.predicate);
