...
public class EntityAIFollow extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      List<EntityLiving> list = this.field_192372_a
         .world
         .getEntitiesWithinAABB(EntityLiving.class, this.field_192372_a.getEntityBoundingBox().expandXyz((double)this.field_192380_i), this.field_192373_b);
      if (!list.isEmpty()) {
   ...
   public boolean continueExecuting() {
      return this.field_192374_c != null
         && !this.field_192376_e.noPath()
         && this.field_192372_a.getDistanceSqToEntity(this.field_192374_c) > (double)(this.field_192378_g * this.field_192378_g);
   }
      ...
      if (this.field_192374_c != null && !this.field_192372_a.getLeashed()) {
         ...
         if (--this.field_192377_f <= 0) {
            ...
            if (d3 > (double)(this.field_192378_g * this.field_192378_g)) {
               ...
               if (d3 <= (double)this.field_192378_g
                  || entitylookhelper.getLookPosX() == this.field_192372_a.posX
