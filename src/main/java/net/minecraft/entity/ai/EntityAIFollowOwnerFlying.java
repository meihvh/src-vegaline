...
public class EntityAIFollowOwnerFlying extends EntityAIFollowOwner {
   ...
   protected boolean func_192381_a(int p_192381_1_, int p_192381_2_, int p_192381_3_, int p_192381_4_, int p_192381_5_) {
      ...
      return (iblockstate.isFullyOpaque() || iblockstate.getMaterial() == Material.LEAVES)
         && this.theWorld.isAirBlock(new BlockPos(p_192381_1_ + p_192381_4_, p_192381_3_, p_192381_2_ + p_192381_5_))
         && this.theWorld.isAirBlock(new BlockPos(p_192381_1_ + p_192381_4_, p_192381_3_ + 1, p_192381_2_ + p_192381_5_));
   }
}
