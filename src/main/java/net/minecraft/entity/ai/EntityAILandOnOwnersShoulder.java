...
public class EntityAILandOnOwnersShoulder extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      ...
      boolean flag = entitylivingbase != null
   ...
   public void updateTask() {
      if (!this.field_192384_c
         && !this.field_192382_a.isSitting()
         && !this.field_192382_a.getLeashed()
         && this.field_192382_a.getEntityBoundingBox().intersectsWith(this.field_192383_b.getEntityBoundingBox())) {
