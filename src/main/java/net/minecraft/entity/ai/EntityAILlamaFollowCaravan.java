...
public class EntityAILlamaFollowCaravan extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      if (!this.field_190859_a.getLeashed() && !this.field_190859_a.func_190718_dR()) {
         List<EntityLlama> list = this.field_190859_a
            .world
            .getEntitiesWithinAABB(
               (Class<? extends EntityLlama>)this.field_190859_a.getClass(), this.field_190859_a.getEntityBoundingBox().expand(9.0, 4.0, 9.0)
            );
   ...
   public void updateTask() {
      if (this.field_190859_a.func_190718_dR()) {
         ...
         Vec3d vec3d = new Vec3d(
               entityllama.posX - this.field_190859_a.posX, entityllama.posY - this.field_190859_a.posY, entityllama.posZ - this.field_190859_a.posZ
            )
            .normalize()
         ...
         this.field_190859_a
            .getNavigator()
            .tryMoveToXYZ(
               this.field_190859_a.posX + vec3d.xCoord, this.field_190859_a.posY + vec3d.yCoord, this.field_190859_a.posZ + vec3d.zCoord, this.field_190860_b
            );
      }
   }
