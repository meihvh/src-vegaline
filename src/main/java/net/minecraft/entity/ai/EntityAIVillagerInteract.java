         ...
         if (this.interactionDelay == 0) {
            ...
            for (int i = 0; i < inventorybasic.getSizeInventory(); i++) {
               ...
               if (!itemstack1.func_190926_b()) {
                  ...
                  entityitem.motionX = (double)(-MathHelper.sin(f1 * (float) (Math.PI / 180.0)) * MathHelper.cos(f2 * (float) (Math.PI / 180.0)) * 0.3F);
                  entityitem.motionZ = (double)(MathHelper.cos(f1 * (float) (Math.PI / 180.0)) * MathHelper.cos(f2 * (float) (Math.PI / 180.0)) * 0.3F);
                  entityitem.motionY = (double)(-MathHelper.sin(f2 * (float) (Math.PI / 180.0)) * 0.3F + 0.1F);
