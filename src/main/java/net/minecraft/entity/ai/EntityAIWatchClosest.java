...
public class EntityAIWatchClosest extends EntityAIBase {
      ...
      if (this.theWatcher.getRNG().nextFloat() >= this.chance) {
         ...
         if (this.watchedClass == EntityPlayer.class) {
            this.closestEntity = this.theWatcher
               .world
               .func_190525_a(
                  this.theWatcher.posX,
                  this.theWatcher.posY,
                  this.theWatcher.posZ,
   ...
   public boolean continueExecuting() {
      if (!this.closestEntity.isEntityAlive()) {
         ...
         return this.theWatcher.getDistanceSqToEntity(this.closestEntity) > (double)(this.maxDistanceForPlayer * this.maxDistanceForPlayer)
            ? false
            : this.lookTime > 0;
      }
   }
   ...
   public void updateTask() {
      this.theWatcher
         ...
         .setLookPosition(
            ...
            (float)this.theWatcher.getHorizontalFaceSpeed(),
