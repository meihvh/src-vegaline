...
public class EntityMoveHelper {
   ...
   public void onUpdateMoveHelper() {
      if (this.action == EntityMoveHelper.Action.STRAFE) {
         ...
         f2 *= f4;
         f3 *= f4;
         float f5 = MathHelper.sin(this.entity.rotationYaw * (float) (Math.PI / 180.0));
         float f6 = MathHelper.cos(this.entity.rotationYaw * (float) (Math.PI / 180.0));
