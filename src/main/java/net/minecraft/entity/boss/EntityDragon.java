...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
   ...
   public void onLivingUpdate() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         this.world
            .spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX + (double)f12, this.posY + 2.0 + (double)f13, this.posZ + (double)f15, 0.0, 0.0, 0.0);
      } else {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.world.isRemote) {
               ...
               if (vec3d != null) {
                  ...
                  double d4 = MathHelper.clamp(
                     MathHelper.wrapDegrees(180.0 - MathHelper.atan2(d6, d8) * (180.0 / Math.PI) - (double)this.rotationYaw), -50.0, 50.0
                  );
                  ...
                  if (this.slowed) {
                     this.moveEntity(MoverType.SELF, this.motionX * 0.8F, this.motionY * 0.8F, this.motionZ * 0.8F);
                  } else {
            ...
            this.dragonPartHead
               .setLocationAndAngles(
                  this.posX + (double)(f19 * 6.5F * f16), this.posY + (double)f20 + (double)(f2 * 6.5F), this.posZ - (double)(f4 * 6.5F * f16), 0.0F, 0.0F
               );
            this.dragonPartNeck
               .setLocationAndAngles(
                  this.posX + (double)(f19 * 5.5F * f16), this.posY + (double)f20 + (double)(f2 * 5.5F), this.posZ - (double)(f4 * 5.5F * f16), 0.0F, 0.0F
               );
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTicks >= 180 && this.deathTicks <= 200) {
         ...
         this.world.spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.posX + (double)f, this.posY + 2.0 + (double)f1, this.posZ + (double)f2, 0.0, 0.0, 0.0);
      }
