...
public class PhaseStrafePlayer extends PhaseBase {
   ...
   public void doLocalUpdate() {
      if (this.attackTarget == null) {
         ...
         double d12 = this.targetLocation == null ? 0.0 : this.targetLocation.squareDistanceTo(this.dragon.posX, this.dragon.posY, this.dragon.posZ);
         ...
         if (this.attackTarget.getDistanceSqToEntity(this.dragon) < 4096.0) {
            if (this.dragon.canEntityBeSeen(this.attackTarget)) {
               ...
               float f = (float)(Math.acos((double)f1) * (180.0 / Math.PI));
               f += 0.5F;
