      ...
      if (this.fallTile.getMaterial() == Material.AIR) {
         ...
         if (!this.world.isRemote) {
            ...
            if (!this.onGround && !flag1) {
               ...
               if (!flag1 && BlockFalling.canFallThrough(this.world.getBlockState(new BlockPos(this.posX, this.posY - 0.01F, this.posZ)))) {
                  this.onGround = false;
                  return;
               }
               ...
               if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                  ...
                  } else if (this.world.func_190527_a(block, blockpos1, true, EnumFacing.UP, (Entity)null)
