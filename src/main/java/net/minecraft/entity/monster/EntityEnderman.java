...
public class EntityEnderman extends EntityMob {
   ...
   public void playEndermanSound() {
      if (this.ticksExisted >= this.lastCreepySound + 400) {
         ...
         if (!this.isSilent()) {
            this.world
               .playSound(
                  this.posX, this.posY + (double)this.getEyeHeight(), this.posZ, SoundEvents.ENTITY_ENDERMEN_STARE, this.getSoundCategory(), 2.5F, 1.0F, false
               );
         }
      }
   }
   ...
   private boolean teleportTo(double x, double y, double z) {
      ...
      if (flag) {
         this.world
            .playSound(
               (EntityPlayer)null, this.prevPosX, this.prevPosY, this.prevPosZ, SoundEvents.ENTITY_ENDERMEN_TELEPORT, this.getSoundCategory(), 1.0F, 1.0F
            );
      ...
      public boolean shouldExecute() {
         ...
         this.player = this.enderman
            ...
            .getNearestAttackablePlayer(
               this.enderman.posX, this.enderman.posY, this.enderman.posZ, d0, d0, (Function<EntityPlayer, Double>)null, new Predicate<EntityPlayer>() {
