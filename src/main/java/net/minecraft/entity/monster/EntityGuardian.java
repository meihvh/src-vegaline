            ...
            for (int i = 0; i < 2; i++) {
               this.world
                  .spawnParticle(
                     ...
                     this.posX + (this.rand.nextDouble() - 0.5) * (double)this.width - vec3d.xCoord * 1.5,
                     this.posY + this.rand.nextDouble() * (double)this.height - vec3d.yCoord * 1.5,
                     this.posZ + (this.rand.nextDouble() - 0.5) * (double)this.width - vec3d.zCoord * 1.5,
                     0.0,
                     0.0,
                     0.0
                  );
   ...
   static class GuardianMoveHelper extends EntityMoveHelper {
      ...
      public void onUpdateMoveHelper() {
         if (this.action == EntityMoveHelper.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
            ...
            double d5 = Math.cos((double)(this.entityGuardian.rotationYaw * (float) (Math.PI / 180.0)));
            double d6 = Math.sin((double)(this.entityGuardian.rotationYaw * (float) (Math.PI / 180.0)));
