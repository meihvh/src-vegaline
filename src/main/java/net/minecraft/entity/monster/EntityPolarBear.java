...
public class EntityPolarBear extends EntityAnimal {
   ...
   class AIAttackPlayer extends EntityAINearestAttackableTarget<EntityPlayer> {
      public AIAttackPlayer() {
         super(EntityPolarBear.this, EntityPlayer.class, 20, true, true, (Predicate<? super EntityPlayer>)null);
      }
      ...
      public boolean shouldExecute() {
         if (EntityPolarBear.this.isChild()) {
            ...
            if (super.shouldExecute()) {
               for (EntityPolarBear entitypolarbear : EntityPolarBear.this.world
                  .getEntitiesWithinAABB(EntityPolarBear.class, EntityPolarBear.this.getEntityBoundingBox().expand(8.0, 4.0, 8.0))) {
