...
public class EntityShulker extends EntityGolem implements IMob {
   ...
   public EnumDyeColor func_190769_dn() {
      return EnumDyeColor.byMetadata(this.dataManager.get(field_190770_bw));
   }
      ...
      protected AxisAlignedBB getTargetableArea(double targetDistance) {
         ...
         if (enumfacing.getAxis() == EnumFacing.Axis.X) {
            ...
            return enumfacing.getAxis() == EnumFacing.Axis.Z
               ? this.taskOwner.getEntityBoundingBox().expand(targetDistance, targetDistance, 4.0)
               : this.taskOwner.getEntityBoundingBox().expand(targetDistance, 4.0, targetDistance);
         }
      }
   }
