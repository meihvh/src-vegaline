...
public class EntitySlime extends EntityLiving implements IMob {
   ...
   protected void dealDamage(EntityLivingBase entityIn) {
      ...
      if (this.canEntityBeSeen(entityIn)
         && this.getDistanceSqToEntity(entityIn) < 0.6 * (double)i * 0.6 * (double)i
   ...
   static class AISlimeAttack extends EntityAIBase {
      ...
      public boolean continueExecuting() {
         ...
         if (entitylivingbase == null) {
            ...
            return entitylivingbase instanceof EntityPlayer && ((EntityPlayer)entitylivingbase).capabilities.disableDamage ? false : --this.growTieredTimer > 0;
         }
      }
