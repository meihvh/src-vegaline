...
public abstract class EntitySpellcasterIllager extends AbstractIllager {
   ...
   public boolean func_193082_dl() {
      return this.world.isRemote ? this.dataManager.get(field_193088_c) > 0 : this.field_193087_b > 0;
   }
   ...
   protected EntitySpellcasterIllager.SpellType func_193083_dm() {
      return !this.world.isRemote ? this.field_193089_bx : EntitySpellcasterIllager.SpellType.func_193337_a(this.dataManager.get(field_193088_c));
   }
   ...
   public void onUpdate() {
      ...
      if (this.world.isRemote && this.func_193082_dl()) {
         ...
         float f = this.renderYawOffset * (float) (Math.PI / 180.0) + MathHelper.cos((float)this.ticksExisted * 0.6662F) * 0.25F;
   ...
   public abstract class AIUseSpell extends EntityAIBase {
      ...
      public boolean shouldExecute() {
         if (EntitySpellcasterIllager.this.getAttackTarget() == null) {
            ...
            return EntitySpellcasterIllager.this.func_193082_dl() ? false : EntitySpellcasterIllager.this.ticksExisted >= this.field_193322_d;
         }
      }
