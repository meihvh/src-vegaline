...
public class EntityVex extends EntityMob {
   ...
   private boolean func_190656_b(int p_190656_1_) {
      int i = this.dataManager.get(field_190664_a);
   ...
   class AIChargeAttack extends EntityAIBase {
      ...
      public boolean shouldExecute() {
         return EntityVex.this.getAttackTarget() != null && !EntityVex.this.getMoveHelper().isUpdating() && EntityVex.this.rand.nextInt(7) == 0
            ? EntityVex.this.getDistanceSqToEntity(EntityVex.this.getAttackTarget()) > 4.0
            : false;
      }
   ...
   class AICopyOwnerTarget extends EntityAITarget {
      ...
      public boolean shouldExecute() {
         return EntityVex.this.field_190665_b != null
            && EntityVex.this.field_190665_b.getAttackTarget() != null
      ...
      public void onUpdateMoveHelper() {
         if (this.action == EntityMoveHelper.Action.MOVE_TO) {
            ...
            if (d3 < EntityVex.this.getEntityBoundingBox().getAverageEdgeLength()) {
               ...
               EntityVex.this.motionX = EntityVex.this.motionX + d0 / d3 * 0.05 * this.speed;
               EntityVex.this.motionY = EntityVex.this.motionY + d1 / d3 * 0.05 * this.speed;
               EntityVex.this.motionZ = EntityVex.this.motionZ + d2 / d3 * 0.05 * this.speed;
               if (EntityVex.this.getAttackTarget() == null) {
                  ...
                  EntityVex.this.rotationYaw = -((float)MathHelper.atan2(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityVex.this.renderYawOffset = EntityVex.this.rotationYaw;
               }
            }
         }
            ...
            if (EntityVex.this.world.isAirBlock(blockpos1)) {
               ...
               if (EntityVex.this.getAttackTarget() == null) {
                  EntityVex.this.getLookHelper()
                     .setLookPosition((double)blockpos1.getX() + 0.5, (double)blockpos1.getY() + 0.5, (double)blockpos1.getZ() + 0.5, 180.0F, 20.0F);
               }
               break;
            }
         }
