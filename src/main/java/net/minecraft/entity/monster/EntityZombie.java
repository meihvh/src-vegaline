...
public class EntityZombie extends EntityMob {
   protected static final IAttribute SPAWN_REINFORCEMENTS_CHANCE = new RangedAttribute((IAttribute)null, "zombie.spawnReinforcements", 0.0, 0.0, 1.0)
   ...
   public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
      ...
      if (livingdata instanceof EntityZombie.GroupData entityzombie$groupdata && entityzombie$groupdata.isChild) {
         this.setChild(true);
