...
public abstract class AbstractHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount {
   ...
   protected static final IAttribute JUMP_STRENGTH = new RangedAttribute((IAttribute)null, "horse.jumpStrength", 0.7, 0.0, 2.0)
   ...
   protected AbstractHorse getClosestHorse(Entity entityIn, double distance) {
      ...
      for (Entity entity1 : this.world
         .getEntitiesInAABBexcluding(entityIn, entityIn.getEntityBoundingBox().addCoord(distance, distance, distance), IS_HORSE_BREEDING)) {
   ...
   protected void func_190681_a(EntityAgeable p_190681_1_, AbstractHorse p_190681_2_) {
      ...
      double d1 = this.getEntityAttribute(JUMP_STRENGTH).getBaseValue()
         + p_190681_1_.getEntityAttribute(JUMP_STRENGTH).getBaseValue()
   ...
   public void updatePassenger(Entity passenger) {
      ...
      if (this.prevRearingAmount > 0.0F) {
         ...
         passenger.setPosition(
            this.posX + (double)(f1 * f3), this.posY + this.getMountedYOffset() + passenger.getYOffset() + (double)f2, this.posZ - (double)(f1 * f)
         );
