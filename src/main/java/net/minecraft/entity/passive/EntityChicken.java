...
public class EntityChicken extends EntityAnimal {
   ...
   public void updatePassenger(Entity passenger) {
      ...
      float f = MathHelper.sin(this.renderYawOffset * (float) (Math.PI / 180.0));
      float f1 = MathHelper.cos(this.renderYawOffset * (float) (Math.PI / 180.0));
      float f2 = 0.1F;
      float f3 = 0.0F;
      passenger.setPosition(
         this.posX + (double)(0.1F * f), this.posY + (double)(this.height * 0.5F) + passenger.getYOffset() + 0.0, this.posZ - (double)(0.1F * f1)
      );
