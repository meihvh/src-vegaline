...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying {
   ...
   private static final Predicate<EntityLiving> field_192014_bH = new Predicate<EntityLiving>() {
      public boolean apply(@Nullable EntityLiving p_apply_1_) {
         return p_apply_1_ != null
            && EntityParrot.field_192017_bK.containsKey(EntityList.field_191308_b.getIDForObject((Class<? extends Entity>)p_apply_1_.getClass()));
      }
   };
   ...
   public void onLivingUpdate() {
      ...
      if (this.field_192019_bM == null
         || this.field_192019_bM.distanceSq(this.posX, this.posY, this.posZ) > 12.0
   ...
   private void func_192001_dv() {
      ...
      this.field_192008_bB = this.field_192008_bB + this.field_192012_bF * 2.0F;
   }
      ...
      if (!p_192006_1_.isSilent() && p_192006_0_.rand.nextInt(50) == 0) {
         ...
         if (!list.isEmpty()) {
            ...
            if (!entityliving.isSilent()) {
               SoundEvent soundevent = func_191999_g(EntityList.field_191308_b.getIDForObject((Class<? extends Entity>)entityliving.getClass()));
               p_192006_0_.playSound(
                  (EntityPlayer)null,
                  p_192006_1_.posX,
                  p_192006_1_.posY,
                  p_192006_1_.posZ,
                  ...
                  0.7F,
                  func_192000_b(p_192006_0_.rand)
               );
               return true;
            }
         }
   ...
   public static void func_192005_a(World p_192005_0_, Entity p_192005_1_) {
      if (!p_192005_1_.isSilent() && !func_192006_b(p_192005_0_, p_192005_1_) && p_192005_0_.rand.nextInt(200) == 0) {
         p_192005_0_.playSound(
            (EntityPlayer)null,
            p_192005_1_.posX,
            p_192005_1_.posY,
            p_192005_1_.posZ,
            func_192003_a(p_192005_0_.rand),
