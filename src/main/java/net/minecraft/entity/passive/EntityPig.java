...
public class EntityPig extends EntityAnimal {
   ...
   public boolean canBeSteered() {
      return !(this.getControllingPassenger() instanceof EntityPlayer entityplayer)
         ? false
         : entityplayer.getHeldItemMainhand().getItem() == Items.CARROT_ON_A_STICK || entityplayer.getHeldItemOffhand().getItem() == Items.CARROT_ON_A_STICK;
   }
   ...
   public void func_191986_a(float p_191986_1_, float p_191986_2_, float p_191986_3_) {
      ...
      if (this.isBeingRidden() && this.canBeSteered()) {
         ...
         this.limbSwingAmount = this.limbSwingAmount + (f1 - this.limbSwingAmount) * 0.4F;
