...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
   ...
   public boolean processInteract(EntityPlayer player, EnumHand hand) {
      ...
      if (flag) {
         ...
         return true;
      } else if (!this.func_190669_a(itemstack, (Class<? extends Entity>)this.getClass()) && this.isEntityAlive() && !this.isTrading() && !this.isChild()) {
   ...
   public void useRecipe(MerchantRecipe recipe) {
      ...
      if (recipe.getItemToBuy().getItem() == Items.EMERALD) {
         this.wealth = this.wealth + recipe.getItemToBuy().func_190916_E();
      }
   ...
   static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList {
      ...
      public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
         ...
         ItemStack itemstack1 = EnchantmentHelper.addRandomEnchantment(
            p_190888_3_, new ItemStack(this.enchantedItemStack.getItem(), 1, this.enchantedItemStack.getMetadata()), 5 + p_190888_3_.nextInt(15), false
         );
