...
public abstract class EntityArrow extends Entity implements IProjectile {
   ...
   public void onUpdate() {
      ...
      if (this.inGround) {
         ...
         this.rotationYaw = (float)(MathHelper.atan2(this.motionX, this.motionZ) * (180.0 / Math.PI));
         this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f4) * (180.0 / Math.PI));
   ...
   protected Entity findEntityOnPath(Vec3d start, Vec3d end) {
      ...
      List<Entity> list = this.world
         .getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expandXyz(1.0), ARROW_TARGETS);
      double d0 = 0.0;
