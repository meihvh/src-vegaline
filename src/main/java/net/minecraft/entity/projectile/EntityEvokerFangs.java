...
public class EntityEvokerFangs extends Entity {
   ...
   public EntityEvokerFangs(
      World p_i47276_1_, double p_i47276_2_, double p_i47276_4_, double p_i47276_6_, float p_i47276_8_, int p_i47276_9_, EntityLivingBase p_i47276_10_
   ) {
      this(p_i47276_1_);
      this.field_190553_a = p_i47276_9_;
      this.func_190549_a(p_i47276_10_);
      this.rotationYaw = p_i47276_8_ * (180.0F / (float)Math.PI);
      ...
      if (this.world.isRemote) {
         ...
         if (this.field_190553_a == -8) {
            for (EntityLivingBase entitylivingbase : this.world
               .getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(0.2, 0.0, 0.2))) {
   ...
   public void handleStatusUpdate(byte id) {
      ...
      if (id == 4) {
         ...
         if (!this.isSilent()) {
            this.world
               .playSound(
                  this.posX, this.posY, this.posZ, SoundEvents.field_191242_bl, this.getSoundCategory(), 1.0F, this.rand.nextFloat() * 0.2F + 0.85F, false
               );
         }
      }
   }
