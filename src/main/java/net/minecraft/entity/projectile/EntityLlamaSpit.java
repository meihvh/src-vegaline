...
public class EntityLlamaSpit extends Entity implements IProjectile {
   ...
   public EntityLlamaSpit(World p_i47273_1_, EntityLlama p_i47273_2_) {
      ...
      this.setPosition(
         p_i47273_2_.posX - (double)(p_i47273_2_.width + 1.0F) * 0.5 * (double)MathHelper.sin(p_i47273_2_.renderYawOffset * (float) (Math.PI / 180.0)),
         p_i47273_2_.posY + (double)p_i47273_2_.getEyeHeight() - 0.1F,
         p_i47273_2_.posZ + (double)(p_i47273_2_.width + 1.0F) * 0.5 * (double)MathHelper.cos(p_i47273_2_.renderYawOffset * (float) (Math.PI / 180.0))
      );
   ...
   public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
      ...
      this.rotationYaw = (float)(MathHelper.atan2(x, z) * (180.0 / Math.PI));
      this.rotationPitch = (float)(MathHelper.atan2(y, (double)f1) * (180.0 / Math.PI));
      this.prevRotationYaw = this.rotationYaw;
      this.prevRotationPitch = this.rotationPitch;
   }
