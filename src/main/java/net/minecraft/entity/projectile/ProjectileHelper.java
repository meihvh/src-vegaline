...
public final class ProjectileHelper {
   ...
   public static final void rotateTowardsMovement(Entity p_188803_0_, float p_188803_1_) {
      ...
      p_188803_0_.rotationYaw = (float)(MathHelper.atan2(d2, d0) * (180.0 / Math.PI)) + 90.0F;
      p_188803_0_.rotationPitch = (float)(MathHelper.atan2((double)f, d1) * (180.0 / Math.PI)) - 90.0F;
