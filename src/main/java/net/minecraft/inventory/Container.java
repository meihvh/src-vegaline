...
public abstract class Container {
   ...
   public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player) {
      ...
      if (clickTypeIn == ClickType.QUICK_CRAFT) {
         ...
         if (slotId == -999) {
            ...
            for (ItemStack itemstack7 = this.transferStackInSlot(player, slotId);
               !itemstack7.func_190926_b() && ItemStack.areItemsEqual(slot5.getStack(), itemstack7);
      ...
      } else if (clickTypeIn == ClickType.SWAP && (dragType >= 0 && dragType < 9 || Minecraft.player.hasNewVersionMoves)) {
   ...
   public static boolean canAddItemToSlot(@Nullable Slot slotIn, ItemStack stack, boolean stackSizeMatters) {
      ...
      return !flag && stack.isItemEqual(slotIn.getStack()) && ItemStack.areItemStackTagsEqual(slotIn.getStack(), stack)
         ? slotIn.getStack().func_190916_E() + (stackSizeMatters ? 0 : stack.func_190916_E()) <= stack.getMaxStackSize()
         : flag;
   }
   ...
   public void func_192389_a(World p_192389_1_, EntityPlayer p_192389_2_, InventoryCrafting p_192389_3_, InventoryCraftResult p_192389_4_) {
      if (!p_192389_1_.isRemote) {
         ...
         if (irecipe != null
            && (irecipe.func_192399_d() || !p_192389_1_.getGameRules().getBoolean("doLimitedCrafting") || entityplayermp.func_192037_E().func_193830_f(irecipe))
            )
          {
