...
public class SlotFurnaceOutput extends Slot {
   ...
   public ItemStack decrStackSize(int amount) {
      if (this.getHasStack()) {
         this.removeCount = this.removeCount + Math.min(amount, this.getStack().func_190916_E());
      }
   ...
   protected void onCrafting(ItemStack stack) {
      ...
      if (!this.thePlayer.world.isRemote) {
         ...
         while (i > 0) {
            ...
            this.thePlayer
               .world
               .spawnEntityInWorld(new EntityXPOrb(this.thePlayer.world, this.thePlayer.posX, this.thePlayer.posY + 0.5, this.thePlayer.posZ + 0.5, k));
         }
      }
