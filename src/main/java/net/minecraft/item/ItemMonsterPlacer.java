   ...
   public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
      ...
      if (playerIn.isRemote) {
         ...
         Entity entity = spawnCreature(
            playerIn, func_190908_h(itemstack), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + d0, (double)blockpos.getZ() + 0.5
         );
         if (entity != null) {
      ...
      if (itemStackIn.isRemote) {
         ...
         if (raytraceresult != null && raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK) {
            ...
            if (!(itemStackIn.getBlockState(blockpos).getBlock() instanceof BlockLiquid)) {
               ...
               Entity entity = spawnCreature(
                  itemStackIn, func_190908_h(itemstack), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + 0.5, (double)blockpos.getZ() + 0.5
               );
               if (entity == null) {
                  return new ActionResult<>(EnumActionResult.PASS, itemstack);
               } else {
