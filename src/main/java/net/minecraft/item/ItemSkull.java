      ...
      if (hand == EnumFacing.DOWN) {
         ...
         if (!stack.canPlayerEdit(worldIn, hand, itemstack) || !Blocks.SKULL.canPlaceBlockAt(playerIn, worldIn)) {
            ...
            if (hand == EnumFacing.UP) {
               i = MathHelper.floor((double)(stack.rotationYaw * 16.0F / 360.0F) + 0.5) & 15;
            }

            if (playerIn.getTileEntity(worldIn) instanceof TileEntitySkull tileentityskull) {
