...
public class ItemSlab extends ItemBlock {
   ...
   public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
      ...
      if (!itemstack.func_190926_b() && stack.canPlayerEdit(worldIn.offset(hand), hand, itemstack)) {
         ...
         if (iblockstate.getBlock() == this.singleSlab) {
            ...
            if ((
                  hand == EnumFacing.UP && blockslab$enumblockhalf == BlockSlab.EnumBlockHalf.BOTTOM
               ...
               if (axisalignedbb != Block.NULL_AABB
                  ...
                  playerIn.playSound(
                     stack, worldIn, soundtype.getPlaceSound(), SoundCategory.BLOCKS, (soundtype.getVolume() + 1.0F) / 2.0F, soundtype.getPitch() * 0.8F
                  );
   ...
   protected <T extends Comparable<T>> IBlockState makeState(IProperty<T> p_185055_1_, Comparable<?> p_185055_2_) {
      return this.doubleSlab.getDefaultState().withProperty((IProperty)p_185055_1_, (Comparable) p_185055_2_);
   }
}
