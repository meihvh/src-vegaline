...
public class JsonToNBT {
   ...
   private <T extends Number> List<T> func_193603_a(byte p_193603_1_, byte p_193603_2_) throws NBTException {
      ...
      while (this.func_193598_n() != ']') {
         ...
         if (p_193603_2_ == 1) {
            list.add((T)(Object)((NBTPrimitive)nbtbase).getByte());
         } else if (p_193603_2_ == 4) {
            list.add((T)(Object)((NBTPrimitive)nbtbase).getLong());
         } else {
            list.add((T)(Object)((NBTPrimitive)nbtbase).getInt());
         }
   ...
   private void func_193604_b(char p_193604_1_) throws NBTException {
      ...
      if (flag && this.func_193598_n() == p_193604_1_) {
         ...
         throw new NBTException(
            "Expected '" + p_193604_1_ + "' but got '" + (flag ? this.func_193598_n() : "<EOF>") + "'", this.field_193622_h, this.field_193623_i + 1
         );
      }
   }

   protected boolean func_193599_a(char p_193599_1_) {
      return p_193599_1_ >= '0' && p_193599_1_ <= '9'
         || p_193599_1_ >= 'A' && p_193599_1_ <= 'Z'
         || p_193599_1_ >= 'a' && p_193599_1_ <= 'z'
         || p_193599_1_ == '_'
         || p_193599_1_ == '-'
         || p_193599_1_ == '.'
