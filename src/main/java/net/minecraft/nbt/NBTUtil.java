...
public final class NBTUtil {
   ...
   private static <T extends Comparable<T>> IBlockState func_193590_a(
      ...
      if (optional.isPresent()) {
         ...
         field_193591_a.warn(
            "Unable to read property: {} with value: {} for blockstate: {}", p_193590_2_, p_193590_3_.getString(p_193590_2_), p_193590_4_.toString()
         );
         return p_193590_0_;
      }
   }
