...
public class CPacketPlayer implements Packet<INetHandlerPlayServer> {
   ...
   public static float lastSendedYaw;
   public static float prevSendedYaw;
   public static float lastSendedPitch;
   ...
   public void setRotation(float yaw, float pitch) {
      this.yaw = yaw;
      this.pitch = pitch;
      prevSendedYaw = lastSendedYaw;
      lastSendedYaw = this.yaw;
      if (prevSendedYaw == 0.0F) {
         prevSendedYaw = lastSendedYaw;
      }

      lastSendedPitch = this.yaw;
   }
