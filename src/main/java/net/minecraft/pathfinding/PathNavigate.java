...
public abstract class PathNavigate {
   ...
   protected void pathFollow() {
      ...
      if (MathHelper.abs((float)(this.theEntity.posX - (vec3d1.xCoord + 0.5))) < this.maxDistanceToWaypoint
         && MathHelper.abs((float)(this.theEntity.posZ - (vec3d1.zCoord + 0.5))) < this.maxDistanceToWaypoint
         && Math.abs(this.theEntity.posY - vec3d1.yCoord) < 1.0) {
         this.currentPath.setCurrentPathIndex(this.currentPath.getCurrentPathIndex() + 1);
      }
   ...
   protected void checkForStuck(Vec3d positionVec3) {
      ...
      if (this.currentPath != null && !this.currentPath.isFinished()) {
         ...
         if (vec3d.equals(this.timeoutCachedNode)) {
            ...
            this.timeoutLimit = this.theEntity.getAIMoveSpeed() > 0.0F ? d0 / (double)this.theEntity.getAIMoveSpeed() * 1000.0 : 0.0;
         }
