...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance) {
      ...
      double d0 = (double)currentPoint.yCoord - (1.0 - this.blockaccess.getBlockState(blockpos).getBoundingBox(this.blockaccess, blockpos).maxY);
   ...
   private PathNodeType getPathNodeType(EntityLiving entitylivingIn, int x, int y, int z) {
      return this.getPathNodeType(
         this.blockaccess, x, y, z, entitylivingIn, this.entitySizeX, this.entitySizeY, this.entitySizeZ, this.getCanBreakDoors(), this.getCanEnterDoors()
      );
   }
   ...
   public PathNodeType getPathNodeType(IBlockAccess blockaccessIn, int x, int y, int z) {
      ...
      return this.func_193578_a(blockaccessIn, x, y, z, pathnodetype);
   }
