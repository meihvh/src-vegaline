...
public class PotionEffect implements Comparable<PotionEffect> {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return !(p_equals_1_ instanceof PotionEffect potioneffect)
            ? false
   ...
   public PotionEffect copy() {
      return new PotionEffect(this.potion, this.duration, this.amplifier, this.isAmbient, this.showParticles);
   }
}
