         ...
         if (item != null) {
            ...
            if (s != null) {
               OBJECT_USE_STATS[i] = new StatCrafting(
                     "stat.useItem.", s, new TextComponentTranslation("stat.useItem", new ItemStack(item).getTextComponent()), item
                  )
                  .registerStat();
         ...
         if (item != null) {
            ...
            if (s != null) {
               OBJECTS_PICKED_UP_STATS[i] = new StatCrafting(
                     "stat.pickup.", s, new TextComponentTranslation("stat.pickup", new ItemStack(item).getTextComponent()), item
                  )
                  .registerStat();
               OBJECTS_DROPPED_STATS[i] = new StatCrafting(
                     "stat.drop.", s, new TextComponentTranslation("stat.drop", new ItemStack(item).getTextComponent()), item
                  )
                  .registerStat();
            }
         }
