...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, ISidedInventory {
   ...
   public final List<TileEntityBeacon.BeamSegment> beamSegments = Lists.newArrayList();
   ...
   public void addEffectsToPlayers() {
      if (this.isComplete && this.levels > 0 && !this.world.isRemote && this.primaryEffect != null) {
         ...
         AxisAlignedBB axisalignedbb = new AxisAlignedBB((double)k, (double)l, (double)i1, (double)(k + 1), (double)(l + 1), (double)(i1 + 1))
            .expandXyz(d0)
            .addCoord(0.0, (double)this.world.getHeight(), 0.0);
      ...
      if (!this.world.isRemote && l < this.levels) {
         for (EntityPlayerMP entityplayermp : this.world
            .getEntitiesWithinAABB(
               EntityPlayerMP.class, new AxisAlignedBB((double)i, (double)j, (double)k, (double)i, (double)(j - 4), (double)k).expand(10.0, 5.0, 10.0)
            )) {
   ...
   public ItemStack decrStackSize(int index, int count) {
      ...
      } else if (count >= this.payment.func_190916_E()) {
