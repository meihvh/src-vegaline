...
public class TileEntityChest extends TileEntityLockableLoot implements ITickable {
   ...
   protected TileEntityChest getAdjacentChest(EnumFacing side) {
      ...
      if (this.isChestAt(blockpos) && this.world.getTileEntity(blockpos) instanceof TileEntityChest tileentitychest) {
   ...
   public void update() {
      ...
      if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
         ...
         this.world
            .playSound(
               (EntityPlayer)null, d1, (double)j + 0.5, d2, SoundEvents.BLOCK_CHEST_OPEN, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F
            );
      }
