      ...
      if (this.furnaceItemStacks.get(0).func_190926_b()) {
         ...
         if (itemstack.func_190926_b()) {
            ...
            if (itemstack1.func_190926_b()) {
               ...
               return itemstack1.func_190916_E() < this.getInventoryStackLimit() && itemstack1.func_190916_E() < itemstack1.getMaxStackSize()
                  ? true
                  : itemstack1.func_190916_E() < itemstack.getMaxStackSize();
            }
         }
      }
   }
   ...
   public void smeltItem() {
      if (this.canSmelt()) {
         ...
         if (itemstack.getItem() == Item.getItemFromBlock(Blocks.SPONGE)
            ...
            && !this.furnaceItemStacks.get(1).func_190926_b()
