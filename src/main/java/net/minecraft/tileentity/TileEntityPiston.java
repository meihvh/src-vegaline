...
public class TileEntityPiston extends TileEntity implements ITickable {
   ...
   private void moveCollidedEntities(float p_184322_1_) {
      ...
      if (!list.isEmpty()) {
         ...
         List<Entity> list1 = this.world
            .getEntitiesWithinAABBExcludingEntity((Entity)null, this.func_190610_a(axisalignedbb, enumfacing, d0).union(axisalignedbb));
         if (!list1.isEmpty()) {
