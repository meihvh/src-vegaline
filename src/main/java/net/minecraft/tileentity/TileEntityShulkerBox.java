...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
   ...
   private AxisAlignedBB func_190588_c(EnumFacing p_190588_1_) {
      ...
      return this.func_190587_b(p_190588_1_)
         .func_191195_a((double)enumfacing.getFrontOffsetX(), (double)enumfacing.getFrontOffsetY(), (double)enumfacing.getFrontOffsetZ());
   }
   ...
   public void openInventory(EntityPlayer player) {
      if (!player.isSpectator()) {
         ...
         if (this.field_190598_h == 1) {
            this.world
               .playSound((EntityPlayer)null, this.pos, SoundEvents.field_191262_fB, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }
      }
   }
   ...
   public void closeInventory(EntityPlayer player) {
      if (!player.isSpectator()) {
         ...
         if (this.field_190598_h <= 0) {
            this.world
               .playSound((EntityPlayer)null, this.pos, SoundEvents.field_191261_fA, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }
      }
   }
