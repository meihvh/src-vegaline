...
public enum EnumFacing implements IStringSerializable {
   ...
   public static EnumFacing fromAngle(double angle) {
      return getHorizontal(MathHelper.floor(angle / 90.0 + 0.5) & 3);
   }
   ...
   public static EnumFacing func_190914_a(BlockPos p_190914_0_, EntityLivingBase p_190914_1_) {
      if (Math.abs(p_190914_1_.posX - (double)((float)p_190914_0_.getX() + 0.5F)) < 2.0
         && Math.abs(p_190914_1_.posZ - (double)((float)p_190914_0_.getZ() + 0.5F)) < 2.0) {
