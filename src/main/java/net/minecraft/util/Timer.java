...
import ru.govno.client.module.modules.PhantomDash;

public class Timer {
   public float renderPartialTicks;
   public double speed = 1.0;
   public double tempSpeed = 1.0;
   ...
   public double getGameSpeed() {
      return this.speed * PhantomDash.tempSpeed * this.tempSpeed * GameSyncTPS.getGameConpense(1.0, GameSyncTPS.instance.SyncPercent.getFloat());
   }
   ...
   public void updateTimer() {
      ...
      this.field_194147_b = this.field_194147_b + this.field_194148_c;
      this.elapsedTicks = (int)this.field_194147_b;
      this.field_194147_b = this.field_194147_b - (float)this.elapsedTicks;
