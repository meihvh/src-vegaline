...
public class AxisAlignedBB {
   ...
   public AxisAlignedBB(Vec3d pos) {
   ...
   public AxisAlignedBB(BlockPos pos, float expandByY1) {
      this(
         ...
         (double)pos.getZ(),
         (double)(pos.getX() + 1),
         (double)((float)pos.getY() + expandByY1),
         (double)(pos.getZ() + 1)
      );
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (Double.compare(axisalignedbb.minX, this.minX) != 0) {
            ...
            return Double.compare(axisalignedbb.maxY, this.maxY) != 0 ? false : Double.compare(axisalignedbb.maxZ, this.maxZ) == 0;
         }
      } else {
         return false;
      }
   ...
   public boolean intersects(Vec3d min, Vec3d max) {
      return this.intersects(
         Math.min(min.xCoord, max.xCoord),
         Math.min(min.yCoord, max.yCoord),
         Math.min(min.zCoord, max.zCoord),
         Math.max(min.xCoord, max.xCoord),
         Math.max(min.yCoord, max.yCoord),
   ...
   public boolean isVecInside(Vec3d vec) {
      if (!(vec.xCoord > this.minX) || !(vec.xCoord < this.maxX)) {
         ...
         return vec.yCoord > this.minY && vec.yCoord < this.maxY ? vec.zCoord > this.minZ && vec.zCoord < this.maxZ : false;
      }
   }
