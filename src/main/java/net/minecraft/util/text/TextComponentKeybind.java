...
public class TextComponentKeybind extends TextComponentBase {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return !(p_equals_1_ instanceof TextComponentKeybind textcomponentkeybind)
            ? false
            : this.field_193638_c.equals(textcomponentkeybind.field_193638_c) && super.equals(p_equals_1_);
      }
   }
