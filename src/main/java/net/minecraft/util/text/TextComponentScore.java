...
public class TextComponentScore extends TextComponentBase {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return !(p_equals_1_ instanceof TextComponentScore textcomponentscore)
            ? false
            : this.name.equals(textcomponentscore.name) && this.objective.equals(textcomponentscore.objective) && super.equals(p_equals_1_);
      }
   }
