...
public class TextComponentTranslation extends TextComponentBase {
   ...
   private ITextComponent getFormatArgumentAsComponent(int index) {
      if (index >= this.formatArgs.length) {
         ...
         if (!(object instanceof ITextComponent itc)) {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return !(p_equals_1_ instanceof TextComponentTranslation textcomponenttranslation)
            ? false
            : Arrays.equals(this.formatArgs, textcomponenttranslation.formatArgs) && this.key.equals(textcomponenttranslation.key) && super.equals(p_equals_1_);
      }
   }
