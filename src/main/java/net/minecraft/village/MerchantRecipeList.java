...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
   ...
   public MerchantRecipe canRecipeBeUsed(ItemStack p_77203_1_, ItemStack p_77203_2_, int p_77203_3_) {
      if (p_77203_3_ > 0 && p_77203_3_ < this.size()) {
         ...
         return this.areItemStacksExactlyEqual(p_77203_1_, merchantrecipe1.getItemToBuy())
               ...
               && (!merchantrecipe1.hasSecondItemToBuy() || p_77203_2_.func_190916_E() >= merchantrecipe1.getSecondItemToBuy().func_190916_E())
            ? merchantrecipe1
            : null;
      } else {
         for (int i = 0; i < this.size(); i++) {
            ...
            if (this.areItemStacksExactlyEqual(p_77203_1_, merchantrecipe.getItemToBuy())
               ...
               && (
                  !merchantrecipe.hasSecondItemToBuy() && p_77203_2_.func_190926_b()
   ...
   private boolean areItemStacksExactlyEqual(ItemStack stack1, ItemStack stack2) {
      return ItemStack.areItemsEqual(stack1, stack2)
         && (!stack2.hasTagCompound() || stack1.hasTagCompound() && NBTUtil.areNBTEquals(stack2.getTagCompound(), stack1.getTagCompound(), false));
   }
