...
public class DragonFightManager {
   ...
   private BlockPattern.PatternHelper findExitPortal() {
      ...
      for (int l = k; l >= 0; l--) {
         BlockPattern.PatternHelper blockpattern$patternhelper1 = this.portalPattern
            .match(this.world, new BlockPos(WorldGenEndPodium.END_PODIUM_LOCATION.getX(), l, WorldGenEndPodium.END_PODIUM_LOCATION.getZ()));
   ...
   private void findAliveCrystals() {
      ...
      for (WorldGenSpikes.EndSpike worldgenspikes$endspike : BiomeEndDecorator.getSpikesForWorld(this.world)) {
         this.aliveCrystals = this.aliveCrystals
            + this.world.getEntitiesWithinAABB(EntityEnderCrystal.class, worldgenspikes$endspike.getTopBoundingBox()).size();
      }
