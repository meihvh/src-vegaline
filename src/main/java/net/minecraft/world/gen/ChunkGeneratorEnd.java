...
public class ChunkGeneratorEnd implements IChunkGenerator {
   ...
   private double[] getHeights(double[] p_185963_1_, int p_185963_2_, int p_185963_3_, int p_185963_4_, int p_185963_5_, int p_185963_6_, int p_185963_7_) {
      ...
      this.pnr = this.perlinNoise1
         .generateNoiseOctaves(this.pnr, p_185963_2_, p_185963_3_, p_185963_4_, p_185963_5_, p_185963_6_, p_185963_7_, d0 / 80.0, 4.277575000000001, d0 / 80.0);
      ...
      for (int l = 0; l < p_185963_5_; l++) {
         for (int i1 = 0; i1 < p_185963_7_; i1++) {
            ...
            for (int j1 = 0; j1 < p_185963_6_; j1++) {
               ...
               int var33 = 8;
               if (j1 < var33) {
                  double d7 = (double)((float)(var33 - j1) / ((float)var33 - 1.0F));
      ...
      if (i > 4096L) {
         ...
         if (f < -20.0F && this.rand.nextInt(14) == 0) {
            ...
            if (this.rand.nextInt(4) == 0) {
               this.endIslands
                  .generate(this.worldObj, this.rand, blockpos.add(this.rand.nextInt(16) + 8, 55 + this.rand.nextInt(16), this.rand.nextInt(16) + 8));
            }
         }
         ...
         if (this.getIslandHeightValue(x, z, 1, 1) > 40.0F) {
            ...
            for (int k = 0; k < j; k++) {
               ...
               if (j1 > 0) {
                  ...
                  if (this.worldObj.isAirBlock(blockpos.add(l, k1 + 1, i1))
                     && this.worldObj.getBlockState(blockpos.add(l, k1, i1)).getBlock() == Blocks.END_STONE) {
            ...
            if (this.rand.nextInt(700) == 0) {
               ...
               if (j2 > 0) {
                  ...
                  if (this.worldObj.getTileEntity(blockpos1) instanceof TileEntityEndGateway tileentityendgateway) {
