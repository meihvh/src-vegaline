                                    ...
                                    if (j2 - 1 < 10) {
                                       ...
                                       if (flag1 && p_180702_5_.getBlockState(j3, j2 - 1, i2).getBlock() == Blocks.DIRT) {
                                          ...
                                          p_180702_5_.setBlockState(
                                             j3, j2 - 1, i2, this.worldObj.getBiome(blockpos$mutableblockpos).topBlock.getBlock().getDefaultState()
                                          );
                                       }
                                    }
                                 }
   ...
   protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
      if (p_175793_1_.getBlock() == Blocks.STONE) {
         ...
         return p_175793_1_.getBlock() == Blocks.SNOW_LAYER
            ? true
            : (p_175793_1_.getBlock() == Blocks.SAND || p_175793_1_.getBlock() == Blocks.GRAVEL) && p_175793_2_.getMaterial() != Material.WATER;
      }
   }
