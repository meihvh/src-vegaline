            ...
            for (int i3 = -2; i3 <= 0; i3++) {
               for (int l3 = -2; l3 <= 0; l3++) {
                  ...
                  if ((i3 > -2 || l3 > -1) && (i3 != -1 || l3 != -2)) {
                     int var28 = 1;
                     this.placeLeafAt(worldIn, k1 + i3, i2 + var28, l1 + l3);
                     this.placeLeafAt(worldIn, 1 + k1 - i3, i2 + var28, l1 + l3);
                     this.placeLeafAt(worldIn, k1 + i3, i2 + var28, 1 + l1 - l3);
                     this.placeLeafAt(worldIn, 1 + k1 - i3, i2 + var28, 1 + l1 - l3);
                  }
               }
            }
