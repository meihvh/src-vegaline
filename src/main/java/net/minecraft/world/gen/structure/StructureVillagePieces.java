...
public class StructureVillagePieces {
   ...
   private static StructureVillagePieces.Village generateComponent(
      ...
      if (i <= 0) {
         ...
         return structureboundingbox != null ? new StructureVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing) : null;
      }
   }
   ...
   abstract static class Village extends StructureComponent {
      ...
      protected void func_189926_a(
         ...
         if (!this.isZombieInfested) {
            this.setBlockState(
               p_189926_1_, Blocks.TORCH.getDefaultState().withProperty(BlockTorch.FACING, p_189926_2_), p_189926_3_, p_189926_4_, p_189926_5_, p_189926_6_
            );
         }
      }
