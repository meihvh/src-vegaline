...
public class WoodlandMansionPieces {
   ...
   public static void func_191152_a(
      TemplateManager p_191152_0_, BlockPos p_191152_1_, Rotation p_191152_2_, List<WoodlandMansionPieces.MansionTemplate> p_191152_3_, Random p_191152_4_
   ) {
   ...
   static class Grid {
      ...
      public EnumFacing func_191113_b(WoodlandMansionPieces.SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_) {
         for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
            if (this.func_191114_a(
               p_191113_1_, p_191113_2_ + enumfacing.getFrontOffsetX(), p_191113_3_ + enumfacing.getFrontOffsetZ(), p_191113_4_, p_191113_5_
            )) {
               return enumfacing;
            }
         }
         ...
         if (p_191110_5_ > 0) {
            ...
            for (int i = 0; i < 8; i++) {
               ...
               if (enumfacing != p_191110_4_.getOpposite() && (enumfacing != EnumFacing.EAST || !this.field_191117_a.nextBoolean())) {
                  ...
                  if (p_191110_1_.func_191145_a(j + enumfacing.getFrontOffsetX(), k + enumfacing.getFrontOffsetZ()) == 0
                     && p_191110_1_.func_191145_a(j + enumfacing.getFrontOffsetX() * 2, k + enumfacing.getFrontOffsetZ() * 2) == 0) {
                     this.func_191110_a(
                        p_191110_1_,
      ...
      private void func_191115_b() {
         ...
         if (list.isEmpty()) {
            ...
            int l1 = woodlandmansionpieces$simplegrid.func_191145_a(tuple.getFirst(), tuple.getSecond());
            woodlandmansionpieces$simplegrid.func_191144_a(tuple.getFirst(), tuple.getSecond(), l1 | 4194304);
            EnumFacing enumfacing1 = this.func_191113_b(this.field_191118_b, tuple.getFirst(), tuple.getSecond(), 1, l1 & 65535);
            ...
            if (list1.isEmpty()) {
               this.field_191119_c.func_191142_a(0, 0, this.field_191119_c.field_191149_b, this.field_191119_c.field_191150_c, 5);
               woodlandmansionpieces$simplegrid.func_191144_a(tuple.getFirst(), tuple.getSecond(), l1);
            } else {
      ...
      private void func_191116_a(WoodlandMansionPieces.SimpleGrid p_191116_1_, WoodlandMansionPieces.SimpleGrid p_191116_2_) {
         ...
         for (Tuple<Integer, Integer> tuple : list) {
            ...
            if (p_191116_2_.func_191145_a(k, l) == 0) {
               ...
               int l1 = l;
               int i2 = 65536;
               if (p_191116_2_.func_191145_a(k + 1, l) == 0
                  && p_191116_2_.func_191145_a(k, l + 1) == 0
                  && p_191116_2_.func_191145_a(k + 1, l + 1) == 0
                  && p_191116_1_.func_191145_a(k + 1, l) == 2
                  && p_191116_1_.func_191145_a(k, l + 1) == 2
                  && p_191116_1_.func_191145_a(k + 1, l + 1) == 2) {
                  j1 = k + 1;
                  l1 = l + 1;
                  i2 = 262144;
               } else if (p_191116_2_.func_191145_a(k - 1, l) == 0
                  && p_191116_2_.func_191145_a(k, l + 1) == 0
                  && p_191116_2_.func_191145_a(k - 1, l + 1) == 0
                  && p_191116_1_.func_191145_a(k - 1, l) == 2
                  && p_191116_1_.func_191145_a(k, l + 1) == 2
   ...
   static class Placer {
      ...
      public void func_191125_a(
         BlockPos p_191125_1_, Rotation p_191125_2_, List<WoodlandMansionPieces.MansionTemplate> p_191125_3_, WoodlandMansionPieces.Grid p_191125_4_
      ) {
         ...
         WoodlandMansionPieces.RoomCollection[] awoodlandmansionpieces$roomcollection = new WoodlandMansionPieces.RoomCollection[]{
               ...
               for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.field_191149_b; j1++) {
                  if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1) == 1) {
                     ...
                     if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 - 1) == 1
                        || (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 - 1) & 8388608) == 8388608) {
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "carpet_north", blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), 1).up(), p_191125_2_
                           )
                        );
                     }

                     if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 + 1, i1) == 1
                        || (woodlandmansionpieces$simplegrid2.func_191145_a(j1 + 1, i1) & 8388608) == 8388608) {
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a,
                              "carpet_east",
                              blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 1).offset(p_191125_2_.rotate(EnumFacing.EAST), 5).up(),
                              p_191125_2_
                           )
                        );
                     }
                     ...
                     if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 + 1) == 1
                        ...
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a,
                              s,
                              blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 5).offset(p_191125_2_.rotate(EnumFacing.WEST), 1),
                              p_191125_2_
                           )
                        );
                     }
                     ...
                     if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 - 1, i1) == 1
                        ...
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a,
                              s1,
                              blockpos1.offset(p_191125_2_.rotate(EnumFacing.WEST), 1).offset(p_191125_2_.rotate(EnumFacing.NORTH), 1),
                              p_191125_2_
                           )
                        );
                     }
               ...
               for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; l1++) {
                  ...
                  if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 2 || flag1) {
                     ...
                     if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1)
                        && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2, k2)) {
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.WEST ? s3 : s2, blockpos2, p_191125_2_)
                        );
                     }
                     ...
                     if (woodlandmansionpieces$simplegrid3.func_191145_a(l1 + 1, k1) == 1 && !flag1) {
                        ...
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos3, p_191125_2_)
                        );
                     }

                     if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1)
                        && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2)) {
                        ...
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1 - 1) == 1 && !flag1) {
                        ...
                        p_191125_3_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, enumfacing1 == EnumFacing.NORTH ? s3 : s2, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (j2 == 65536) {
                        ...
                        if (!p_191125_4_.func_191114_a(
                           woodlandmansionpieces$simplegrid3, l1 + enumfacing2.getFrontOffsetX(), k1 + enumfacing2.getFrontOffsetZ(), l2, k2
                        )) {
      ...
      private void func_191130_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191130_1_,
         ...
         do {
            ...
            } else if (WoodlandMansionPieces.Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getFrontOffsetX(), j + p_191130_4_.getFrontOffsetZ())
      ...
      private void func_191123_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191123_1_,
            ...
            for (int j = 0; j < p_191123_4_.field_191149_b; j++) {
               ...
               if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i) && !flag) {
                  ...
                  if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j - 1, i)) {
                     ...
                     p_191123_1_.add(
                        new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos5, p_191123_3_.add(Rotation.CLOCKWISE_180))
                     );
                  }
                  ...
                  if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i - 1)) {
                     ...
                     p_191123_1_.add(
                        new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos6, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90))
                     );
                  }
                  ...
                  if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i + 1)) {
                     ...
                     p_191123_1_.add(
                        new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos7, p_191123_3_.add(Rotation.CLOCKWISE_90))
                     );
                  }
               }
            }
               ...
               for (int i1 = 0; i1 < p_191123_4_.field_191149_b; i1++) {
                  ...
                  if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k) && flag1) {
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos9, p_191123_3_.add(Rotation.CLOCKWISE_180))
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "small_wall", blockpos10, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos11, p_191123_3_.add(Rotation.CLOCKWISE_90))
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k)) {
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                           ...
                           p_191123_1_.add(
                              new WoodlandMansionPieces.MansionTemplate(
                                 this.field_191134_a, "small_wall_corner", blockpos13, p_191123_3_.add(Rotation.CLOCKWISE_90)
                              )
                           );
                        }
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
                           ...
                           p_191123_1_.add(
                              new WoodlandMansionPieces.MansionTemplate(
                                 this.field_191134_a, "small_wall_corner", blockpos14, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)
                              )
                           );
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                           ...
                           p_191123_1_.add(
                              new WoodlandMansionPieces.MansionTemplate(
                                 this.field_191134_a, "small_wall_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)
                              )
                           );
                        }
                     }
               ...
               if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l) && !flag2) {
                  if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l)) {
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1)) {
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "roof_corner", blockpos16, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)
                           )
                        );
                     } else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l - 1)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "roof_inner_corner", blockpos19, p_191123_3_.add(Rotation.CLOCKWISE_90)
                           )
                        );
                     }
                  }
                  ...
                  if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l)) {
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_corner", blockpos20, p_191123_3_.add(Rotation.CLOCKWISE_90))
                        );
                     } else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l + 1)) {
                        ...
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "roof_inner_corner", blockpos21, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1)) {
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_corner", blockpos17, p_191123_3_.add(Rotation.CLOCKWISE_180))
                        );
                     } else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l - 1)) {
                        BlockPos blockpos22 = blockpos17.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 1);
                        p_191123_1_.add(
                           new WoodlandMansionPieces.MansionTemplate(
                              this.field_191134_a, "roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_180)
                           )
                        );
                     }
                  }
      ...
      private void func_191133_a(List<WoodlandMansionPieces.MansionTemplate> p_191133_1_, WoodlandMansionPieces.PlacementData p_191133_2_) {
         ...
         p_191133_1_.add(
            new WoodlandMansionPieces.MansionTemplate(
               this.field_191134_a, "entrance", p_191133_2_.field_191139_b.offset(enumfacing, 9), p_191133_2_.field_191138_a
            )
         );
      ...
      private void func_191129_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191129_1_,
      ...
      private void func_191132_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191132_1_,
         ...
         if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH) {
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos13, p_191132_3_
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos12, p_191132_3_, Mirror.LEFT_RIGHT
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos11, p_191132_3_.add(Rotation.CLOCKWISE_180)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos10, p_191132_3_, Mirror.FRONT_BACK
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a,
                  p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_),
                  blockpos9,
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos8, p_191132_3_.add(Rotation.CLOCKWISE_90)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191100_a(this.field_191135_b, p_191132_7_), blockpos6, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos5, p_191132_3_
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos4, p_191132_3_.add(Rotation.CLOCKWISE_180)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos3, p_191132_3_.add(Rotation.CLOCKWISE_90)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191098_b(this.field_191135_b, p_191132_7_), blockpos2, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(
                  this.field_191134_a, p_191132_6_.func_191102_c(this.field_191135_b), blockpos1, p_191132_3_.add(Rotation.CLOCKWISE_90)
               )
            );
            ...
            p_191132_1_.add(
               new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191132_6_.func_191102_c(this.field_191135_b), blockpos, p_191132_3_)
            );
         }
      }

      private void func_191127_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191127_1_,
         ...
         p_191127_1_.add(
            new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191127_6_.func_191101_d(this.field_191135_b), blockpos, rotation, mirror)
         );
      }

      private void func_191128_a(
         List<WoodlandMansionPieces.MansionTemplate> p_191128_1_, BlockPos p_191128_2_, Rotation p_191128_3_, WoodlandMansionPieces.RoomCollection p_191128_4_
      ) {
         BlockPos blockpos = p_191128_2_.offset(p_191128_3_.rotate(EnumFacing.EAST), 1);
         p_191128_1_.add(
            new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, p_191128_4_.func_191103_e(this.field_191135_b), blockpos, p_191128_3_, Mirror.NONE)
         );
      }
   }
   ...
   static class SimpleGrid {
      ...
      public int func_191145_a(int p_191145_1_, int p_191145_2_) {
         return p_191145_1_ >= 0 && p_191145_1_ < this.field_191149_b && p_191145_2_ >= 0 && p_191145_2_ < this.field_191150_c
            ? this.field_191148_a[p_191145_1_][p_191145_2_]
            : this.field_191151_d;
      }
