...
public class BetterGrass {
   ...
   private static TextureAtlasSprite registerSprite(
      Properties p_registerSprite_0_, String p_registerSprite_1_, String p_registerSprite_2_, TextureMap p_registerSprite_3_
   ) {
      ...
      return p_registerSprite_3_.registerSprite(resourcelocation1);
   }

   public static List getFaceQuads(
      IBlockAccess p_getFaceQuads_0_, IBlockState p_getFaceQuads_1_, BlockPos p_getFaceQuads_2_, EnumFacing p_getFaceQuads_3_, List p_getFaceQuads_4_
   ) {
      if (p_getFaceQuads_3_ == EnumFacing.UP || p_getFaceQuads_3_ == EnumFacing.DOWN) {
         ...
         if (block instanceof BlockMycelium) {
            ...
            return block instanceof BlockGrass
               ? getFaceQuadsGrass(p_getFaceQuads_0_, p_getFaceQuads_1_, p_getFaceQuads_2_, p_getFaceQuads_3_, p_getFaceQuads_4_)
               : p_getFaceQuads_4_;
         }
      }
   }
   ...
   private static List getFaceQuadsMycelium(
      IBlockAccess p_getFaceQuadsMycelium_0_,
      IBlockState p_getFaceQuadsMycelium_1_,
      BlockPos p_getFaceQuadsMycelium_2_,
      EnumFacing p_getFaceQuadsMycelium_3_,
   ...
   private static List getFaceQuadsGrassPath(
      IBlockAccess p_getFaceQuadsGrassPath_0_,
      IBlockState p_getFaceQuadsGrassPath_1_,
      BlockPos p_getFaceQuadsGrassPath_2_,
      EnumFacing p_getFaceQuadsGrassPath_3_,
      List p_getFaceQuadsGrassPath_4_
   ) {
      if (!betterGrassPath) {
         return p_getFaceQuadsGrassPath_4_;
      } else if (Config.isBetterGrassFancy()) {
         return getBlockAt(p_getFaceQuadsGrassPath_2_.down(), p_getFaceQuadsGrassPath_3_, p_getFaceQuadsGrassPath_0_) == Blocks.GRASS_PATH
   ...
   private static List getFaceQuadsDirt(
      IBlockAccess p_getFaceQuadsDirt_0_,
      IBlockState p_getFaceQuadsDirt_1_,
      BlockPos p_getFaceQuadsDirt_2_,
      EnumFacing p_getFaceQuadsDirt_3_,
      ...
      if (p_getFaceQuadsDirt_1_.getValue(BlockDirt.VARIANT) != BlockDirt.DirtType.PODZOL) {
         if (block != Blocks.GRASS_PATH) {
            ...
            return betterGrassPath && getBlockAt(p_getFaceQuadsDirt_2_, p_getFaceQuadsDirt_3_, p_getFaceQuadsDirt_0_) == Blocks.GRASS_PATH
   ...
   private static List getFaceQuadsGrass(
      IBlockAccess p_getFaceQuadsGrass_0_,
      IBlockState p_getFaceQuadsGrass_1_,
      BlockPos p_getFaceQuadsGrass_2_,
      EnumFacing p_getFaceQuadsGrass_3_,
