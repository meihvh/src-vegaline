...
public class ConnectedParser {
   ...
   public boolean isFullBlockName(String[] p_isFullBlockName_1_) {
      if (p_isFullBlockName_1_.length < 2) {
         ...
         if (s.length() < 1) {
            ...
            return this.startsWithDigit(s) ? false : !s.contains("=");
         }
      }
   }
   ...
   private static Object getValueName(Comparable p_getValueName_0_) {
      return p_getValueName_0_ instanceof IStringSerializable istringserializable ? istringserializable.getName() : p_getValueName_0_.toString();
   }
   ...
   public EnumFacing parseFace(String p_parseFace_1_) {
      ...
      } else if (p_parseFace_1_.equals("top") || p_parseFace_1_.equals("up")) {
         return EnumFacing.UP;
      } else if (p_parseFace_1_.equals("north")) {
   ...
   public static int parseColor4(String p_parseColor4_0_, int p_parseColor4_1_) {
      if (p_parseColor4_0_ == null) {
         ...
         try {
            return (int)(Long.parseLong(p_parseColor4_0_, 16) & -1L);
         } catch (NumberFormatException var3) {
            return p_parseColor4_1_;
         }
      }
