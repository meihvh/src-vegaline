...
public class ConnectedProperties {
   ...
   private static int parseFace(String p_parseFace_0_) {
      ...
      if (p_parseFace_0_.equals("bottom") || p_parseFace_0_.equals("down")) {
         return 1;
      } else if (p_parseFace_0_.equals("top") || p_parseFace_0_.equals("up")) {
         return 2;
      } else if (p_parseFace_0_.equals("north")) {
         return 4;
   ...
   private static int parseMethod(String p_parseMethod_0_) {
      if (p_parseMethod_0_ == null) {
         ...
         return 1;
      } else if (p_parseMethod_0_.equals("ctm_compact")) {
         return 10;
      } else if (p_parseMethod_0_.equals("horizontal") || p_parseMethod_0_.equals("bookshelf")) {
         return 2;
      } else if (p_parseMethod_0_.equals("vertical")) {
         return 6;
         ...
         return 8;
      } else if (p_parseMethod_0_.equals("vertical+horizontal") || p_parseMethod_0_.equals("v+h")) {
         return 9;
      } else if (p_parseMethod_0_.equals("overlay")) {
         return 11;
      } else {
   ...
   private static TextureAtlasSprite getIcon(String p_getIcon_0_) {
      ...
      return textureatlassprite != null ? textureatlassprite : texturemap.getSpriteSafe("blocks/" + p_getIcon_0_);
   }
   ...
   private boolean isValidRepeat(String p_isValidRepeat_1_) {
      if (this.tiles == null) {
         ...
         return false;
      } else if (this.height > 0 && this.height <= 16) {
