...
public class ConnectedTexturesCompact {
   ...
   public static BakedQuad[] getConnectedTextureCtmCompact(
      int p_getConnectedTextureCtmCompact_0_,
      ConnectedProperties p_getConnectedTextureCtmCompact_1_,
      int p_getConnectedTextureCtmCompact_2_,
      BakedQuad p_getConnectedTextureCtmCompact_3_,
      RenderEnv p_getConnectedTextureCtmCompact_4_
   ) {
      if (p_getConnectedTextureCtmCompact_1_.ctmTileIndexes != null
         && p_getConnectedTextureCtmCompact_0_ >= 0
      ...
      switch (p_getConnectedTextureCtmCompact_0_) {
         case 1:
            return getQuadsCompactH(
               0,
               3,
               p_getConnectedTextureCtmCompact_1_.tileIcons,
   ...
   private static BakedQuad[] getQuadsCompactH(
      int p_getQuadsCompactH_0_,
      int p_getQuadsCompactH_1_,
      TextureAtlasSprite[] p_getQuadsCompactH_2_,
      int p_getQuadsCompactH_3_,
      BakedQuad p_getQuadsCompactH_4_,
      RenderEnv p_getQuadsCompactH_5_
   ) {
      return getQuadsCompact(
         ConnectedTexturesCompact.Dir.LEFT,
         p_getQuadsCompactH_0_,
         ConnectedTexturesCompact.Dir.RIGHT,
         p_getQuadsCompactH_1_,
         p_getQuadsCompactH_2_,
         p_getQuadsCompactH_3_,
         p_getQuadsCompactH_4_,
         p_getQuadsCompactH_5_
      );
   }

   private static BakedQuad[] getQuadsCompactV(
      int p_getQuadsCompactV_0_,
      int p_getQuadsCompactV_1_,
      TextureAtlasSprite[] p_getQuadsCompactV_2_,
      int p_getQuadsCompactV_3_,
      BakedQuad p_getQuadsCompactV_4_,
      RenderEnv p_getQuadsCompactV_5_
   ) {
      return getQuadsCompact(
         ConnectedTexturesCompact.Dir.UP,
         p_getQuadsCompactV_0_,
         ConnectedTexturesCompact.Dir.DOWN,
         p_getQuadsCompactV_1_,
         p_getQuadsCompactV_2_,
         p_getQuadsCompactV_3_,
         p_getQuadsCompactV_4_,
         p_getQuadsCompactV_5_
      );
   }

   private static BakedQuad[] getQuadsCompact4(
      int p_getQuadsCompact4_0_,
      int p_getQuadsCompact4_1_,
      int p_getQuadsCompact4_2_,
      int p_getQuadsCompact4_3_,
      TextureAtlasSprite[] p_getQuadsCompact4_4_,
      int p_getQuadsCompact4_5_,
      BakedQuad p_getQuadsCompact4_6_,
      RenderEnv p_getQuadsCompact4_7_
   ) {
      if (p_getQuadsCompact4_0_ == p_getQuadsCompact4_1_) {
         return p_getQuadsCompact4_2_ == p_getQuadsCompact4_3_
            ? getQuadsCompact(
               ...
               ConnectedTexturesCompact.Dir.DOWN,
               p_getQuadsCompact4_2_,
               p_getQuadsCompact4_4_,
               p_getQuadsCompact4_5_,
               p_getQuadsCompact4_6_,
   ...
   private static BakedQuad[] getQuadsCompact(
      int p_getQuadsCompact_0_, TextureAtlasSprite[] p_getQuadsCompact_1_, BakedQuad p_getQuadsCompact_2_, RenderEnv p_getQuadsCompact_3_
   ) {
   ...
   private static BakedQuad[] getQuadsCompact(
      ConnectedTexturesCompact.Dir p_getQuadsCompact_0_,
      int p_getQuadsCompact_1_,
      ConnectedTexturesCompact.Dir p_getQuadsCompact_2_,
      int p_getQuadsCompact_3_,
      TextureAtlasSprite[] p_getQuadsCompact_4_,
      int p_getQuadsCompact_5_,
      BakedQuad p_getQuadsCompact_6_,
      RenderEnv p_getQuadsCompact_7_
   ) {
      BakedQuad bakedquad = getQuadCompact(
         p_getQuadsCompact_4_[p_getQuadsCompact_1_], p_getQuadsCompact_0_, p_getQuadsCompact_5_, p_getQuadsCompact_6_, p_getQuadsCompact_7_
      );
      BakedQuad bakedquad1 = getQuadCompact(
         p_getQuadsCompact_4_[p_getQuadsCompact_3_], p_getQuadsCompact_2_, p_getQuadsCompact_5_, p_getQuadsCompact_6_, p_getQuadsCompact_7_
      );
   ...
   private static BakedQuad[] getQuadsCompact(
      ...
      ConnectedTexturesCompact.Dir p_getQuadsCompact_2_,
      int p_getQuadsCompact_3_,
      ConnectedTexturesCompact.Dir p_getQuadsCompact_4_,
      int p_getQuadsCompact_5_,
      TextureAtlasSprite[] p_getQuadsCompact_6_,
      int p_getQuadsCompact_7_,
      BakedQuad p_getQuadsCompact_8_,
      RenderEnv p_getQuadsCompact_9_
   ) {
      BakedQuad bakedquad = getQuadCompact(
         p_getQuadsCompact_6_[p_getQuadsCompact_1_], p_getQuadsCompact_0_, p_getQuadsCompact_7_, p_getQuadsCompact_8_, p_getQuadsCompact_9_
      );
      BakedQuad bakedquad1 = getQuadCompact(
         p_getQuadsCompact_6_[p_getQuadsCompact_3_], p_getQuadsCompact_2_, p_getQuadsCompact_7_, p_getQuadsCompact_8_, p_getQuadsCompact_9_
      );
      BakedQuad bakedquad2 = getQuadCompact(
         p_getQuadsCompact_6_[p_getQuadsCompact_5_], p_getQuadsCompact_4_, p_getQuadsCompact_7_, p_getQuadsCompact_8_, p_getQuadsCompact_9_
      );
   ...
   private static BakedQuad[] getQuadsCompact(
      ...
      ConnectedTexturesCompact.Dir p_getQuadsCompact_4_,
      int p_getQuadsCompact_5_,
      ConnectedTexturesCompact.Dir p_getQuadsCompact_6_,
      int p_getQuadsCompact_7_,
      TextureAtlasSprite[] p_getQuadsCompact_8_,
      int p_getQuadsCompact_9_,
      BakedQuad p_getQuadsCompact_10_,
      RenderEnv p_getQuadsCompact_11_
   ) {
      BakedQuad bakedquad = getQuadCompact(
         p_getQuadsCompact_8_[p_getQuadsCompact_1_], p_getQuadsCompact_0_, p_getQuadsCompact_9_, p_getQuadsCompact_10_, p_getQuadsCompact_11_
      );
      BakedQuad bakedquad1 = getQuadCompact(
         p_getQuadsCompact_8_[p_getQuadsCompact_3_], p_getQuadsCompact_2_, p_getQuadsCompact_9_, p_getQuadsCompact_10_, p_getQuadsCompact_11_
      );
      BakedQuad bakedquad2 = getQuadCompact(
         p_getQuadsCompact_8_[p_getQuadsCompact_5_], p_getQuadsCompact_4_, p_getQuadsCompact_9_, p_getQuadsCompact_10_, p_getQuadsCompact_11_
      );
      BakedQuad bakedquad3 = getQuadCompact(
         p_getQuadsCompact_8_[p_getQuadsCompact_7_], p_getQuadsCompact_6_, p_getQuadsCompact_9_, p_getQuadsCompact_10_, p_getQuadsCompact_11_
      );
   ...
   private static BakedQuad getQuadCompact(
      TextureAtlasSprite p_getQuadCompact_0_,
      ConnectedTexturesCompact.Dir p_getQuadCompact_1_,
      int p_getQuadCompact_2_,
      BakedQuad p_getQuadCompact_3_,
   ...
   private static BakedQuad getQuadCompact(
      ...
      ConnectedTexturesCompact.Dir p_getQuadCompact_1_,
      int p_getQuadCompact_2_,
      int p_getQuadCompact_3_,
      int p_getQuadCompact_4_,
      int p_getQuadCompact_5_,
      int p_getQuadCompact_6_,
      BakedQuad p_getQuadCompact_7_,
      ...
      if (amap == null) {
         ...
         if (i >= 0 && i < amap.length) {
            ...
            if (bakedquad == null) {
               bakedquad = makeSpriteQuadCompact(
                  p_getQuadCompact_7_,
                  p_getQuadCompact_0_,
                  p_getQuadCompact_6_,
                  p_getQuadCompact_2_,
   ...
   private static BakedQuad makeSpriteQuadCompact(
      BakedQuad p_makeSpriteQuadCompact_0_,
      TextureAtlasSprite p_makeSpriteQuadCompact_1_,
      int p_makeSpriteQuadCompact_2_,
      int p_makeSpriteQuadCompact_3_,
      int p_makeSpriteQuadCompact_4_,
      int p_makeSpriteQuadCompact_5_,
      ...
      for (int i = 0; i < 4; i++) {
         fixVertexCompact(
            ...
            i,
            textureatlassprite,
            p_makeSpriteQuadCompact_1_,
            p_makeSpriteQuadCompact_2_,
            p_makeSpriteQuadCompact_3_,
            p_makeSpriteQuadCompact_4_,
            p_makeSpriteQuadCompact_5_,
            p_makeSpriteQuadCompact_6_
         );
      }

      return new BakedQuad(aint, p_makeSpriteQuadCompact_0_.getTintIndex(), p_makeSpriteQuadCompact_0_.getFace(), p_makeSpriteQuadCompact_1_);
   }

   private static void fixVertexCompact(
      int[] p_fixVertexCompact_0_,
      int p_fixVertexCompact_1_,
      TextureAtlasSprite p_fixVertexCompact_2_,
      TextureAtlasSprite p_fixVertexCompact_3_,
      int p_fixVertexCompact_4_,
      int p_fixVertexCompact_5_,
      int p_fixVertexCompact_6_,
      int p_fixVertexCompact_7_,
