...
public class CrashReporter {
   ...
   public static void extendCrashReport(CrashReportCategory p_extendCrashReport_0_) {
      ...
      p_extendCrashReport_0_.addCrashSection(
         "Shaders", (Shaders.getShaderPackName())
      );
      p_extendCrashReport_0_.addCrashSection(
         "OpenGlVersion", (Config.openGlVersion)
      );
      p_extendCrashReport_0_.addCrashSection(
         "OpenGlRenderer", (Config.openGlRenderer)
      );
      p_extendCrashReport_0_.addCrashSection(
         "OpenGlVendor", (Config.openGlVendor)
      );
