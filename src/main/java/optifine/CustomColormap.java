...
public class CustomColormap implements CustomColors.IColorizer {
   ...
   private static String parseTexture(String p_parseTexture_0_, String p_parseTexture_1_, String p_parseTexture_2_) {
      if (p_parseTexture_0_ != null) {
         ...
         return fixTextureName(p_parseTexture_0_, p_parseTexture_2_);
      } else {
         ...
         return fixTextureName(s, p_parseTexture_2_);
      }
   }
   ...
   public int getColorSmooth(
      IBlockAccess p_getColorSmooth_1_, double p_getColorSmooth_2_, double p_getColorSmooth_4_, double p_getColorSmooth_6_, int p_getColorSmooth_8_
   ) {
      if (this.format == 2) {
         return this.color;
      } else {
