...
public class CustomItemProperties {
   ...
   public CustomItemProperties(Properties p_i33_1_, String p_i33_2_) {
      ...
      this.texture = parseTexture(
         p_i33_1_.getProperty("texture"),
         p_i33_1_.getProperty("tile"),
         p_i33_1_.getProperty("source"),
         p_i33_2_,
         this.basePath,
         this.type,
         this.mapTextures,
   ...
   private static String parseTexture(
      String p_parseTexture_0_,
      String p_parseTexture_1_,
      String p_parseTexture_2_,
      String p_parseTexture_3_,
      String p_parseTexture_4_,
      int p_parseTexture_5_,
      Map<String, String> p_parseTexture_6_,
      boolean p_parseTexture_7_
   ) {
      ...
      if (p_parseTexture_0_ != null) {
         ...
         return fixTextureName(p_parseTexture_0_, p_parseTexture_4_);
         ...
         if (!p_parseTexture_7_) {
            ...
            return fixTextureName(s1, p_parseTexture_4_);
         }
      }
   }
   ...
   private static String parseModel(
      String p_parseModel_0_, String p_parseModel_1_, String p_parseModel_2_, int p_parseModel_3_, Map<String, String> p_parseModel_4_
   ) {
      if (p_parseModel_0_ != null) {
         ...
         return fixModelName(p_parseModel_0_, p_parseModel_2_);
         ...
         if (i > 1) {
            ...
            if (aint.length == 1) {
               ...
               if (p_parseRangeInt_1_.startsWith("-")) {
                  ...
                  return p_parseRangeInt_1_.endsWith("-") ? new RangeInt(i1, 65535) : new RangeInt(i1, i1);
               }
   ...
   private static IBakedModel makeBakedModel(
      TextureMap p_makeBakedModel_0_, ItemModelGenerator p_makeBakedModel_1_, String[] p_makeBakedModel_2_, boolean p_makeBakedModel_3_
   ) {
   ...
   private String[] getModelTextures() {
      if (this.type == 1 && this.items.length == 1) {
         ...
         if (item instanceof ItemArmor itemarmor && itemarmor.getArmorMaterial() == ItemArmor.ArmorMaterial.LEATHER) {
            String s = "leather";
            String s1 = "helmet";
   ...
   private static IBakedModel bakeModel(TextureMap p_bakeModel_0_, ModelBlock p_bakeModel_1_, boolean p_bakeModel_2_) {
      ...
      SimpleBakedModel.Builder simplebakedmodel$builder = new SimpleBakedModel.Builder(p_bakeModel_1_, p_bakeModel_1_.createOverrides())
   ...
   private static BakedQuad makeBakedQuad(
      BlockPart p_makeBakedQuad_0_,
      BlockPartFace p_makeBakedQuad_1_,
      TextureAtlasSprite p_makeBakedQuad_2_,
      EnumFacing p_makeBakedQuad_3_,
      ModelRotation p_makeBakedQuad_4_,
      boolean p_makeBakedQuad_5_
   ) {
      FaceBakery facebakery = new FaceBakery();
      return facebakery.makeBakedQuad(
         p_makeBakedQuad_0_.positionFrom,
         p_makeBakedQuad_0_.positionTo,
         p_makeBakedQuad_1_,
         p_makeBakedQuad_2_,
         p_makeBakedQuad_3_,
         p_makeBakedQuad_4_,
         p_makeBakedQuad_0_.partRotation,
         p_makeBakedQuad_5_,
         p_makeBakedQuad_0_.shade
      );
   }
   ...
   private static void loadItemModel(ModelBakery p_loadItemModel_0_, String p_loadItemModel_1_) {
      ...
      if (Reflector.ModelLoader.exists()) {
         try {
            ...
            Config.warn("Error registering model: " + modelresourcelocation + ", " + var9.getClass().getName() + ": " + var9.getMessage());
         }
      } else {
   ...
   private static ResourceLocation getModelLocation(String p_getModelLocation_0_) {
      return Reflector.ModelLoader.exists() && !p_getModelLocation_0_.startsWith("mcpatcher/") && !p_getModelLocation_0_.startsWith("optifine/")
