...
public class CustomItems {
   ...
   private static Map makePotionImageProperties(
      IResourcePack p_makePotionImageProperties_0_, String p_makePotionImageProperties_1_, int p_makePotionImageProperties_2_
   ) {
      Map map = new HashMap();
   ...
   private static Properties makePotionProperties(
      String p_makePotionProperties_0_, String p_makePotionProperties_1_, int p_makePotionProperties_2_, String p_makePotionProperties_3_
   ) {
   ...
   public static IBakedModel getCustomItemModel(
      ItemStack p_getCustomItemModel_0_, IBakedModel p_getCustomItemModel_1_, ResourceLocation p_getCustomItemModel_2_, boolean p_getCustomItemModel_3_
   ) {
   ...
   public static boolean bindCustomArmorTexture(
      ItemStack p_bindCustomArmorTexture_0_, EntityEquipmentSlot p_bindCustomArmorTexture_1_, String p_bindCustomArmorTexture_2_
   ) {
   ...
   private static ResourceLocation getCustomArmorLocation(
      ItemStack p_getCustomArmorLocation_0_, EntityEquipmentSlot p_getCustomArmorLocation_1_, String p_getCustomArmorLocation_2_
   ) {
      ...
      } else if (p_getCustomArmorLocation_0_.getItem() instanceof ItemArmor itemarmor) {
   ...
   private static boolean matchesProperties(CustomItemProperties p_matchesProperties_0_, ItemStack p_matchesProperties_1_, int[][] p_matchesProperties_2_) {
      ...
      if (p_matchesProperties_0_.stackSize != null && !p_matchesProperties_0_.stackSize.isInRange(p_matchesProperties_1_.func_190916_E())) {
         ...
         if (p_matchesProperties_0_.hand != 0) {
            return p_matchesProperties_0_.hand == 1 && renderOffHand ? false : p_matchesProperties_0_.hand != 2 || renderOffHand;
         } else {
            return true;
         }
      }
   ...
   public static boolean renderCustomArmorEffect(
      EntityLivingBase p_renderCustomArmorEffect_0_,
      ItemStack p_renderCustomArmorEffect_1_,
      ModelBase p_renderCustomArmorEffect_2_,
      float p_renderCustomArmorEffect_3_,
      float p_renderCustomArmorEffect_4_,
      float p_renderCustomArmorEffect_5_,
      float p_renderCustomArmorEffect_6_,
      float p_renderCustomArmorEffect_7_,
      float p_renderCustomArmorEffect_8_,
      float p_renderCustomArmorEffect_9_
   ) {
      if (enchantmentProperties != null && (!NoRender.get.isActived() || !NoRender.get.EnchGlintEffect.getBool())) {
         if (Config.isShaders() && Shaders.isShadowPass) {
            return false;
         } else if (p_renderCustomArmorEffect_1_ != null && (!NoRender.get.actived || !NoRender.get.EnchGlintEffect.getBool())) {
                     ...
                     if (acustomitemproperties != null) {
                        for (int k = 0; k < acustomitemproperties.length; k++) {
                           ...
                           if (set.add(j)
                              ...
                              GlStateManager.matrixMode(5888);
                              p_renderCustomArmorEffect_2_.render(
                                 p_renderCustomArmorEffect_0_,
                                 p_renderCustomArmorEffect_3_,
                                 p_renderCustomArmorEffect_4_,
                                 p_renderCustomArmorEffect_6_,
                                 p_renderCustomArmorEffect_7_,
                                 p_renderCustomArmorEffect_8_,
                                 p_renderCustomArmorEffect_9_
                              );
                           }
                        }
                     }
