...
public class HttpPipeline {
   ...
   public static void addRequest(HttpPipelineRequest p_addRequest_0_) {
      ...
      for (HttpPipelineConnection httppipelineconnection = getConnection(httprequest.getHost(), httprequest.getPort(), httprequest.getProxy());
         !httppipelineconnection.addRequest(p_addRequest_0_);
   ...
   private static synchronized void removeConnection(
      String p_removeConnection_0_, int p_removeConnection_1_, Proxy p_removeConnection_2_, HttpPipelineConnection p_removeConnection_3_
   ) {
