...
public class ModelSprite {
   ...
   public void render(Tessellator p_render_1_, float p_render_2_) {
      ...
      renderItemIn2D(
         p_render_1_, f, f2, f1, f3, this.sizeX, this.sizeY, p_render_2_ * (float)this.sizeZ, this.modelRenderer.textureWidth, this.modelRenderer.textureHeight
      );
      GlStateManager.translate(-this.posX * p_render_2_, -this.posY * p_render_2_, -this.posZ * p_render_2_);
   }

   public static void renderItemIn2D(
      Tessellator p_renderItemIn2D_0_,
      float p_renderItemIn2D_1_,
      float p_renderItemIn2D_2_,
      float p_renderItemIn2D_3_,
      float p_renderItemIn2D_4_,
      int p_renderItemIn2D_5_,
      int p_renderItemIn2D_6_,
      float p_renderItemIn2D_7_,
      float p_renderItemIn2D_8_,
      float p_renderItemIn2D_9_
   ) {
      ...
      bufferbuilder.pos(0.0, d1, 0.0).tex((double)p_renderItemIn2D_1_, (double)p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(d0, d1, 0.0).tex((double)p_renderItemIn2D_3_, (double)p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(d0, 0.0, 0.0).tex((double)p_renderItemIn2D_3_, (double)p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(0.0, 0.0, 0.0).tex((double)p_renderItemIn2D_1_, (double)p_renderItemIn2D_2_).endVertex();
      p_renderItemIn2D_0_.draw();
      GL11.glNormal3f(0.0F, 0.0F, 1.0F);
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
      bufferbuilder.pos(0.0, 0.0, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_1_, (double)p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(d0, 0.0, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_3_, (double)p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(d0, d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_3_, (double)p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(0.0, d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_1_, (double)p_renderItemIn2D_4_).endVertex();
      p_renderItemIn2D_0_.draw();
      ...
      for (int i = 0; i < p_renderItemIn2D_5_; i++) {
         ...
         bufferbuilder.pos((double)f4 * d0, d1, 0.0).tex((double)f5, (double)p_renderItemIn2D_4_).endVertex();
         bufferbuilder.pos((double)f4 * d0, 0.0, 0.0).tex((double)f5, (double)p_renderItemIn2D_2_).endVertex();
         bufferbuilder.pos((double)f4 * d0, 0.0, (double)p_renderItemIn2D_7_).tex((double)f5, (double)p_renderItemIn2D_2_).endVertex();
      }
      ...
      for (int j = 0; j < p_renderItemIn2D_5_; j++) {
         ...
         bufferbuilder.pos((double)f6 * d0, 0.0, (double)p_renderItemIn2D_7_).tex((double)f10, (double)p_renderItemIn2D_2_).endVertex();
         bufferbuilder.pos((double)f6 * d0, 0.0, 0.0).tex((double)f10, (double)p_renderItemIn2D_2_).endVertex();
         bufferbuilder.pos((double)f6 * d0, d1, 0.0).tex((double)f10, (double)p_renderItemIn2D_4_).endVertex();
      ...
      for (int k = 0; k < p_renderItemIn2D_6_; k++) {
         ...
         bufferbuilder.pos(0.0, (double)f13 * d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_1_, (double)f11).endVertex();
         bufferbuilder.pos(d0, (double)f13 * d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_3_, (double)f11).endVertex();
         bufferbuilder.pos(d0, (double)f13 * d1, 0.0).tex((double)p_renderItemIn2D_3_, (double)f11).endVertex();
         bufferbuilder.pos(0.0, (double)f13 * d1, 0.0).tex((double)p_renderItemIn2D_1_, (double)f11).endVertex();
      }
      ...
      for (int l = 0; l < p_renderItemIn2D_6_; l++) {
         ...
         bufferbuilder.pos(0.0, (double)f9 * d1, (double)p_renderItemIn2D_7_).tex((double)p_renderItemIn2D_1_, (double)f12).endVertex();
         bufferbuilder.pos(0.0, (double)f9 * d1, 0.0).tex((double)p_renderItemIn2D_1_, (double)f12).endVertex();
         bufferbuilder.pos(d0, (double)f9 * d1, 0.0).tex((double)p_renderItemIn2D_3_, (double)f12).endVertex();
      }
