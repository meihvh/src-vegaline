...
public class PlayerConfigurationParser {
   ...
   private BufferedImage downloadTextureImage(String p_downloadTextureImage_1_) {
      ...
      try {
         ...
         Config.warn("Error loading item texture " + p_downloadTextureImage_1_ + ": " + var5.getClass().getName() + ": " + var5.getMessage());
         return null;
      }
   }
   ...
   private PlayerItemModel downloadModel(String p_downloadModel_1_) {
      ...
      try {
         ...
         Config.warn("Error loading item model " + p_downloadModel_1_ + ": " + var8.getClass().getName() + ": " + var8.getMessage());
         return null;
      }
   }
}
