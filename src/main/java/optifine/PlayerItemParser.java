...
public class PlayerItemParser {
   ...
   public static ModelRenderer parseModelRenderer(
      JsonObject p_parseModelRenderer_0_, ModelBase p_parseModelRenderer_1_, int[] p_parseModelRenderer_2_, String p_parseModelRenderer_3_
   ) {
   ...
   private static int[][] parseFaceUvs(JsonObject p_parseFaceUvs_0_) {
      int[][] aint = new int[][]{
         Json.parseIntArray(p_parseFaceUvs_0_.get("uvDown"), 4),
