...
public class ReflectorForge {
   public static void FMLClientHandler_trackBrokenTexture(
      ResourceLocation p_FMLClientHandler_trackBrokenTexture_0_, String p_FMLClientHandler_trackBrokenTexture_1_
   ) {
      if (!Reflector.FMLClientHandler_trackBrokenTexture.exists()) {
         Object object = Reflector.call(Reflector.FMLClientHandler_instance);
         Reflector.call(
            object, Reflector.FMLClientHandler_trackBrokenTexture, p_FMLClientHandler_trackBrokenTexture_0_, p_FMLClientHandler_trackBrokenTexture_1_
         );
      }
   }
   ...
   public static boolean renderFirstPersonHand(RenderGlobal p_renderFirstPersonHand_0_, float p_renderFirstPersonHand_1_, int p_renderFirstPersonHand_2_) {
      return !Reflector.ForgeHooksClient_renderFirstPersonHand.exists()
         ...
         : Reflector.callBoolean(
            Reflector.ForgeHooksClient_renderFirstPersonHand, p_renderFirstPersonHand_0_, p_renderFirstPersonHand_1_, p_renderFirstPersonHand_2_
         );
   }
   ...
   public static boolean blockHasTileEntity(IBlockState p_blockHasTileEntity_0_) {
      ...
      return !Reflector.ForgeBlock_hasTileEntity.exists()
         ? block.hasTileEntity()
   ...
   public static boolean isItemDamaged(ItemStack p_isItemDamaged_0_) {
      return !Reflector.ForgeItem_showDurabilityBar.exists()
         ? p_isItemDamaged_0_.isItemDamaged()
         : Reflector.callBoolean(p_isItemDamaged_0_.getItem(), Reflector.ForgeItem_showDurabilityBar, p_isItemDamaged_0_);
   }
   ...
   public static int getLightValue(IBlockState p_getLightValue_0_, IBlockAccess p_getLightValue_1_, BlockPos p_getLightValue_2_) {
      return Reflector.ForgeIBlockProperties_getLightValue2.exists()
         ? Reflector.callInt(p_getLightValue_0_, Reflector.ForgeIBlockProperties_getLightValue2, p_getLightValue_1_, p_getLightValue_2_)
