...
public class TriangleElement {
   private final List<Vec2f> offsetPos = new ArrayList<>();
   ...
   public int getColor(float alphaPC) {
      ...
      return ColorUtils.swapAlpha(
         ColorUtils.swapDark(color, this.colorOffsetDark.getAnim()), (float)ColorUtils.getAlphaFromColor(color) * alphaPC * this.colorOffsetDark.anim
      );
   }
   ...
   public void updateElement() {
      if (this.timerHelper.hasReached((double)this.delay)) {
