   ...
   public void drawTextBox(CFontRenderer font, float alphaPercent) {
      if (this.getVisible()) {
         ...
         if (!s.isEmpty()) {
            ...
            j1 = (int)font.getStringWidth(s1) + l;
            font.drawStringWithShadow(s1, (float)l, (float)i1, i);
         }
         ...
         if (!s.isEmpty() && flag && j < s.length()) {
            font.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
         }

         if (flag1) {
            if (flag2) {
               RenderUtils.drawRect((double)k1, (double)(i1 - 1), (double)(k1 + 1), (double)((float)(i1 + 1) + this.fontRendererInstance.getHeight()), -3092272);
            } else {
               font.drawStringWithShadow("_", (float)k1, (float)i1, i);
            }
         }

         if (k != j) {
            int l1 = l + (int)this.fontRendererInstance.getStringWidth(s.substring(0, k));
            this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + (int)this.fontRendererInstance.getHeight());
         }
      }
   }
