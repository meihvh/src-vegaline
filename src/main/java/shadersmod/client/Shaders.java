...
public class Shaders {
   ...
   public static int lastUseProgramInt = 0;
   ...
   private static CustomTexture[] loadCustomTextures(Properties props, int stage) {
      ...
      return list.size() <= 0 ? null : list.toArray(new CustomTexture[list.size()]);
   }
      ...
      if (path == null) {
         ...
         try {
            ...
            if (inputstream == null) {
               ...
               return new CustomTexture(index, s, simpleshadertexture);
            }
            ...
            try {
               ...
               while (true) {
                  ...
                  if (shaderline != null) {
                     ...
                     } else if (shaderline.isConstFloat("shadowMapFov") || shaderline.isComment("SHADOWFOV")) {
                        shadowMapFOV = shaderline.getValueFloat();
                        shadowMapIsOrtho = false;
                        SMCLog.info("Shadow map field of view: " + shadowMapFOV);
                     } else if (shaderline.isConstFloat("shadowDistance") || shaderline.isComment("SHADOWHPL")) {
                     ...
                     } else if (shaderline.isConstFloat("drynessHalflife") || shaderline.isComment("DRYNESSHL")) {
