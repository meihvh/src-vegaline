...
import vialoadingbase.model.ComparableProtocolVersion;
import vialoadingbase.model.Platform;
import vialoadingbase.platform.ViaBackwardsPlatformImpl;
import vialoadingbase.platform.ViaRewindPlatformImpl;
import vialoadingbase.platform.ViaVersionPlatformImpl;
import vialoadingbase.platform.viaversion.VLBViaCommandHandler;
import vialoadingbase.platform.viaversion.VLBViaInjector;
import vialoadingbase.platform.viaversion.VLBViaProviders;
import vialoadingbase.util.JLoggerToLog4j;
...
public class ViaLoadingBase {
   ...
   public static final Platform PLATFORM_VIA_REWIND = new Platform(
      "ViaRewind",
      () -> inClassPath("de.gerrygames.viarewind.api.ViaRewindPlatform"),
   ...
   public void initPlatform() {
      ...
      ViaManagerBuilder builder = ViaManagerImpl.builder()
   ...
   public static class ViaLoadingBaseBuilder {
      ...
      public ViaLoadingBase.ViaLoadingBaseBuilder managerBuilderConsumer(Consumer<ViaManagerBuilder> managerBuilderConsumer) {
         this.managerBuilderConsumer = managerBuilderConsumer;
         return this;
      }
